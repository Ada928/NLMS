 ...
 * @desc 审批路线模板设置
 */
public class RouteDetailQueryOperation extends BaseOperation {
	private static Log log = LogFactory.getLog(RouteDetailQueryOperation.class);
	...
	public void execute(OperationContext context) throws CommonException {
		...
		WorkflowRouteParam workflowRouteParam = (WorkflowRouteParam) context.getAttribute(IN_PARAM);
		...
		PageQueryResult result = routeService.queryRouteParam(workflowRouteParam, pageSizeI.intValue(),
				pageIndexI.intValue());
