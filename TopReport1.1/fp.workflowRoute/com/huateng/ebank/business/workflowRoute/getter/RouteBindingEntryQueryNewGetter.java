...
import com.huateng.ebank.business.management.operation.RouteBindingEntryQueryNewOperation;
...
public class RouteBindingEntryQueryNewGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws CommonException {
		...
		oc.setAttribute(RouteBindingEntryQueryNewOperation.IN_PARAM, routeBindingView);
		oc.setAttribute(RouteBindingEntryQueryNewOperation.IN_PARAM_PAGESIZE, PageSize);
		oc.setAttribute(RouteBindingEntryQueryNewOperation.IN_PARAM_PAGEINDEX, PageIndex);
		OPCaller.call("Management.RouteBindingEntryQueryNewOperation", oc);

		PageQueryResult pageResult = (PageQueryResult) oc.getAttribute(RouteBindingEntryQueryNewOperation.OUT_PARAM);
		return pageResult;
