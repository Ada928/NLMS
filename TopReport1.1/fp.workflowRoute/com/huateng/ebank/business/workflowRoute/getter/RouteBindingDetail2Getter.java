...
public class RouteBindingDetail2Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws CommonException {
		...
		// String routeId =
		// (String)getCommQueryServletRequest().getParameterMap().get("routeId");
		// String bussType =
		// (String)getCommQueryServletRequest().getParameterMap().get("bussType");
		// String brhClass =
		// (String)getCommQueryServletRequest().getParameterMap().get("brhClass");
		// String draftType =
		// (String)getCommQueryServletRequest().getParameterMap().get("draftType");
		// String startBrhno =
		// (String)getCommQueryServletRequest().getParameterMap().get("startBrhno");
		// String maxAmt =
		// (String)getCommQueryServletRequest().getParameterMap().get("maxAmt");
		// String isBand =
		// (String)getCommQueryServletRequest().getParameterMap().get("isBand");
		...
		// oc.setAttribute(RouteBindingDetail2Operation.IN_PARAM,
		// routeBindingView);
		...
		PageQueryResult pageResult = (PageQueryResult) oc.getAttribute(RouteBindingDetail2Operation.OUT_PARAM);
		return pageResult;
