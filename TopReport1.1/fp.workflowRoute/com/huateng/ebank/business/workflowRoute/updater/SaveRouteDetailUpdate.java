...
public class SaveRouteDetailUpdate extends BaseUpdate {
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		UpdateResultBean updateResultBean = multiUpdateResultBean.getUpdateResultBeanByID("routeDetailSet");
		...
		while (updateResultBean.hasNext()) {
			...
			if (!DataFormat.isEmpty(routeId)) {
				...
				// WorkflowRouteDef workflowRouteDef =
				// DAOUtils.getWorkflowRouteDefDAO().query(Integer.parseInt(routeId));
		...
		OPCaller.call("Management.SaveRouteDetailUpdateOperation", oc);
