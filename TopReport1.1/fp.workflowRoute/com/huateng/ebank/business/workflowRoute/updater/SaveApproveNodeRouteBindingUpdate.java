...
public class SaveApproveNodeRouteBindingUpdate extends BaseUpdate {
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		UpdateResultBean updateResultBean = multiUpdateResultBean.getUpdateResultBeanByID("approveNodeRouteBinding");
		...
		while (updateResultBean.hasNext()) {
			...
			// map.put("bussType", map.get("bussType").toString() +
			// map.get("bizType").toString());
