 ...
 *
 */
public class SaveRouteBindingNewUpdate extends BaseUpdate {
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		UpdateResultBean updateResultBean1 = multiUpdateResultBean
				.getUpdateResultBeanByID("routeBindingDetail1_Config");
		...
		UpdateResultBean updateResultBean2 = multiUpdateResultBean
				.getUpdateResultBeanByID("routeBindingDetail2_Config");
		...
		// oc.setAttribute(SaveRouteDetailUpdateOperation.IN_INSERT,
		// insertList);
		// oc.setAttribute(SaveRouteDetailUpdateOperation.IN_UPDATE,
		// updateList);

		OPCaller.call("Management.SaveRouteBindingUpdateOperation", oc);
