...
public class BopForSameInduDepositBalanceInfoAuditUpdate extends BaseUpdate {
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean,
		...
		try {
			...
			UpdateResultBean updateResultBean = multiUpdateResultBean
					.getUpdateResultBeanByID("BopForSameInduDepositBalanceInfoAudit");
			...
			oc.setAttribute(BopForSameInduDepositOperation.CMD, BopForSameInduDepositOperation.CMD_BALANCE_AUDIT);
			oc.setAttribute(BopForSameInduDepositOperation.BALANCE_IN_LIST, bopCfaExDsList);
