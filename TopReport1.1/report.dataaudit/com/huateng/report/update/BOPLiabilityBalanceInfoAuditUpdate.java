...
public class BOPLiabilityBalanceInfoAuditUpdate extends BaseUpdate {

	private static final String DATASET_ID = "BOPLiabilityBalanceInfoAudit";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			oc.setAttribute(BOPCFAExguInfoAuditOperation.CHOOSE, BOPCFAExguInfoAuditOperation.ZR_YU_E);
