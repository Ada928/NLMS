...
public class BopCfaExplrmbloDsChangeInfoAuditUpdate extends BaseUpdate {

	private static final String DATASET_ID = "BopCfaExplrmbloDsChangeInfoAudit";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			context.setAttribute(BopCfaExplrmbloDsChangeInfoOperation.CMD,
					BopCfaExplrmbloDsChangeInfoOperation.CMD_APPROVED);
			context.setAttribute(BopCfaExplrmbloDsChangeInfoOperation.IN_PARAM, approveList);
			// call方式开启operation事务
