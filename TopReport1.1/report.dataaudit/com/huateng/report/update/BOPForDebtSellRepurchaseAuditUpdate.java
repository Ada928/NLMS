...
public class BOPForDebtSellRepurchaseAuditUpdate extends BaseUpdate {

	private static final String DATASET_ID = "BOPForDebtSellRepurchaseAD";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			oc.setAttribute(BOPForDebtSellRepurchaseOperation.CMD, BOPForDebtSellRepurchaseOperation.OP_LOAN_AUDIT);
			oc.setAttribute(BOPForDebtSellRepurchaseOperation.IN_AUDIT_LIST, BopCfaExdebtDsList);
			oc.setAttribute(BOPForDebtSellRepurchaseOperation.IN_AUDIT_STATUS, approveStatusChoose);
			oc.setAttribute(BOPForDebtSellRepurchaseOperation.IN_AUDIT_RESULT, approveResultChoose);
