...
public class BopForDebtYinTuanChangeAuditUpdate extends BaseUpdate {
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			UpdateResultBean updateResultBean = multiUpdateResultBean
					.getUpdateResultBeanByID("bopForDebtYinTuanChangeAudit");
			...
			oc.setAttribute(BopForDebtYinTuanOperation.CMD, BopForDebtYinTuanOperation.OP_CHANGE_AUDIT);
