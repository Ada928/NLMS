...
public class BOPForDebtUsanceLeOfCreditAuditUpdate extends BaseUpdate {
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			oc.setAttribute(BOPForDebtUsanceLeOfCreditOperation.CMD, BOPForDebtUsanceLeOfCreditOperation.OP_LOAN_AUDIT);
			oc.setAttribute(BOPForDebtUsanceLeOfCreditOperation.IN_AUDIT_LIST, BopCfaExdebtDsList);
			oc.setAttribute(BOPForDebtUsanceLeOfCreditOperation.IN_AUDIT_STATUS, approveStatusChoose);
			oc.setAttribute(BOPForDebtUsanceLeOfCreditOperation.IN_AUDIT_RESULT, approveResultChoose);
