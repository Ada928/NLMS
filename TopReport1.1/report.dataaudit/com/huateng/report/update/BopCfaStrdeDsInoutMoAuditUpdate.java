 ...
 * 资金流出入和结购汇信息审核
 */
public class BopCfaStrdeDsInoutMoAuditUpdate extends BaseUpdate {
	private static final String DATASET_ID = "bopCfaStrdeDsInoutMoEntryAudit";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			context.setAttribute(BopCfaStrdeDsAuditOperation.INOUTMO_AUDIT_LIST_IN_PARAM, bopCfaStrdeDsList);
			...
			context.setAttribute(BopCfaStrdeDsAuditOperation.CMD, BopCfaStrdeDsAuditOperation.INOUTMO_AUDIT_CMD);
