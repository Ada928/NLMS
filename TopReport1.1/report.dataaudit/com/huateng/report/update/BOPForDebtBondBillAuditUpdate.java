...
public class BOPForDebtBondBillAuditUpdate extends BaseUpdate {

	private static final String DATASET_ID = "BOPForDebtBondBillAudit";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			oc.setAttribute(BOPForDebtBondBillOperation.CMD, BOPForDebtBondBillOperation.CMD_APPROVE);
			oc.setAttribute(BOPForDebtBondBillOperation.IN_AUDIT_LIST, bopcfaList);
			oc.setAttribute(BOPForDebtBondBillOperation.IN_AUDIT_STATUS, approveStatusChoose);
			oc.setAttribute(BOPForDebtBondBillOperation.IN_AUDIT_RESULT, approveResultChoose);
