...
public class BOPForDebtChangAuditUpdate extends BaseUpdate {

	private static final String DATASET_ID = "BOPForDebtChangeInfoVer";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			oc.setAttribute(BOPForDebtChangeInfoOperation.CMD, BOPForDebtChangeInfoOperation.OP_CHANG_AUDIT);
			oc.setAttribute(BOPForDebtChangeInfoOperation.IN_AUDIT_LIST, BopCfaExdebtDsList);
			oc.setAttribute(BOPForDebtChangeInfoOperation.IN_AUDIT_STATUS, approveStatusChoose);
			oc.setAttribute(BOPForDebtChangeInfoOperation.IN_AUDIT_RESULT, approveResultChoose);
