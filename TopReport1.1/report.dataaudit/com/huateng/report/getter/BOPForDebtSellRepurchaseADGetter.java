...
public class BOPForDebtSellRepurchaseADGetter extends BaseGetter {

	public Result call() throws AppException {

		try {
			setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "卖出回购签约信息查询");
	...
	private PageQueryResult getData() throws CommonException {
		...
		paramentList.add(TopReportConstants.REPORT_FILE_TYPE_CFA_AE);
