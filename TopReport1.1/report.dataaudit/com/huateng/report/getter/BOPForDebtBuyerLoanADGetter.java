...
public class BOPForDebtBuyerLoanADGetter extends BaseGetter {
	...
	public Result call() throws AppException {
		try {
			...
			result.init();
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "外债买方信贷签约信息审核页面查询");
			return result;
	...
	private PageQueryResult getData() throws CommonException {
		...
		paramentList.add(TopReportConstants.REPORT_FILE_TYPE_CFA_AB);
