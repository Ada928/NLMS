...
public class BopForDebtYinTuanChangeAuditGetter extends BaseGetter {
	...
	public PageQueryResult getData() throws CommonException {
		...
		return debtYinTuanService.queryAuditYinTuan("change", pageIndex, pageSize, qStartDate, qEndDate, qactiontype,
				qRecStatus, qapproveStatus, qrepStatus, qfiller2);
		// return debtYinTuanService.queryAuditYinTuan("change", pageIndex,
