...
public class BopForSameInduDepositBalanceInfoAuditGetter extends BaseGetter {
	...
	private PageQueryResult getData() throws AppException {
		this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "境外同业存放审核信息余额信息查询");
		...
		// ='"+TopReportConstants.REPORT_RECSTATUS_01+"' or
		// bds.recStatus='"+TopReportConstants.REPORT_RECSTATUS_02+"')");
