...
public class BopCfaStrdeDsContractEntryAuditGetter extends BaseGetter {

	public Result call() throws AppException {
		try {
			PageQueryResult pageResult = getData();
			setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "商业银行人民币结构性存款签约信息审核查询");
	...
	private PageQueryResult getData() throws CommonException {
		...
		hqlObj.add(TopReportConstants.REPORT_FILE_TYPE_CFA_FA);
		...
		hql.append(" AND model.brNo = ? ORDER BY lstUpdTm desc,workDate, actiontype, approveStatus DESC ");
