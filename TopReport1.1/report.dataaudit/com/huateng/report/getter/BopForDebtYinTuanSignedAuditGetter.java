...
public class BopForDebtYinTuanSignedAuditGetter extends BaseGetter {
	...
	public PageQueryResult getData() throws CommonException {
		...
		return debtYinTuanService.queryAuditYinTuan("signed", pageIndex, pageSize, qStartDate, qEndDate, qactiontype,
				qRecStatus, qapproveStatus, qrepStatus, qfiller2);
		// return debtYinTuanService.queryAuditYinTuan("signed", pageIndex,
		// pageSize, qworkDate, eworkDate, qactiontype, qRecStatus,
		// qapproveStatus, qrepStatus, qfiller2);
	}
}
