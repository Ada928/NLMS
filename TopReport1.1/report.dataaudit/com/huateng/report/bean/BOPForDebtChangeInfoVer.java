...
public class BOPForDebtChangeInfoVer implements Serializable {
	...
	private BigDecimal fairValue;// FAIRVALUE 价值 数值型，22.2
									// 选填项。对于银行发行的货币市场工具，应每月末报送该笔债券和票据、货币市场工具的最后一个交易日公允价值市值，月末报送。
