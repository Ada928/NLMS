...
public class BOPForDebtBilLoanVer implements Serializable {
	...
	private String actionDesc; // ACTIONDESC 删除原因 字符型，128
	...
	private String contracDate;// CONTRACTDATE 签约日期 日期型，8
								// 必填项，格式YYYYMMDD，小于等于当前日期。
	...
	private BigDecimal anninrate; // ANNINRATE 年化利率值 数值型，13.8
									// 必填项，大于等于0，按小数填写，如利率为3.21%，则填写0.0321。
	private String creditorCode;// CREDITORCODE 债权人代码 字符型，11 非必填项。
	private String creditorName;// CREDITORNAME 债权人中文名称 字符型，128
								// 非必填项。债权人中文名称和债权人英文名称至少填写一个。
	private String creditorNamEn;// CREDITORNAMEN 债权人英文名称 字符型，128
									// 非必填项。债权人中文名称和债权人英文名称至少填写一个。
	...
	private String spapfeboIndex;// SPAPFEBOINDEX 是否经外汇局特批不需占用指标 字符型，1
									// 必填项，是-Y，否-N，默认为否，填写N。
