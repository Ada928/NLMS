...
public class JshDfDsCollService {
	...
	private boolean delJshDfDsCollAvailable(String id) throws CommonException {
		// TODO Auto-generated method stub
		String hql = " select count(ds) from MtsJshDefgDs ds where ds.apptype = '"
				+ TopReportConstants.REPORT_APP_TYPE_JSH + "'";
	...
	public void collManageAdd(MtsJshDefgDs ds) throws CommonException {
		...
		rootDao.save(ds);
		// 记录到数据处理记录表
		ReportCommonService.getInstance().saveBiDataProcessLog(TopReportConstants.REPORT_APP_TYPE_JSH,
				TopReportConstants.REPORT_FILE_TYPE_JSH_F, uuid, ds.getRptno(),
	...
	public void collManageMod(MtsJshDefgDs ds) throws CommonException {
		...
		// 记录到数据处理记录表
		ReportCommonService.getInstance().saveBiDataProcessLog(TopReportConstants.REPORT_APP_TYPE_JSH,
				TopReportConstants.REPORT_FILE_TYPE_JSH_F, ds.getId(), ds.getRptno(),
