	...
	public void execute(OperationContext context) throws CommonException {
		...
		if (BASIC_CMD_ADD.equals(cmd)) {
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "外汇账户内补录基础信息新增" });
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "外汇账户内补录基础信息修改" });
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "外汇账户内补录基础信息删除" });
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "外汇账户内补录管理信息新增" });
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "外汇账户内补录管理信息修改" });
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "外汇账户内补录管理信息删除" });
