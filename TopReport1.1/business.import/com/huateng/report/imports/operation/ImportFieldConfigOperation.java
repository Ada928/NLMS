...
public class ImportFieldConfigOperation extends BaseOperation {
	private static Log log = LogFactory.getLog(ImportFieldConfigOperation.class);
	...
	public void execute(OperationContext context) throws CommonException {
		...
		ImportFieldConfigService importConfigService = ImportFieldConfigService.getInstance();
