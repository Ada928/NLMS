...
public class ExcelOp {
	 ...
	 * @return 是否成功
	 */
	public boolean readFileContent(TFileDataInfo curImpFileInfo, String fPath, String fFName, Constant constant)
			throws IOException {
		...
		try {
			HSSFWorkbook hsWorkBook = new HSSFWorkbook(new POIFSFileSystem(fis));// 指定xls文件;
					...
					if (hsRow.getCell((short) j) != null) {
						...
						case 0: { // CELL_TYPE_NUMERIC
							if (hsRow.getCell((short) j).getNumericCellValue()
									- (int) hsRow.getCell((short) j).getNumericCellValue() == 0) {
								line = line + (int) hsRow.getCell((short) j).getNumericCellValue() + "|";
								tmplin = tmplin + (int) hsRow.getCell((short) j).getNumericCellValue();
							} else {
								line = line + hsRow.getCell((short) j).getNumericCellValue() + "|";
								tmplin = tmplin + hsRow.getCell((short) j).getNumericCellValue();
							}
							break;
						}
						case 1: { // CELL_TYPE_STRING
							line = line + hsRow.getCell((short) j).getStringCellValue() + "|";
							tmplin = tmplin + hsRow.getCell((short) j).getStringCellValue();
							break;
						}
						case 2: { // CELL_TYPE_FORMULA
							line = line + hsRow.getCell((short) j).getCellFormula() + "|";
							tmplin = tmplin + hsRow.getCell((short) j).getCellFormula();
							break;
						}
						...
						case 4: { // CELL_TYPE_BOOLEAN
							line = line + hsRow.getCell((short) j).getBooleanCellValue() + "|";
							tmplin = tmplin + hsRow.getCell((short) j).getBooleanCellValue();
							break;
						}
						case 5: { // CELL_TYPE_ERROR
							line = line + hsRow.getCell((short) j).getErrorCellValue() + "|";
							tmplin = tmplin + hsRow.getCell((short) j).getErrorCellValue();
							break;
						}
						default: {
							line = line + hsRow.getCell((short) j).getStringCellValue() + "|";
