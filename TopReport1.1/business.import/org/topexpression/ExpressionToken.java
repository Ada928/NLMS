...
public class ExpressionToken {
	...
	// Token word yuan type: constants, variables, operators, function,
	// separator
	private ETokenType tokenType;
	// When TokenType = ETOKEN_TYPE_CONSTANT, of storage constants description
	private Constant constant;
	// When TokenType = ETOKEN_TYPE_VARIABLE, variable storage variable
	// description
	private Variable variable;
	// When TokenType = ETOKEN_TYPE_OPERATOR, operator storage fuck do operator
	// description
