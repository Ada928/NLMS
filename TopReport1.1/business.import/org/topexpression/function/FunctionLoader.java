...
public class FunctionLoader {
	 ...
	 */
	public static Object invokeFunction(String functionName, Object[] parameters) throws NoSuchMethodException,
			IllegalAccessException, InvocationTargetException, IllegalExpressionException {
	...
	public static Object invokeFunctionExp(String functionName, Object[] parameters) throws NoSuchMethodException,
			IllegalAccessException, InvocationTargetException, IllegalExpressionException {
		IMethod mehtod = single.factoryMap.get(functionName);
		if (mehtod == null) {
			throw new NoSuchMethodException();
