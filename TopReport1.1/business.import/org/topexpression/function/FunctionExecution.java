...
public class FunctionExecution {
	...
	/**
	 * According to the function name, parameter arrays, implement operation,
	 * and return the results Token
	 * 
	 * @param functionName
	 *            The function name
	 * @param position
	 * @param args
	 *            Note the parameters from args due order according to the stack
	 *            LIFO pop-up, so must take number from the tail backwards
	 * @return
	...
	public static Constant executeExp(String functionName, int position, Constant[] args)
			throws IllegalExpressionException {
		if (functionName == null) {
			// throw new IllegalExpressionException("函数名为空",position);
		}
	...
	/**
	 * Check function and parameter is legal, is an executable If legitimate,
	 * return contains implement results of types of Token If not lawful, null
	 * 
	 * @param functionName
	 * @param position
	 * @param args
	 ...
	 * @throws IllegalExpressionException
	 */
	public static Constant varify(String functionName, int position, BaseDataMeta[] args)
			throws IllegalExpressionException {
		if (functionName == null) {
			throw new IllegalExpressionException("函数名为空", position);
		}

		// Through the method name and parameter arrays, acquisition method, and
		// methods of the return value, which translates into ExpressionToken
		try {
