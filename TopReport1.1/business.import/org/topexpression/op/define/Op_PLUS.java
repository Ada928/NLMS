...
/**
 * Plus operation realize Plus operation includes mathematics addition and
 * rotative string connection
 * 
 * @author lei.zhang
 * @since 2010-12-7
 * @version 1.0
...
public class Op_PLUS implements IOperatorExecution {
	...
	public Constant execute(Constant[] args) throws IllegalExpressionException {
		...
		if (BaseDataMeta.DataType.DATATYPE_STRING == first.getDataType()
			...
			String firstString = "";
			String secondString = "";
			// Rotative string connection operations, if the parameter is null,
			// regard as empty rotative string processing
