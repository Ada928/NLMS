 ...
 * @desc
 */
public class ApproveNodeRouteBindingOperation extends BaseOperation {
	private static Log log = LogFactory.getLog(ApproveNodeRouteBindingOperation.class);
	...
	public void execute(OperationContext context) throws CommonException {
		...
		PageQueryResult result = routeService.queryApproveNodeRouteBindingInfo(routeBindingView, pageSizeI.intValue(), pageIndexI.intValue());
