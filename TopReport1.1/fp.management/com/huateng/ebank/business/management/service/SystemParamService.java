...
public class SystemParamService {
	private static final Logger logger = Logger
			.getLogger(SystemParamService.class);

	protected SystemParamService() {
	}

	public synchronized static SystemParamService getInstance() {
		return (SystemParamService) ApplicationContextUtils
				.getBean(SystemParamService.class.getName());
	}
...
//	 * @throws CommonException
//	 */
//	public List getSmallGageClassByCondition(String gageUpCode, String gageLevle)
//			throws CommonException {
//		GageClassDAO gcd = DAOUtils.getGageClassDAO();
//		String whereString = " 1=1";
...
//	 * @throws CommonException
//	 */
//	public List getSmallGageClassList(String gageUpCode) throws CommonException {
//		GageClassDAO gcd = DAOUtils.getGageClassDAO();
...
//	}
	 ...
	 */
	public PfSysParam getPfSysParamByCondition(String magicId, String paramId)
	throws CommonException {
