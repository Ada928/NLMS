...
public class WorkFlowParamUpdate extends BaseUpdate {
	 ...
	 * 
	 * @see
	 * com.huateng.commquery.process.call._CallUpdate#saveOrUpdate(com.huateng.
	 * commquery.result.MultiUpdateResultBean,
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			UpdateResultBean updateResultBean = multiUpdateResultBean.getUpdateResultBeanByID("parammng_WorkFlowParam");
			...
			while (updateResultBean.hasNext()) {
				...
				case UpdateResultBean.MODIFY:
					...
					// String
					// tlrnoList=(String)WorkFlowParamService.getInstance().getTlrnoRoleTaskOperate(newMap).get("TLRNO_LIST");
