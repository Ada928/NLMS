		...
		try {
			...
			while (updateResultBean.hasNext()) {
				...
				case UpdateResultBean.INSERT:
					...
					// bhProcStep.setSingleFlag
					// (DataFormat.trim((String)map.get("single_flag" )) ) ;
				...
				case UpdateResultBean.DELETE:
					...
					// bhProcStep.setJobno
					// (Integer.valueOf(DataFormat.trim((String)map.get("jobno"
					// ))) ) ;
					// bhProcStep.setStep
					// (Integer.valueOf(DataFormat.trim((String)map.get("step"
					// )) )) ;
					// bhProcStep.setSubStep
					// (Integer.valueOf(DataFormat.trim((String)map.get("sub_step"
					// )) )) ;
					// bhProcStep.setProcessFunction(DataFormat.trim((String)map.get("process_function"
					// )) ) ;
					// bhProcStep.setProcessParam
					// (DataFormat.trim((String)map.get("process_param" )) ) ;
					// bhProcStep.setProcessTlrno
					// (DataFormat.trim((String)map.get("process_tlrno" )) ) ;
					// bhProcStep.setRuntime
					// (DataFormat.trim((String)map.get("runtime" )) ) ;
					// bhProcStep.setSubFlag
					// (DataFormat.trim((String)map.get("sub_flag" )) ) ;
					// bhProcStep.setReportFlag
					// (DataFormat.trim((String)map.get("report_flag" )) ) ;
					// bhProcStep.setMaxproc
					// (Integer.valueOf(DataFormat.trim((String)map.get("maxproc"
					// )) )) ;
					// bhProcStep.setTempFlag
					// (DataFormat.trim((String)map.get("temp_flag" )) ) ;
					// bhProcStep.setSuspend
					// (DataFormat.trim((String)map.get("suspend" )) ) ;
					// bhProcStep.setSingleFlag
					// (DataFormat.trim((String)map.get("single_flag" )) ) ;
					// bhProcStep.setDesc
					// (DataFormat.trim((String)map.get("desc" )) ) ;
					// bhProcStep.setDesc1
					// (DataFormat.trim((String)map.get("desc1" )) ) ;
					// bhProcStep.setDesc2
					// (DataFormat.trim((String)map.get("desc2" )) ) ;
