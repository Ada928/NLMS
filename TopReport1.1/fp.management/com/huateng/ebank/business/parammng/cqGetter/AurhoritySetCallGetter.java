...
public class AurhoritySetCallGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		// String loantype
		// =(String)getCommQueryServletRequest().getParameterMap().get("loantype");
		// String projecttype
		// =(String)getCommQueryServletRequest().getParameterMap().get("projecttype");
		...
		while (outParam.hasNext()) {
			...
			// String bizclassname
			// =DataDicService.getInstance().getNameByTypeNo(
			...
			// }else
			// if(limitParam.getBizClass().equals(SystemConstant.LIMIT_PARAM_BIZ_CLASS_PROJ))
