...
public class BhProcLogGetter extends BaseGetter {
	...
	public Result call() throws AppException {
		try {
			 ...
			 * new com.huateng.ebank.entity.data.BhProcLog(); for(int
			 * i=0;i<list.size();i++) { Object []temp = (Object[])list.get(i);
	...
	protected PageQueryResult getData() throws Exception {
		 ...
		 * timestamps,po.errMsg,po.desc1,po.desc2 from BhProcLog po where 1=1";
		...
		if (pageQueryResult.getQueryResult() == null || pageQueryResult.getQueryResult().isEmpty()) {
			ExceptionUtil.throwCommonException("没有符合条件的批处理状态信息", ErrorCode.ERROR_CODE_RECORD_NOTFOUND);
		}
		return pageQueryResult;
	}
