...
public abstract class BaseNsRoleInfo implements Serializable {

	public static String REF = "NsRoleInfo";
	 ...
	 */
	public BaseNsRoleInfo(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof NsRoleInfo))
			return false;
		else {
			NsRoleInfo roleInfo = (NsRoleInfo) obj;
