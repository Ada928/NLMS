...
public abstract class BaseNsInternationBLOperateLog implements Serializable {
	...
	// constructors
	public BaseNsInternationBLOperateLog() {
		initialize();
	}
	 ...
	 */
	public BaseNsInternationBLOperateLog(java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof NsInternationBLOperateLog))
			return false;
		else {
			NsInternationBLOperateLog intenaBLOperateLog = (NsInternationBLOperateLog) obj;
