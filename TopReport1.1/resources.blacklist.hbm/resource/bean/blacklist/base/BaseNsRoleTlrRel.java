...
public abstract class BaseNsRoleTlrRel implements Serializable {
	 ...
	 */
	public BaseNsRoleTlrRel(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof NsRoleTlrRel))
			return false;
		else {
			NsRoleTlrRel tlrRoleRel = (NsRoleTlrRel) obj;
