...
public abstract class BaseNsRoleFuncRel implements Serializable {

	public static String REF = "NsRoleFuncRel";
	public static String PROP_FUNCID = "funcid";
	public static String PROP_ID = "id";
	public static String PROP_ROLE_ID = "roleId";

	// constructors
	public BaseNsRoleFuncRel() {
		initialize();
	}
	 ...
	 */
	public BaseNsRoleFuncRel(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof NsRoleFuncRel))
			return false;
		else {
			NsRoleFuncRel roleFuncRel = (NsRoleFuncRel) obj;
