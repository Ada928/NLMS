...
public class BaseNsPoliceBlackList implements Serializable {
	...
	private String id;
	private String blacklistType;//名单类型(1：黑名单 2：灰名单)
	private String accountType;//客户类型(C:对公 I:对私)
	private String accountCode;//账户代号
	private String certificateType;//证件类型
	private String certificateNumber;//证件号码
	private String clientName;
	private String clientEnglishName;
	private String bankCode;//银行编号(支付清算系统编号)
	private String blackListedOrganization;//发送机构(公安)
	private String contact;//公安联系人
	private String contactPhone;//公安联系人电话
	...
	private String cardBkBookNo;//卡/折号
