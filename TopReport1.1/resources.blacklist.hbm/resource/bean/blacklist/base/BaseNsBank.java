...
public abstract class BaseNsBank implements Serializable {

	public static String REF = "NsBank";
	 ...
	 */
	public BaseNsBank(java.lang.String brcode) {
	 ...
	 */
	public BaseNsBank(java.lang.String brcode, java.lang.String brno) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof NsBankInfo))
			return false;
		else {
			NsBankInfo bean = (NsBankInfo) obj;
			if (null == this.getBrcode() || null == bean.getBrcode())
				return false;
			else
				return (this.getBrcode().equals(bean.getBrcode()));
		}
	}
