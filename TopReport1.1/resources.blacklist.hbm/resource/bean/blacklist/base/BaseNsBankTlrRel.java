...
public abstract class BaseNsBankTlrRel implements Serializable {

	public static String REF = "NsBankTlrRel";
	public static String PROP_TLR_NO = "tlrNo";
	public static String PROP_ID = "id";
	public static String PROP_BR_NO = "brcode";

	// constructors
	public BaseNsBankTlrRel() {
		initialize();
	}
	 ...
	 */
	public BaseNsBankTlrRel(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof NsBankTlrRel))
			return false;
		else {
			NsBankTlrRel tlrBctlRel = (NsBankTlrRel) obj;
