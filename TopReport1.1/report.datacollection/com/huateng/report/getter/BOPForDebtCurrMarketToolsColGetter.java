...
public class BOPForDebtCurrMarketToolsColGetter extends BaseGetter {
	...
	private List getData() throws CommonException {
		...
		if (NEW_CMD.equals(op)) {
			...
			bop.setExdebtcode(ReportUtils.getBussinessNo(TopReportConstants.REPORT_FILE_TYPE_CFA_AJ));
			ReportUtils.setObjectPro(bop, TopReportConstants.REPORT_FILE_TYPE_CFA_AJ);

			/** 债权人类型代码，见境外主体类型代码表。“货币市场工具”类外债的债权人类型代码统一填报为“资本市场”。 */
			bop.setCreditortype("20001800");
