...
public class BOPForDebtRefinancingColGetter extends BaseGetter {
	...
	private List getData() throws CommonException {
		...
		if (NEW_CMD.equals(op)) {
			bop.setExdebtcode(ReportUtils.getBussinessNo(TopReportConstants.REPORT_FILE_TYPE_CFA_AD));
			ReportUtils.setObjectPro(bop, TopReportConstants.REPORT_FILE_TYPE_CFA_AD);
