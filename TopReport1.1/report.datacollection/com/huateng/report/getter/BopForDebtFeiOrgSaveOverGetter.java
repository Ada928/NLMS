 ...
 *         2012-8-15上午10:54:59
 */
public class BopForDebtFeiOrgSaveOverGetter extends BaseGetter {
	...
	public PageQueryResult getData() throws CommonException, IllegalAccessException, InvocationTargetException {
		...
		if (!DataFormat.isEmpty(op)) {
			...
			return debtYinTuanService.queryRecordFeiOrgSave("over", pageIndex, pageSize, qworkDateStart, qworkDateEnd,
