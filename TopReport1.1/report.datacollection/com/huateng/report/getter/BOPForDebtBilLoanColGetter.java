...
public class BOPForDebtBilLoanColGetter extends BaseGetter {
	...
	private List getData() throws CommonException {
		...
		if (NEW_CMD.equals(op)) {
			...
			bop.setExdebtcode(ReportUtils.getBussinessNo(TopReportConstants.REPORT_FILE_TYPE_CFA_AA));
			GlobalInfo gInfo = GlobalInfo.getCurrentInstance();
			bop.setDebtorcode(gInfo.getBrno());
			ReportUtils.setObjectPro(bop, TopReportConstants.REPORT_FILE_TYPE_CFA_AA);
			list.add(bop);
			return list;
