	...
	public Result call() throws AppException {
		try {
			...
			if (value != null && !value.equals("")) {
				queryCondition
						.setQueryString(" from BiNationregion  bn where bn.id like '" + value + "' order by bn.id");
			} else {
			...
			/*
			 * BiNationregion biNa = new BiNationregion(); biNa.setId("ABW");
			 * biNa.setNationregionNumber("533");
			 * biNa.setNationregionName("阿鲁巴");
			 * 
			 * BiNationregion biNa1 = new BiNationregion(); biNa.setId("ARE");
			 * biNa.setNationregionNumber("784");
			 * biNa.setNationregionName("阿拉伯联合酋长国");
			 * 
			 * BiNationregion biNa2 = new BiNationregion(); biNa.setId("HKG");
			 ...
			 * 
			 * list.add(biNa); list.add(biNa1); list.add(biNa2);
			 */
