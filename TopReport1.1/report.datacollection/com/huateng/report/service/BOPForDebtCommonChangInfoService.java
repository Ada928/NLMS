...
public class BOPForDebtCommonChangInfoService {
	...
	public String commonLogInfo(String debtFieldType, String oprType, String colOrNot) throws CommonException {
		...
		/*
		 * AA 外债双边贷款—变动信息 AB 外债买方信贷—变动信息 AC 外债境外同业拆借—变动信息 AD 外债海外代付—变动信息 AE
		 * 外债卖出回购—变动信息 AF 外债远期信用证—变动信息 AG 外债银团贷款—变动信息 AH 外债贵金属拆借—变动信息 AI
		 * 外债其他贷款—变动信息 AJ 外债货币市场工具—变动信息
		 */
	...
	public void insertLogInfo(GlobalInfo gi, HtLog htLog, String debtFieldType, String oprType, String colOrNot)
	...
	public void reportCommonService(String apptype, String currentfile, String changId, String debtFieldType,
			String oprType) throws CommonException {
		String logInfo = "";
		String op = "";
		...
		reportCommonService.saveBiDataProcessLog(apptype, currentfile, changId, TopReportConstants.REPORT_BUSITYPE_BOP,
				oprType, op, logInfo);
