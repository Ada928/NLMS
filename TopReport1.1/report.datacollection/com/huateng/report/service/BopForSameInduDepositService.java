...
public class BopForSameInduDepositService {
	...
	// "com.huateng.report.service.BopForSameInduDepositService";
	// private static final Logger log =
	// Logger.getLogger(BopForSameInduDepositService.class);

	public static synchronized BopForSameInduDepositService getInstance() {
		return (BopForSameInduDepositService) ApplicationContextUtils
				.getBean(BopForSameInduDepositService.class.getName());
	}
	...
	public PageQueryResult queryRecordAD(int pageIndex, int pageSize, String qworkDate, String qactiontype,
			String qrecStatus, String qapproveStatus, String qrepStatus, String qexdebtcode) throws CommonException {
		...
		hql.append(" and  (bds.recStatus ='" + TopReportConstants.REPORT_RECSTATUS_01 + "' or  bds.recStatus='"
	 ...
	 * @throws CommonException
	 */
	public void saveInduDeposit(BopCfaExdebtDs bopCfaExdebtDs, BopCfaCreditorDs bopCfaCreditorDs)
			throws CommonException {
		...
		if (bopCfaExdebtDs.getId() != "" && bopCfaCreditorDs.getId() != "") {
			...
			reportCommonService.saveBiDataProcessLog(bopCfaExdebtDs.getApptype(), bopCfaExdebtDs.getCurrentfile(),
					bopCfaExdebtDs.getId(), TopReportConstants.REPORT_BUSITYPE_BOP,
					TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "新增",
					"新增外债信息-签约信息     签约信息ID ：" + bopCfaExdebtDs.getId());
		}
	}

	public void updateInduDeposit(BopCfaExdebtDs bopCfaExdebtDs, BopCfaCreditorDs bopCfaCreditorDs)
			throws CommonException {
		ReportCommonService reportCommonService = ReportCommonService.getInstance();
		ROOTDAO rootdao = ROOTDAOUtils.getROOTDAO();
		if (bopCfaExdebtDs.getId() != "" && bopCfaCreditorDs.getId() != "") {
			...
			reportCommonService.saveBiDataProcessLog(bopCfaExdebtDs.getApptype(), bopCfaExdebtDs.getCurrentfile(),
					bopCfaExdebtDs.getId(), TopReportConstants.REPORT_BUSITYPE_BOP,
					TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "更新",
					"修改外债信息-签约信息     签约信息ID ：" + bopCfaExdebtDs.getId());
		}
	}
	...
	public void deleteInduDeposit(BopCfaExdebtDs bopCfaExdebtDs) throws CommonException {
		ReportCommonService reportCommonService = ReportCommonService.getInstance();
		/** 外债 校验开始 删除不用验证 **/
		// ReportDataVaildUtil.executeVaild(bopCfaExdebtDs.getApptype(),
		// bopCfaExdebtDs.getCurrentfile(), bopCfaExdebtDs);
		...
		StringBuilder hql = new StringBuilder(" SELECT COUNT(*) FROM BopCfaExdebtDs WHERE filler1 = '")
				...
				.append(TopReportConstants.REPORT_FILE_TYPE_CFA_AM).append("' AND recStatus <> '")
		...
		reportCommonService.saveBiDataProcessLog(bopCfaExdebtDs.getApptype(), bopCfaExdebtDs.getCurrentfile(),
				bopCfaExdebtDs.getId(), TopReportConstants.REPORT_BUSITYPE_BOP,
				TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "删除",
				"删除外债信息-签约信息     签约信息ID ：" + bopCfaExdebtDs.getId());
	}
	...
	public void saveInduDepositBalance(BopCfaExdebtDs bopCfaExdebtDs) throws CommonException {
		...
		if (bopCfaExdebtDs.getId() != "") {
			...
			reportCommonService.saveBiDataProcessLog(bopCfaExdebtDs.getApptype(), bopCfaExdebtDs.getCurrentfile(),
					bopCfaExdebtDs.getId(), TopReportConstants.REPORT_BUSITYPE_BOP,
					TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "新增",
					"新增外债信息-同业存放—余额信息     余额信息ID ：" + bopCfaExdebtDs.getId());
		}
	}
	...
	public void updateInduDepositBalance(BopCfaExdebtDs bopCfaExdebtDs) throws CommonException {
		...
		if (bopCfaExdebtDs.getId() != "") {
			...
			reportCommonService.saveBiDataProcessLog(bopCfaExdebtDs.getApptype(), bopCfaExdebtDs.getCurrentfile(),
					bopCfaExdebtDs.getId(), TopReportConstants.REPORT_BUSITYPE_BOP,
					TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "更新",
					"修改外债信息-同业存放—余额信息     余额信息ID ：" + bopCfaExdebtDs.getId());
		}
	}
	 ...
	 * @throws CommonException
	 */
	public void auditInduDeposit(String approveStatusChoose, String approveResultChoose,
			List<BopCfaExdebtDs> bopCfaExdebtDsList) throws CommonException {
		ReportCommonService reportCommonService = ReportCommonService.getInstance();
		...
		for (BopCfaExdebtDs bopCfaExdebtDs : bopCfaExdebtDsList) {
			...
			if (TopReportConstants.REPORT_APPROVESTATUS_01.equals(approveStatusChoose)) {
				reportCommonService.saveBiDataProcessLog(bopCfaExdebtDs.getApptype(), bopCfaExdebtDs.getCurrentfile(),
						...
						"审核外债信息-同业存放—签约信息     外债信息ID ：" + bopCfaExdebtDs.getId());
			} else {
				reportCommonService.saveBiDataProcessLog(bopCfaExdebtDs.getApptype(), bopCfaExdebtDs.getCurrentfile(),
						bopCfaExdebtDs.getId(), TopReportConstants.REPORT_BUSITYPE_BOP,
	 ...
	 * @throws CommonException
	 */
	public void auditInduBalanceDeposit(String approveStatusChoose, String approveResultChoose,
			List<BopCfaExdebtDs> bopCfaExdebtDsList) throws CommonException {
		ReportCommonService reportCommonService = ReportCommonService.getInstance();
		GlobalInfo gi = GlobalInfo.getCurrentInstance();
		...
		for (BopCfaExdebtDs bopCfaExdebtDs : bopCfaExdebtDsList) {
			...
			if (TopReportConstants.REPORT_APPROVESTATUS_01.equals(approveStatusChoose)) {
				reportCommonService.saveBiDataProcessLog(bopCfaExdebtDs.getApptype(), bopCfaExdebtDs.getCurrentfile(),
						bopCfaExdebtDs.getId(), TopReportConstants.REPORT_BUSITYPE_BOP,
						TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_AUDIT, "通过",
						"审核外债信息-同业存放—余额信息     外债信息ID ：" + bopCfaExdebtDs.getId());
			} else {
				reportCommonService.saveBiDataProcessLog(bopCfaExdebtDs.getApptype(), bopCfaExdebtDs.getCurrentfile(),
						bopCfaExdebtDs.getId(), TopReportConstants.REPORT_BUSITYPE_BOP,
						TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_AUDIT, "不通过",
