...
public class BopCfaExplbalainfoService {
	...
	public synchronized static BopCfaExplbalainfoService getInstance() {
		return (BopCfaExplbalainfoService) ApplicationContextUtils.getBean(BopCfaExplbalainfoService.class.getName());
	}

	@SuppressWarnings("unchecked")
	public List<BopCfaExplbalainfo> load(String uuid) throws CommonException {
		ROOTDAO rootdao = ROOTDAOUtils.getROOTDAO();
		List list = rootdao.queryByQL2List(" FROM BopCfaExplbalainfo WHERE recId = ? ", new Object[] { uuid }, null);
		return list;
	}
