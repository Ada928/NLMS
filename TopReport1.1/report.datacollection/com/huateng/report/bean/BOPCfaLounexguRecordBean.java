...
public class BOPCfaLounexguRecordBean {
	...
	private java.lang.String lounexgucode;// 外债编号

	private java.lang.String dofoexlocode;// 国内外汇贷款编号
	private java.lang.String creditorcode;// 债权人代码
	private java.lang.String debtorcode;// 债务人代码
	private java.lang.String debtorname;// 债务人中文名称
	private java.lang.String debtortype;// 债务人类型
	private java.lang.String credcurrcodeOth;// 贷款币种
	private java.math.BigDecimal credconamount;// 贷款签约金额
	private java.lang.String cfeogudad;// 中资企业境外担保项下贷款业务批准文件号
	private java.lang.String cfeogudcurr;// 中资企业境外担保项下境内贷款额度币种
	private java.math.BigDecimal cfeogudamount;// 中资企业境外担保项下境内贷款额度金额
	private java.lang.String valuedate;// 起息日
	private java.lang.String maturity;// 到期日
	private java.lang.String remarkOth;// 备注
	private java.lang.String filler2Oth;// 业务流水号

	// 变动信息
	private java.lang.String filler1; // 预留字段1
	private java.lang.String buscode;// 银行业务参号
	private java.lang.String changeno;// 变动编号
	private java.lang.String changedate;// 变动日期
	private java.lang.String credcurrcode;// 变动币种
	private java.lang.String remark;// 备注
	private java.lang.String filler2;// 业务流水号
	private java.math.BigDecimal credwithamount;// 提款金额
	private java.math.BigDecimal credrepayamount;// 还本金额
	private java.math.BigDecimal picamount;// 付息费金额
	private java.math.BigDecimal credprinbala;// 贷款余额
	private java.math.BigDecimal guarantlibala;// 担保责任余额
	private java.math.BigDecimal guperamount;// 担保履约金额
	...
	private java.util.Date crtTm;// 最后更新时间
	private java.util.Date lstUpdTm;// 创建时间
	private java.lang.String actiondesc;// 删除原因
	private java.lang.String subSuccess;// 是否成功
	...
	public java.lang.String getCredcurrcodeOth() {
		return credcurrcodeOth;
	}

	public void setCredcurrcodeOth(java.lang.String credcurrcodeOth) {
		this.credcurrcodeOth = credcurrcodeOth;
	}
	...
	public java.lang.String getRemarkOth() {
		return remarkOth;
	}

	public void setRemarkOth(java.lang.String remarkOth) {
		this.remarkOth = remarkOth;
	}
