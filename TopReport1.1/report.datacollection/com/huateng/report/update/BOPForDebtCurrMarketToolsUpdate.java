...
import com.huateng.report.operation.BOPForDebtCurrMarketToolsOperation;
 ...
 */
public class BOPForDebtCurrMarketToolsUpdate extends BaseUpdate {

	private static final String DATASET_ID = "BOPForDebtCurrMarketToolsCol";
		...
		if (updateResultBean.hasNext()) {
			...
			if (!StringUtils.isEmpty(op)) {
				if (RECORD_ADD.equalsIgnoreCase(op)) {
					...
					bpExdebt.setCurrentfile(TopReportConstants.REPORT_FILE_TYPE_CFA_AJ);
					...
					oc.setAttribute(BOPForDebtCurrMarketToolsOperation.CMD,
							BOPForDebtCurrMarketToolsOperation.CMD_INSERT);
					...
					oc.setAttribute(BOPForDebtCurrMarketToolsOperation.CMD,
							BOPForDebtCurrMarketToolsOperation.CMD_UPDATE);
					...
					oc.setAttribute(BOPForDebtCurrMarketToolsOperation.CMD,
							BOPForDebtCurrMarketToolsOperation.CMD_DELETE);
				}
			}
		}
		oc.setAttribute(BOPForDebtCurrMarketToolsOperation.IN_PARAM_EXDEBT, bpExdebt);
		oc.setAttribute(BOPForDebtCurrMarketToolsOperation.IN_PARAM_BCC, bcc);

		OPCaller.call(BOPForDebtCurrMarketToolsOperation.ID, oc);
