...
public class BopForDebtFeiPerSaveSignedUpdate extends BaseUpdate {
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			UpdateResultBean BcedUpdateResultBean = multiUpdateResultBean
					.getUpdateResultBeanByID("bopForDebtFeiPerSaveSigned");
			...
			if (op.equals("new")) {
				oc.setAttribute(BopForDebtFeiPerSaveOperation.CMD, BopForDebtFeiPerSaveOperation.OP_SIGNED_NEW);
			} else if (op.equals("modify")) {
				oc.setAttribute(BopForDebtFeiPerSaveOperation.CMD, BopForDebtFeiPerSaveOperation.OP_SIGNED_MOD);
			} else if (op.equals("delete")) {
				oc.setAttribute(BopForDebtFeiPerSaveOperation.CMD, BopForDebtFeiPerSaveOperation.OP_SIGNED_DEL);
			}
