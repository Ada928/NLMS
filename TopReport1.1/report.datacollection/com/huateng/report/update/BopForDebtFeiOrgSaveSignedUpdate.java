...
public class BopForDebtFeiOrgSaveSignedUpdate extends BaseUpdate {
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			UpdateResultBean BcedUpdateResultBean = multiUpdateResultBean
					.getUpdateResultBeanByID("bopForDebtFeiOrgSaveSigned");
			...
			if (op.equals("new")) {
				oc.setAttribute(BopForDebtFeiOrgSaveOperation.CMD, BopForDebtFeiOrgSaveOperation.OP_SIGNED_NEW);
			} else if (op.equals("modify")) {
				oc.setAttribute(BopForDebtFeiOrgSaveOperation.CMD, BopForDebtFeiOrgSaveOperation.OP_SIGNED_MOD);
			} else if (op.equals("delete")) {
				oc.setAttribute(BopForDebtFeiOrgSaveOperation.CMD, BopForDebtFeiOrgSaveOperation.OP_SIGNED_DEL);
			}
