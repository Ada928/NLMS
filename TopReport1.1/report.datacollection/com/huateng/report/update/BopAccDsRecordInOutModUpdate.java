	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			if (op.equals("modify")) {
				...
				oc.setAttribute(BopAccDsOperation.CMD, BopAccDsOperation.OP_INOUT_MOD);
				oc.setAttribute(BopAccDsOperation.IN_INOUT_MOD, bopAccDs);
				OPCaller.call(BopAccDsOperation.ID, oc);
			}
			if (op.equals("delete")) {
				OperationContext oc = new OperationContext();
				oc.setAttribute(BopAccDsOperation.CMD, BopAccDsOperation.OP_INOUT_DEL);
				oc.setAttribute(BopAccDsOperation.IN_INOUT_DEL, bopAccDs);
				OPCaller.call(BopAccDsOperation.ID, oc);
			}
