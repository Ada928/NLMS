	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean,
		...
		try {
			...
			UpdateResultBean updateResultBean = multiUpdateResultBean
					.getUpdateResultBeanByID("BopForSameInduDepositBalanceInfoCol");
			...
			while (updateResultBean.hasNext()) {
				...
				if ("newBalance".equalsIgnoreCase(op)) {
					...
					bopCfaExdebtDs.setApproveStatus(TopReportConstants.REPORT_APPROVESTATUS_00);// 审核状态
																								// 未审核
					bopCfaExdebtDs.setRepStatus(TopReportConstants.REPORT_REPSTATUS_00);// 回执状态
																						// 00
																						// 未返回
					...
					oc.setAttribute(BopForSameInduDepositOperation.CMD,
							BopForSameInduDepositOperation.CMD_BALANCE_INSERT);
					...
					oc.setAttribute(BopForSameInduDepositOperation.CMD,
							BopForSameInduDepositOperation.CMD_BALANCE_UPDATE);
					...
					bopCfaExdebtDs.setLstUpdTlr(gi.getTlrno());// 最新更新人\
					oc.setAttribute(BopForSameInduDepositOperation.CMD,
							BopForSameInduDepositOperation.CMD_BALANCE_DELETE);
					bopCfaExdebtDs.setBalanceFileType(TopReportConstants.REPORT_FILE_TYPE_CFA_AL);
				}
