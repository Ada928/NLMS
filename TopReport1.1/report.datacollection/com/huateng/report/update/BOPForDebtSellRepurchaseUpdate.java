		...
		if (updateResultBean.hasNext()) {
			...
			if (!StringUtils.isEmpty(op)) {
				if (RECORD_ADD.equalsIgnoreCase(op)) {
					...
					oc.setAttribute(BOPForDebtSellRepurchaseOperation.CMD,
							BOPForDebtSellRepurchaseOperation.CMD_INSERT);
					...
					oc.setAttribute(BOPForDebtSellRepurchaseOperation.CMD,
							BOPForDebtSellRepurchaseOperation.CMD_UPDATE);
					...
					oc.setAttribute(BOPForDebtSellRepurchaseOperation.CMD,
							BOPForDebtSellRepurchaseOperation.CMD_DELETE);
				}
			}
		}
