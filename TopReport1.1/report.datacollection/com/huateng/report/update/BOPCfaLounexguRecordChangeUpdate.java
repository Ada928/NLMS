		...
		try {
			...
			if (updateResultBean.hasNext()) {
				...
				if ("new".equalsIgnoreCase(op)) {
					...
					if (map.get("credwithamount").toString() != null
							&& !"".equals(map.get("credwithamount").toString())) {
					...
					if (map.get("credrepayamount").toString() != null
							&& !"".equals(map.get("credrepayamount").toString())) {
					...
					if (map.get("guarantlibala").toString() != null
							&& !"".equals(map.get("guarantlibala").toString())) {
