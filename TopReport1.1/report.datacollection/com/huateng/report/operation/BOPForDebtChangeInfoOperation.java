...
public class BOPForDebtChangeInfoOperation extends BaseOperation {
	...
	public void execute(OperationContext context) throws CommonException {
		...
		// 变动信息需要对 外债信息表 ：BOP_CFA_EXDEBT_DS, 项目信息表 :BOP_PROJECT_INFO,债权人信息表
		...
		if (CMD_INSERT.equalsIgnoreCase(cmd)) {
			...
			bopDebtCommon.reportCommonService(bpExdebt.getApptype(), bpExdebt.getCurrentfile(), bpExdebt.getId(),
					fieldType, TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT);
			...
			bopDebtCommon.reportCommonService(bpExdebt.getApptype(), bpExdebt.getCurrentfile(), bpExdebt.getId(),
					fieldType, TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_DEL);
