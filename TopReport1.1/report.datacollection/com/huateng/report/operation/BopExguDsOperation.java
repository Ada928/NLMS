	...
	public void execute(OperationContext context) throws CommonException {
		...
		if (!CMD_DELETE.equalsIgnoreCase(cmd)) {
			...
			if (CMD_INSERT.equalsIgnoreCase(cmd)) {
				...
				List<BopExguTorDs> beneficiaryList = (List<BopExguTorDs>) context
						.getAttribute(IN_PARAM_CHECK_BENEFICIARY);
			...
			ReportDataVaildUtil.executeVaild(bop.getBopCfaExguDs().getApptype(), bop.getBopCfaExguDs().getCurrentfile(),
					bop);
		...
		if (CMD_INSERT.equalsIgnoreCase(cmd)) {
			...
			reportCommonService.saveBiDataProcessLog(bopCfaExguDs.getApptype(), bopCfaExguDs.getCurrentfile(),
					...
					"对外担保-签约信息        签约信息ID ：" + bopCfaExguDs.getId());
			reportCommonService.saveBiDataProcessLog(bopCfaExguDs.getApptype(), bopCfaExguDs.getCurrentfile(),
					bopCfaExguDs.getId(), TopReportConstants.REPORT_BUSITYPE_BOP,
					TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "A-创建", "对外担保-签约信息-担保申请人信息       签约信息ID ："
							+ bopCfaExguDs.getId() + "    受益人或被担保人名称：" + bopExguTorDs.getTorName());
		}
			...
			reportCommonService.saveBiDataProcessLog(bopCfaExguDs.getApptype(), bopCfaExguDs.getCurrentfile(),
					bopCfaExguDs.getId(), TopReportConstants.REPORT_BUSITYPE_BOP,
					TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "C-修改", "对外担保-签约信息-担保申请人信息       签约信息ID ："
							+ bopCfaExguDs.getId() + "    受益人或被担保人名称：" + bopExguTorDs.getTorName());
		...
		if (CMD_INSERT.equalsIgnoreCase(torAddCmd)) {
			for (int i = 0; i < insertTorGuaList.size(); i++) {
				...
				reportCommonService.saveBiDataProcessLog(bopCfaExguDs.getApptype(), bopCfaExguDs.getCurrentfile(),
						bopCfaExguDs.getId(), TopReportConstants.REPORT_BUSITYPE_BOP,
						TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "A-创建",
						"对外担保-签约信息        签约信息ID ：" + bopCfaExguDs.getId() + "被担保人名称：" + bopExguTorDs.getTorName());
			}
			for (int i = 0; i < insertTorBenList.size(); i++) {
				...
				reportCommonService.saveBiDataProcessLog(bopCfaExguDs.getApptype(), bopCfaExguDs.getCurrentfile(),
						bopCfaExguDs.getId(), TopReportConstants.REPORT_BUSITYPE_BOP,
						TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "A-创建",
						"对外担保-签约信息        签约信息ID ：" + bopCfaExguDs.getId() + "受益人名称：" + bopExguTorDs.getTorName());
			}
		}
		if (CMD_UPDATE.equalsIgnoreCase(torModCmd)) {
			for (int i = 0; i < modTorGuaList.size(); i++) {
				...
				reportCommonService.saveBiDataProcessLog(bopCfaExguDs.getApptype(), bopCfaExguDs.getCurrentfile(),
						bopCfaExguDs.getId(), TopReportConstants.REPORT_BUSITYPE_BOP,
						TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "C-修改",
						"对外担保-签约信息        签约信息ID ：" + bopCfaExguDs.getId() + "受益人或被担保人名称：" + bopExguTorDs.getTorName());
			}
		...
		if (CMD_DELETE.equalsIgnoreCase(torDelCmd)) {
			for (int i = 0; i < delTorGuaList.size(); i++) {
				...
				reportCommonService.saveBiDataProcessLog(bopCfaExguDs.getApptype(), bopCfaExguDs.getCurrentfile(),
						bopCfaExguDs.getId(), TopReportConstants.REPORT_BUSITYPE_BOP,
						TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "D-删除",
						"对外担保-签约信息        签约信息ID ：" + bopCfaExguDs.getId() + "被担保人名称：" + bopExguTorDs.getTorName());
			}
