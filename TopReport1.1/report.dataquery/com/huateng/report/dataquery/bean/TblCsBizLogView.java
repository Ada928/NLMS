...
public class TblCsBizLogView implements Serializable {
	...
	public TblCsBizLogView(String id, String txnDate, String txnStartTime, String txnEndTime, Long txnRunTime,
			String brCode, String oprCode, String ipAdr, String funcId, String oprTxnCd, String txnBizLog1,
			String txnBizLog2, String txnStatus, String txnFailLog, String tlrName) {
		super();
		this.id = id;
		this.txnDate = txnDate;
		this.txnStartTime = txnStartTime;
