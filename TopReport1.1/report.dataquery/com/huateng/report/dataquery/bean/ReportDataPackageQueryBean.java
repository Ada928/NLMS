...
public class ReportDataPackageQueryBean implements Serializable {
	...
	public ReportDataPackageQueryBean(String id, String fileName, String workDate, String recordType, String busiType,
			Date produceTm, String receiptFileName, Date impReceiptTm) {
		super();
		this.id = id;
