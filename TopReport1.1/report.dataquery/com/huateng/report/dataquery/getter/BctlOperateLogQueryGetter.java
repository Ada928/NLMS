 ...
 */
public class BctlOperateLogQueryGetter extends BaseGetter {
	...
	private PageQueryResult getData() throws CommonException {
		...
		BctlOperateLogService bctlOPLogService = BctlOperateLogService
				.getInstance();
		return bctlOPLogService.queryBctlOperateLogDetail(pageIndex, pageSize,
