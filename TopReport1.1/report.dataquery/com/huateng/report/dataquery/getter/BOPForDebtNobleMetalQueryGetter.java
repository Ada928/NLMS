...
public class BOPForDebtNobleMetalQueryGetter extends BaseGetter {
	...
	public PageQueryResult getData() throws CommonException, IllegalAccessException, InvocationTargetException {
		...
		return debtYinTuanService.queryFeiOrgSaveQueryBetweenDate("signedQuery", pageIndex, pageSize, qbrNo, qrecStatus,
				qactiontype, qapproveStatus, qrepStatus, qFiller2, qWorkDateBegin, qWorkDateOver);
	}
}
