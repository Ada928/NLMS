...
public class ExecuteStateQueryEntryGetter extends BaseGetter {
	...
	public Result call() throws AppException {
		try {
			String workDate = getCommQueryServletRequest().getParameter("qworkDate");
	...
	private PageQueryResult getData() throws CommonException {
		...
		ExecuteStateQueryService statequeryservice = ExecuteStateQueryService.getInstance();

		StringBuilder queryhql = new StringBuilder(" FROM BiProcessLog WHERE 1 = 1 ");
		...
		return statequeryservice.pageQueryByHql(pageIndex, pageSize, queryhql.toString());
	}
}