...
public class BopAccDsInOutQueryGetter extends BaseGetter {
	...
	public PageQueryResult getData() throws CommonException {
		...
		return bopAccDsService.queryBopAccDsQuery("InOut", pageIndex, pageSize, qbrNo, qactiontype, qrecStatus,
				qapproveStatus, qrepStatus, null, qaccountno, qstartDate, qendDate);
	}
}
