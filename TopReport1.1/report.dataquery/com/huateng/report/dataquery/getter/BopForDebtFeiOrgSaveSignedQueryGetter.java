 ...
 *         2012-8-15上午10:54:59
 */
public class BopForDebtFeiOrgSaveSignedQueryGetter extends BaseGetter {

	@Override
	public Result call() throws AppException {
		try {
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "非居民机构存款签约信息查询");
	...
	public PageQueryResult getData() throws CommonException, IllegalAccessException, InvocationTargetException {
		...
		return debtYinTuanService.queryFeiOrgSaveQuery("signed", pageIndex, pageSize, qbrNo, qrecStatus, qactiontype,
