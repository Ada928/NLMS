...
public class JshDDsQueryGetter extends BaseGetter {
	...
	public Result call() throws AppException {
		...
		try {
			...
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "外汇账户内结汇补录查询基础信息查询");
	...
	private PageQueryResult getData() throws CommonException {
		...
		objs.add(TopReportConstants.REPORT_FILE_TYPE_JSH_D);
