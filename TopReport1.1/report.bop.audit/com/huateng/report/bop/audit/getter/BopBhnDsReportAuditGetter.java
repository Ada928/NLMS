...
public class BopBhnDsReportAuditGetter extends BaseGetter {
	...
	public Result call() throws AppException {
		...
		try {
			...
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "境外汇款申请书申报信息审核查询");
	...
	private PageQueryResult getData() throws CommonException {
		...
		hqlObj.add(TopReportConstants.REPORT_FILE_TYPE_BOP_H);
