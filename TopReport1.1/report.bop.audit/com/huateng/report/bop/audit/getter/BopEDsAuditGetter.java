...
public class BopEDsAuditGetter extends BaseGetter {

	public Result call() throws AppException {
		try {
			PageQueryResult pageQueryResult = getData();
			setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "国际收支审核信息查询-境内汇款申请书基础信息查询");
	...
	public PageQueryResult getData() throws AppException {
		...
		return bopEqDsAuditService.queryBOPEqAudit(TopReportConstants.REPORT_FILE_TYPE_BOP_E, pageIndex, pageSize,
