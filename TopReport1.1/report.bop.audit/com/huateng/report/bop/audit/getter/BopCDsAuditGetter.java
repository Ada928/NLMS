...
public class BopCDsAuditGetter extends BaseGetter {
	...
	public Result call() throws AppException {
		try {
			...
			result.init();
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "对外付款/承兑通知书基础信息审核查询");
			return result;
	...
	private PageQueryResult getData() throws CommonException {
		...
		return bopCkpDsService.queryBopCkpAudit(TopReportConstants.REPORT_FILE_TYPE_BOP_C, pageIndex, pageSize,
