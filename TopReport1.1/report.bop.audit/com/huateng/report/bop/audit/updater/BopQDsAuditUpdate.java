...
public class BopQDsAuditUpdate extends BaseUpdate {

	private static final String DATASET_ID = "BopQDsAudit";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			oc.setAttribute(BopEqDsAuditOperation.CMD, BopEqDsAuditOperation.OP_Q_AUDIT);
