...
public class BopBhnDsManageAuditUpdate extends BaseUpdate {

	public static final String DATA_SET_MANAGE_ID = "BopBhnDsManageAudit";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean arg0, HttpServletRequest arg1, HttpServletResponse arg2)
		...
		try {
			...
			context.setAttribute(BopBhnDsAuditOperation.MANAGE_AUDIT_LIST_IN_PARAM, list);
			...
			context.setAttribute(BopBhnDsAuditOperation.CMD, BopBhnDsAuditOperation.CMD_MANAGE_AUDIT);
