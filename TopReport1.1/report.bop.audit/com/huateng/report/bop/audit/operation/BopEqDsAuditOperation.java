...
public class BopEqDsAuditOperation extends BaseOperation {
	...
	public void execute(OperationContext context) throws CommonException {
		...
		if (OP_E_AUDIT.equals(cmd)) {
			service.auditBopEqDs(TopReportConstants.REPORT_FILE_TYPE_BOP_E, bopEqDsList, approveStatusChoose,
					approveResultChoose);
			...
			service.auditBopEqDs(TopReportConstants.REPORT_FILE_TYPE_BOP_Q, bopEqDsList, approveStatusChoose,
					approveResultChoose);
