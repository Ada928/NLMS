...
public class BopAgDsAuditOperation extends BaseOperation {
	...
	public void execute(OperationContext context) throws CommonException {
		...
		if (OP_A_AUDIT.equals(cmd)) {
			service.auditBopAgDs(TopReportConstants.REPORT_FILE_TYPE_BOP_A, bopAgDsList, approveStatusChoose,
					approveResultChoose);
			...
			service.auditBopAgDs(TopReportConstants.REPORT_FILE_TYPE_BOP_G, bopAgDsList, approveStatusChoose,
					approveResultChoose);
