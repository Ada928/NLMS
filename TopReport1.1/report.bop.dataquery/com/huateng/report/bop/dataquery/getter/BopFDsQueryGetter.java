...
public class BopFDsQueryGetter extends BaseGetter {
	@Override
	public Result call() throws AppException {
		try {
			...
			result.init();
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "境内付款/承兑通知书基础信息查询页面查询");
			return result;
	...
	private PageQueryResult getData() throws CommonException {
		...
		return bopFsDsService.queryFsDs(TopReportConstants.REPORT_FILE_TYPE_BOP_F, pageIndex, pageSize, qbrNo,
