...
public class BopEDsQueryGetter extends BaseGetter {
	...
	public PageQueryResult getData() throws AppException {
		setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "国际收支信息补录查询-境内汇款申请书-基础信息查询");
		...
		return bopEqDsService.queryBOPEqRecord(TopReportConstants.REPORT_FILE_TYPE_BOP_E, pageIndex, pageSize, qbrNo,
