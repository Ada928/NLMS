...
public class BopNDsQueryGetter extends BaseGetter {

	@Override
	public Result call() throws AppException {
		try {
			PageQueryResult pageResult = getData();
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "境外汇款信息补录查询管理信息查询");
	...
	private PageQueryResult getData() throws CommonException {
		...
		objs.add(TopReportConstants.REPORT_FILE_TYPE_BOP_N);
