package com.huateng.report.jsh.genupreportfile.impl;
...
public class BufJshDDsImpl implements IGetSubFileList {
	...
	public List getSubFileResultList(Map<String, Object> paramMap) throws CommonException {
		...
		hqlBuff.append(" from MtsJshDefgDs model ").append(" where model.apptype = '" + appType).append("'")
