...
public class BopFDsLoadPageGetter extends BaseGetter {

	public Result call() throws AppException {
		try {
			setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "境内付款/承兑通知书拾取页面查询");
	...
	public PageQueryResult getData() throws CommonException, IllegalAccessException, InvocationTargetException {
		...
		buff.append(" from MtsBopFsDs ds where 1 = 1");
		...
		// 拾取的是基础信息
		buff.append(" and ds.currentfile = '" + TopReportConstants.REPORT_FILE_TYPE_BOP_F + "'");
