...
public class BopBhnDsCollService {
	...
	private boolean delBopBhnDsCollAvailable(String id) throws CommonException {
		// TODO Auto-generated method stub
		String hql = " select count(ds) from MtsBopBhnDs ds where ds.apptype = '"
				+ TopReportConstants.REPORT_APP_TYPE_BOP + "'";
	...
	public void collReportAdd(MtsBopBhnDs ds) throws CommonException {
		...
		rootDao.save(ds);
		// 记录到数据处理记录表
		ReportCommonService.getInstance().saveBiDataProcessLog(TopReportConstants.REPORT_APP_TYPE_BOP,
				TopReportConstants.REPORT_FILE_TYPE_BOP_H, uuid, ds.getRptno(),
				TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "新增", "申报信息新增");
	}
	...
	public void collReportMod(MtsBopBhnDs ds) throws CommonException {
		...
		// 记录到数据处理记录表
		ReportCommonService.getInstance().saveBiDataProcessLog(TopReportConstants.REPORT_APP_TYPE_BOP,
				TopReportConstants.REPORT_FILE_TYPE_BOP_H, ds.getId(), ds.getRptno(),
				TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "修改", "申报信息修改");
	}
	...
	public void collReportDel(MtsBopBhnDs ds) throws CommonException {
		...
		ReportCommonService.getInstance().saveBiDataProcessLog(TopReportConstants.REPORT_APP_TYPE_BOP,
				TopReportConstants.REPORT_FILE_TYPE_BOP_H, ds.getId(), ds.getRptno(),
				TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_DEL, "删除", "申报信息删除");
	}
	...
	public void collManageAdd(MtsBopBhnDs ds) throws CommonException {
		...
		// 记录到数据处理记录表
		ReportCommonService.getInstance().saveBiDataProcessLog(TopReportConstants.REPORT_APP_TYPE_BOP,
				TopReportConstants.REPORT_FILE_TYPE_BOP_N, uuid, ds.getRptno(),
				TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "新增", "管理信息新增");
	}
	...
	public void collManageMod(MtsBopBhnDs ds) throws CommonException {
		...
		// 记录到数据处理记录表
		ReportCommonService.getInstance().saveBiDataProcessLog(TopReportConstants.REPORT_APP_TYPE_BOP,
				TopReportConstants.REPORT_FILE_TYPE_BOP_N, ds.getId(), ds.getRptno(),
				TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_EDIT, "修改", "管理信息修改");
	}
	...
	public void collManageDel(MtsBopBhnDs ds) throws CommonException {
		...
		ReportCommonService.getInstance().saveBiDataProcessLog(TopReportConstants.REPORT_APP_TYPE_BOP,
				TopReportConstants.REPORT_FILE_TYPE_BOP_N, ds.getId(), ds.getRptno(),
				TopReportConstants.REPORT_DATAPROCESS_EXECTYPE_DEL, "删除", "管理信息删除");
	}
