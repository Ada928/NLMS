 ...
 * 
 */
public class BopEDsCollectionUpdate extends BaseUpdate {

	private static final String DATASET_ID = "BopEDsCollectionInfo";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean arg0, HttpServletRequest arg1, HttpServletResponse arg2)
		...
		if (updateResultBean.hasNext()) {
			...
			if (RECORD_ADD.equals(op)) {
				context.setAttribute(BopEqDsOperation.CMD, BopEqDsOperation.OP_E_NEW);
				context.setAttribute(BopEqDsOperation.IN_E_NEW, bopEqDs);
			} else if (RECORD_MOD.equals(op)) {
				context.setAttribute(BopEqDsOperation.CMD, BopEqDsOperation.OP_E_MOD);
				context.setAttribute(BopEqDsOperation.IN_E_MOD, bopEqDs);
			} else if (RECORD_DEL.equals(op)) {
				context.setAttribute(BopEqDsOperation.CMD, BopEqDsOperation.OP_E_DEL);
				context.setAttribute(BopEqDsOperation.IN_E_DEL, bopEqDs);
			}
