	...
	public void execute(OperationContext context) throws CommonException {
		...
		if (BASIC_CMD_ADD.equals(cmd)) {
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "境外汇款申请书基础信息新增" });
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "境外汇款申请书基础信息修改" });
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "境外汇款申请书基础信息删除" });
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "境外汇款申请书申报信息新增" });
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "境外汇款申请书申报信息修改" });
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "境外汇款申请书申报信息删除" });
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "境外汇款申请书管理信息新增" });
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "境外汇款申请书管理信息修改" });
			...
			globalInfo.addBizLog("Updater.log",
					new String[] { globalInfo.getTlrno(), globalInfo.getBrcode(), "境外汇款申请书管理信息删除" });
