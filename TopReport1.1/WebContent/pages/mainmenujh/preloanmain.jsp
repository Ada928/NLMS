...
<frameset rows="85,*,26" framespacing="0" frameborder="0" border="0">
	...
	<frameset cols="153,*,0" framespacing="0" frameborder="0" border="0" bordercolor="#99CC99" name=subFrame>
		<frameset name="fleft" cols="*,15" frameborder="0">
			<frame src="<%=request.getContextPath()%>/pages/mainmenujh/frame/left8.jsp" name="left" scrolling="auto" noresize
				id="left">
...
-->
	...
	<frame src="<%=request.getContextPath()%>/pages/mainmenujh/frame/footBar.jsp" name="bottomFrame" scrolling="NO"
		noresize="noresize">
</frameset>
</html>
