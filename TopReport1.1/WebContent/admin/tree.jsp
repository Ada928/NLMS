...
%>
   		var   tree_node=new   Array(<%=t.toString()%>);
		document.write('<style>');
		document.write('TD.Tree_FOLDER_1{font-size: 15px; font-weight: bold; color: #0151A6; line-height: 35px;  border-bottom-width: 1px; border-bottom-style: inset; text-align:left; border-bottom-color: #51B2DF; background-color:#CBE8F5}');
		document.write('TD.Tree_FOLDER_2{font-size: 15px; font-weight: bold; color: #0151A6; line-height: 35px;  border-bottom-width: 1px; border-bottom-style: inset; text-align:left; border-bottom-color: #51B2DF; background-color:#CBE8F5}');
		document.write('TD.Tree_FOLDER_3{font-size: 15px; font-weight: bold; color: #0151A6; line-height: 35px;  border-bottom-width: 1px; border-bottom-style: inset; text-align:left; border-bottom-color: #51B2DF; background-color:#CBE8F5}');
