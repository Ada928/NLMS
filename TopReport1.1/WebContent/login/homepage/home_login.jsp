...
<body
	style="padding:0px;margin:0px;font-size:12px;font-family: Arial,Helvetica,sans-serif;text-align: left;width: 100%;height: 100% "
	bgcolor="#ffffff">
	<div style="font-size: 12px; color: green;padding-left: 15px;line-height: 25px;">
		欢迎您：<%=userInfo.getTlrName()%>(<%=userInfo.getTlrNo()%>)
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当前登录机构：<%=globalInfo.getBrno() + "-" + globalInfo.getBrName()%>
	</div>
	<div style="font-size: 12px;padding-left: 15px;line-height: 25px;">
		上次成功登录时间：<%=userInfo.getLastLoginTime()%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;上次登录失败时间：<%=userInfo.getLastLoginFailTime()%>
	</div>
