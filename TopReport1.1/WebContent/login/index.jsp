...
#li5 a {
	background:
		url('<%=request.getContextPath()%>/templets/ui/themes/blue/images/login/c_13.png')
		no-repeat;
}
</style>
</head>
...
<body scroll="no" style="overflow:hidden;padding:0px;marggin:0px;">
	...
	<div region="south" border="false" class="index-south">
		<table id="footer" cellpadding="0" cellspacing="0" border="0">
			...
			<td class="footer-right" nowrap="nowrap">版本:v1.0</td>
		</table>
	</div>
	...
	<script type="text/javascript">
		...
		var dts = new DynamicTabSet($("#workframe"), {
		...
		function topHidden() {
			...
			$('body').layout('panel', 'north').panel('resize', {
				height : $("#headtbl").height()
			});
			$('body').layout('resize');
		}
	
		function goChangePwd() {
			doWork('changePwd', '密码修改', '/fpages/management/ftl/ChangePwd.ftl');
		}
