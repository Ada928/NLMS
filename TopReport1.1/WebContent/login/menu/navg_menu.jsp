...
<div id="navgChangeDiv" class="navgdiv" style="display:none;">
	<table width="100%" cellpadding="0" cellspacing="3" style="overflow:auto;word-break: keep-all">
		...
		<tr>
			<td align="center">
				...
				%>
				<div class="menudiv" title="<%="当前：" + info.getFuncname()%>"
 ...
 %>
				<div addtr="navg" class="menudiv" title="<%=info.getFuncname()%>" onmouseover="menudivover(this);"
...
<script>
	function changeNavg(url, type, name) {
		//window.open(url + "?type=" + type, "_top");
		var urlt = null;
		urlt = url + "?type=" + type, "_top";
		doWork(type, name, urlt);
	}
