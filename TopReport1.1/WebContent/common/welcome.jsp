...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<table width="695" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td width="695" class="location">&nbsp;&nbsp;<a href="<%=response.encodeURL("../common/welcome.jsp")%>">主页</a>
				&gt; 登陆信息
			</td>
		</tr>
		<tr>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td>
													<table width="100%" border="1" cellpadding="2" cellspacing="0" class="table-class">
														<tr align="left">
															<td height="23" colspan="14" valign="top" nowrap class="tdTitle"><strong>我的工具箱</strong></td>
														</tr>
														<tr align="right">
															<td width="5%" align="center" valign="top" nowrap class="tdTitle">&nbsp;</td>
															<td width="30%" colspan="5" height="23" align="center" valign="top" nowrap bgcolor="#FFFFFF"
																class="tdTitle"><strong>功能名称</strong></td>
															<td width="65%" colspan="2" align="center" valign="middle" nowrap class="tdTitle"><strong>
																	功能描述</strong></td>
														</tr>
														<tr align="right" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="tdValue">
															<td width="5%" align="center" valign="top" nowrap><font color="#666666"><b>1</b></font></td>
															<td width="30%" colspan="5" align="center" valign="middle" nowrap><a
																	href='<%=response.encodeURL("../inquiryPrint/forcastAll.jsp")%>' target="businessfrm">预警信息查询</a></td>
														...
														<tr align="right" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="tdValue">
															...
															<td width="30%" colspan="5" align="center" valign="middle" nowrap><a
																	href='<%=response.encodeURL(request.getContextPath()+"/fpages/workflow/ftl/GetTaskList.ftl")%>'
														...
														<tr align="right" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="tdValue">
															...
															<td width="30%" colspan="5" align="center" valign="middle" nowrap><a
																	href='<%=response.encodeURL("../inquiryPrint/RepayPlanCalc0.do")%>' target="businessfrm">理财计算器</a></td>
															<td width="65%" colspan="2" align="center" valign="middle">提供各种理财计算器，负责向客户提供各种贷款的还款计划试算</td>
														</tr>
