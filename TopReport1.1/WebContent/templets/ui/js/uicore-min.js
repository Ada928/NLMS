(function($) {
    ...
    $.fn.draggable = function(_27, _28) {
        ...
        return this.each(function() {
            ...
            if (_2a) {
                ...
                _29 = $.extend({},
                $.fn.draggable.defaults, $.fn.draggable.parseOptions(this), _27 || {});
            }
    ...
    $.fn.draggable.parseOptions = function(_36) {
        var t = $(_36);
        return $.extend({},
        $.parser.parseOptions(_36, ["cursor", "handle", "axis", {
            "revert": "boolean",
            "deltaX": "number",
            "deltaY": "number",
            "edge": "number"
    ...
    $.fn.droppable = function(_3d, _3e) {
        ...
        return this.each(function() {
            ...
            if (_3f) {
                ...
                $.data(this, "droppable", {
                    options: $.extend({},
                    $.fn.droppable.defaults, $.fn.droppable.parseOptions(this), _3d)
                });
            }
        });
    };
    ...
    $.fn.droppable.parseOptions = function(_40) {
        var t = $(_40);
        return $.extend({},
        $.parser.parseOptions(_40, ["accept"]), {
            disabled: (t.attr("disabled") ? true: undefined)
        });
    };
    ...
    $.fn.resizable = function(_46, _47) {
        ...
        return this.each(function() {
            ...
            if (_54) {
                ...
                _53 = $.extend({},
                $.fn.resizable.defaults, $.fn.resizable.parseOptions(this), _46 || {});
                $.data(this, "resizable", {
                    options: _53
                });
            }
    ...
    $.fn.resizable.parseOptions = function(_5e) {
        var t = $(_5e);
        return $.extend({},
        $.parser.parseOptions(_5e, ["handles", {
            minWidth: "number",
            minHeight: "number",
            maxWidth: "number",
            maxHeight: "number",
        ...
        return this.each(function() {
            ...
            if (_69) {
                ...
                $.data(this, "linkbutton", {
                    options: $.extend({},
                    $.fn.linkbutton.defaults, $.fn.linkbutton.parseOptions(this), _67)
                });
                $(this).removeAttr("disabled");
            }
            _5f(this);
            this.disable = function(flag) {
                $(this).linkbutton(flag ? "disable": "enable");
            };
        });
    };
    ...
    $.fn.linkbutton.parseOptions = function(_6a) {
        var t = $(_6a);
        return $.extend({},
        $.parser.parseOptions(_6a, ["id", "iconCls", {
            plain: "boolean"
        }]), {
            disabled: (t.attr("disabled") ? true: undefined),
            text: $.trim(t.html()),
    ...
    function _6b(_6c) {
        ...
        var _6e = _6d.options;
        if (_6e.toolbar) {
            $(_6e.toolbar).find("tr:first").append($(_6c).find("td.pagination-toolbar"));
        }
        var bb = _6d.bb = {};
        var _6f = {
            first: {
        ...
        if (_6e.toolbar) {
            $("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(tr);
            var ptoolbar = $(_6e.toolbar).find("td.pagination-toolbar").appendTo(tr);
        ...
        function(e) {
            ...
            if (tt.hasClass("tree-hit")) {
                ...
                if (tt.hasClass("tree-checkbox")) {
                    if (_a0.onBeforeClick.call(_9f, _a6(_9f, _a3[0]), !tt.hasClass("tree-checkbox1")) == false) {
                        return;
                    }
                    _c3(_9f, _a3[0], !tt.hasClass("tree-checkbox1"));
                    return false;
                } else {
                    var oldv = $(_9f).tree('getSelected');
                    if (_a0.onBeforeClick.call(_9f, _a6(_9f, _a3[0])) == false) {
                        e.stopPropagation();
                        return;
                    }
                    _148(_9f, _a3[0]);
                    var newv = _a6(_9f, _a3[0]);
                    _a0.onClick.call(_9f, newv, oldv);
                }
            }
            e.stopPropagation();
        }).bind("dblclick",
        ...
        function _e3(ul, _e6, _e7) {
            for (var i = 0; i < _e6.length; i++) {
                ...
                if (_e8.state != "open" && _e8.state != "closed") {
                    if (_e8.hasChild == true || _e8.hasChild == "true") {
                        _e8.state = "closed";
                    } else {
                        _e8.state = "open";
                    }
    ...
    function _f9(_fa, ul, _fb, _fc) {
        ...
        var _101 = _fd.loader.call(_fa, _fb,
        function(data) {
    ...
    $.fn.tree = function(_159, _15a) {
        ...
        return this.each(function() {
            ...
            if (_15b) {
                ...
                opts = $.extend({},
                $.fn.tree.defaults, $.fn.tree.parseOptions(this), _159);
                $.data(this, "tree", {
                    options: opts,
                    tree: _93(this)
                });
    ...
    $.fn.tree.parseOptions = function(_174) {
        var t = $(_174);
        return $.extend({},
        $.parser.parseOptions(_174, ["url", "method", {
            checkbox: "boolean",
        ...
        return this.each(function() {
            ...
            if (_186) {
                ...
                _186 = $.data(this, "progressbar", {
                    options: $.extend({},
                    $.fn.progressbar.defaults, $.fn.progressbar.parseOptions(this), _183),
                    bar: init(this)
                });
            }
    ...
    $.fn.progressbar.parseOptions = function(_18a) {
        return $.extend({},
        $.parser.parseOptions(_18a, ["width", "text", {
            value: "number"
        }]));
    };
    ...
    function _1f7(_1f8) {
        ...
        _1f9.window.draggable({
            ...
            onStopDrag: function(e) {
                _1f9.options.left = Math.max(0, Math.min(e.data.left, $(_1f9.mask).width() - $(e.data.target).width() - 10));
                _1f9.options.top = Math.max(0, Math.min(e.data.top, $(_1f9.mask).height() - $(e.data.target).height() - 10));
                $(_1f8).window("move");
                _1f9.proxy.remove();
                _1f9.proxy = null;
            }
        ...
        return this.each(function() {
            ...
            if (_1fd) {
                ...
                _1fd = $.data(this, "window", {
                    options: $.extend({},
                    $.fn.window.defaults, $.fn.window.parseOptions(this), _1fa)
                });
    ...
    $.fn.window.parseOptions = function(_202) {
        return $.extend({},
        $.fn.panel.parseOptions(_202), $.parser.parseOptions(_202, [{
            draggable: "boolean",
            resizable: "boolean",
            shadow: "boolean",
            modal: "boolean",
    ...
    $.fn.accordion = function(_26e, _26f) {
        ...
        return this.each(function() {
            ...
            if (_270) {
                ...
                opts = $.extend({},
                $.fn.accordion.defaults, $.fn.accordion.parseOptions(this), _26e);
                var r = _24c(this);
                $.data(this, "accordion", {
                    options: opts,
    ...
    $.fn.accordion.parseOptions = function(_276) {
        var t = $(_276);
        return $.extend({},
        $.parser.parseOptions(_276, ["width", "height", {
            fit: "boolean",
            border: "boolean",
            animate: "boolean"
        }]));
    ...
    function _2a3(_2a4, pp, _2a5) {
        ...
        opts.tab.append("<a href=\"javascript:void(0)\" class=\"tabs-inner\">" + "<span class=\"tabs-title\"></span>" + "<span class=\"tabs-icon\"></span>" + "<span class=\"tabs-click\"></span>" + "</a>");
    ...
    function _2ac(_2c5, _2c6) {
        ...
        if (_2c9) {
            _2c9.panel("close");
            _2c9.panel("options").tab.removeClass("tabs-selected").addClass("tabs-hover");
        }
        _2c8.panel("open");
    ...
    function _305(_306, _307, _308) {
        ...
        p.panel("panel").animate(_30e.collapse, _308,
        function() {
    ...
    function _30f(_310, _311) {
        ...
        p.panel("panel").animate(_313.expand,
        function() {
            _2e9(_310);
        });
        function _314() {
    ...
    $.fn.layout = function(_31d, _31e) {
        ...
        return this.each(function() {
            ...
            if (_31f) {
                ...
                var opts = $.extend({},
                $.fn.layout.defaults, $.fn.layout.parseOptions(this), _31d);
                $.data(this, "layout", {
                    options: opts,
                    panels: {
                        center: $(),
        ...
        function _329(menu) {
            menu.addClass("menu").find(">div").each(function() {
                ...
                if (item.hasClass("menu-sep")) {
                    ...
                    var item_text = $("<div class=\"menu-text\"></div>").html(text);
        ...
        return this.each(function() {
            ...
            if (_35c) {
                ...
                $.data(this, "menubutton", {
                    options: $.extend({},
                    $.fn.menubutton.defaults, $.fn.menubutton.parseOptions(this), _35a)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
    ...
    $.fn.menubutton.parseOptions = function(_35d) {
        var t = $(_35d);
        return $.extend({},
        $.fn.linkbutton.parseOptions(_35d), $.parser.parseOptions(_35d, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
    ...
    function _35f(_360, _361) {
        ...
        if (_361) {
            ...
            btn.linkbutton("enable");
            _362.unbind(".splitbutton");
            _362.bind("click.splitbutton",
            function() {
                _363();
                return false;
            });
            var _364 = null;
            _362.bind("mouseenter.splitbutton",
            function() {
        ...
        return this.each(function() {
            ...
            if (_367) {
                ...
                $.data(this, "splitbutton", {
                    options: $.extend({},
                    $.fn.splitbutton.defaults, $.fn.splitbutton.parseOptions(this), _365)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
    ...
    $.fn.splitbutton.parseOptions = function(_368) {
        var t = $(_368);
        return $.extend({},
        $.fn.linkbutton.parseOptions(_368), $.parser.parseOptions(_368, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
    ...
    function _390(_391) {
        ...
        if (opts.validType) {
            var _395 = opts.validType;
            var msg = opts.msg;
            var rule = opts.rules['rul'];
            if (_393 && rule) {
                if (!rule["validator"](_393, _395)) {
                    box.addClass("validatebox-invalid");
                    var _397 = rule["message"](msg);
    ...
    function _3c4(_3c5) {
        ...
        $(_3c5).unbind(".numberbox").bind("keypress.numberbox",
        function(e) {
            if (e.which == 45) {
    ...
    function _3c8(_3c9, _3ca) {
        ...
        if (_3ca) {
            opts.disabled = true;
            $(_3c9).attr("readonly", true);
        } else {
            opts.disabled = false;
            $(_3c9).removeAttr("readonly");
        }
    };
        ...
        return this.each(function() {
            ...
            if (_3ce) {
                ...
                _3ce = $.data(this, "numberbox", {
                    options: $.extend({},
                    $.fn.numberbox.defaults, $.fn.numberbox.parseOptions(this), _3cb),
                    field: init(this)
                });
                $(this).removeAttr("disabled");
                $(this).css({
    ...
    $.fn.numberbox.parseOptions = function(_3d1) {
        var t = $(_3d1);
        return $.extend({},
        $.fn.validatebox.parseOptions(_3d1), $.parser.parseOptions(_3d1, ["decimalSeparator", "groupSeparator", "prefix", "suffix", {
            min: "number",
            max: "number",
            precision: "number"
        }]), {
            disabled: (t.attr("disabled") ? true: t.attr("readonly")),
    ...
    function show(_3f0) {
        ...
        for (var i = 0; i < _3f1.length; i++) {
            ...
            if (!today) {
                ...
                today = today.replace(/-/g, "").replace(/\//g, "");
            }
            var mode = opts.comparemode;
            for (var j = 0; j < week.length; j++) {
                var day = week[j];
                var td = $("<td class=\"calendar-day calendar-other-month\"></td>").attr("abbr", day[0] + "," + day[1] + "," + day[2]).html(day[2]).appendTo(tr);
                var tddd = day[0] + (day[1] < 10 ? "0": "") + day[1] + (day[2] < 10 ? "0": "") + day[2];
                if (mode == "lt" && tddd >= today) {
                    td.addClass("calendar-day-disabled");
                } else if (mode == "gt" && tddd <= today) {
                    td.addClass("calendar-day-disabled");
                } else if (mode == "le" && tddd > today) {
                    td.addClass("calendar-day-disabled");
                } else if (mode == "ge" && tddd < today) {
                    td.addClass("calendar-day-disabled");
                }
            }
        }
        t.find("td[abbr^=\"" + opts.year + "," + opts.month + "\"]").removeClass("calendar-other-month");
        var now = opts.current;
        ...
        t.find("td").hover(function() {
            if ($(this).hasClass("calendar-day-disabled")) return;
        ...
        return this.each(function() {
            ...
            if (_3f9) {
                ...
                _3f9 = $.data(this, "calendar", {
                    options: $.extend({},
                    $.fn.calendar.defaults, $.fn.calendar.parseOptions(this), _3f7)
                });
                init(this);
            }
    ...
    $.fn.calendar.parseOptions = function(_3fa) {
        var t = $(_3fa);
        return $.extend({},
        $.parser.parseOptions(_3fa, ["width", "height", {
            firstDay: "number",
            fit: "boolean",
            border: "boolean"
        }]));
    ...
    function _402(_403) {
        ...
        _404.find(".spinner-arrow-up,.spinner-arrow-down").unbind(".spinner").bind("mousedown.spinner",
        function(e) {
            e.stopPropagation();
        });
        if (!opts.disabled) {
            _404.find(".spinner-arrow-up").bind("mouseenter.spinner",
            function() {
            ...
            _404.find(".spinner-arrow-down").bind("mouseenter.spinner",
            function() {
                $(this).addClass("spinner-arrow-hover");
            }).bind("mouseleave.spinner",
            function() {
        ...
        return this.each(function() {
            ...
            if (_40b) {
                ...
                _40b = $.data(this, "spinner", {
                    options: $.extend({},
                    $.fn.spinner.defaults, $.fn.spinner.parseOptions(this), _408),
                    spinner: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.spinner.parseOptions = function(_40f) {
        var t = $(_40f);
        return $.extend({},
        $.fn.validatebox.parseOptions(_40f), $.parser.parseOptions(_40f, ["width", "min", "max", {
            increment: "number",
            editable: "boolean"
        }]), {
            value: (t.val() || undefined),
        ...
        return this.each(function() {
            ...
            if (_417) {
                ...
                $.data(this, "numberspinner", {
                    options: $.extend({},
                    $.fn.numberspinner.defaults, $.fn.numberspinner.parseOptions(this), _414)
                });
            }
            _410(this);
        });
    ...
    $.fn.numberspinner.parseOptions = function(_419) {
        return $.extend({},
        $.fn.spinner.parseOptions(_419), $.fn.numberbox.parseOptions(_419), {});
    };
        ...
        return this.each(function() {
            ...
            if (_431) {
                ...
                $.data(this, "timespinner", {
                    options: $.extend({},
                    $.fn.timespinner.defaults, $.fn.timespinner.parseOptions(this), _42e)
                });
                _41a(this);
            }
        });
    ...
    $.fn.timespinner.parseOptions = function(_433) {
        return $.extend({},
        $.fn.spinner.parseOptions(_433), $.parser.parseOptions(_433, ["separator", {
            showSeconds: "boolean",
            highlight: "number"
        }]));
    };
    ...
    function _461(_462) {
        ...
        if (opts.toolbar) {
            if (typeof opts.toolbar == "string") {
                ...
                $(opts.toolbar).show();
                if ($(opts.toolbar)[0]) initElements($(opts.toolbar)[0]);
            } else {
        ...
        function _467(_46c, _46d, _46e) {
            ...
            $(_46c).show();
            $(_46c).empty();
            var t = $("<table gridname=\"" + opts.id + "_thead\" class=\"datagrid-htable\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tbody></tbody></table>").appendTo(_46c);
    ...
    function _471(_472) {
        ...
        function(e) {
            ...
            if (tt.parent().hasClass("datagrid-cell-check")) {
                ...
                if (opts.isdropdown) {
                    if (opts.onBeforeClickRow.call(_472, _47e, row, tr.hasClass("datagrid-row-selected")) == false) {
                        return;
                    }
            ...
            if (col && col.editor) {
                ...
                if (!field.readOnly) {
                    ...
                    if (_510) {
                        ...
                        var _target = _510.init(cell.find("td"), _50f, otheropts, cell.width());
    ...
    var _545 = {
        text: {
            init: function(_546, options, otherops, width) {
                ...
                _548.attr('dataField', dataField).attr('componentDataset', componentDataset).attr('id', 'editor_' + dataField);;
                _548.bind("change",
                function(event) {
        ...
        textarea: {
            init: function(_54e, _54f, otherops, width) {
                ...
                _550.attr('dataField', dataField).attr('componentDataset', componentDataset).attr('id', 'editor_' + dataField);;
                _550.bind("change",
                function(event) {
                    _fieldChangeEvent(event);
                });
        ...
        checkbox: {
            init: function(_556, _557, otherops, width) {
                ...
                _558.attr('dataField', dataField).attr('componentDataset', componentDataset).attr('id', 'editor_' + dataField).attr('editType', 'checkbox');
                _558.val(_557.on);
        ...
        numberbox: {
            init: function(_55d, _55e, otherops, width) {
                ...
                _55f.attr('dataField', dataField).attr('componentDataset', componentDataset).attr('id', 'editor_' + dataField).attr('editType', 'numberbox');
                _55f.bind("change",
                function(event) {
                    _fieldChangeEvent(event);
                });
        ...
        validatebox: {
            init: function(_566, options, otherops, width) {
                ...
                _568.attr('dataField', dataField).attr('componentDataset', componentDataset).attr('id', 'editor_' + dataField);;
                _568.bind("change",
                function(event) {
                    _fieldChangeEvent(event);
                });
        ...
        datebox: {
            init: function(_56f, _570, otherops, width) {
                ...
                _571.attr('dataField', dataField).attr('componentDataset', componentDataset).attr('id', 'editor_' + dataField).attr('editType', 'datebox').attr('dateType', dateType);
                _dataInitEvent(_571, null, 'datebox', width);
                _571.combo("textbox").bind("mousedown.combo",
                function(e) {
                    e.stopPropagation();
        ...
        combobox: {
            init: function(_578, _579, otherops, _width) {
                ...
                _57a.attr('dataField', dataField).attr('componentDataset', componentDataset).attr('editType', 'dropDownSelect').attr('dropDown', dropdown).attr('id', 'editor_' + dataField);;
                if (mask) {
                ...
                var o = {
                    onSelect: function(value) {
                        if (!value.id) {
                            _57a.combobox("clear");
                            _57a.combobox("panel").panel("close");
                        }
                        var opts = _57a.combobox('options');
                        var _dropdown_dataset = opts.dropdowndataset;
                        if (value.id) {
                            var values = _57a.combobox('getValues');
                            setElementValue(_57a[0], dataset, _57a.attr("dataField"), values.join(","));
                            if (!opts.multiple) {
                                setElementValue(_57a[0], dataset, _57a.attr("dataField") + "Name", value.text);
                            } else {
                                var textArray = new Array();
                                var tArray = new Array();
                                var data = eval(_57a.attr("dataField") + "_Json");
                                ...
                                tArray1 = tArray;
                                setElementValue(_57a[0], dataset, _57a.attr("dataField") + "Name", tArray.join(','));
                            }
                        } else {
                            setElementValue(_57a[0], dataset, _57a.attr("dataField"), "");
                            _57a.combobox("panel").panel("close");
                        }
                    },
                    onUnselect: function(value) {
                        ...
                        needAbort = (isUserEventDefined(eventName) && !fireUserEvent(eventName, [_dropdown, value.record, this]));
                        if (needAbort) return;
                        if (opts.multiple) {
                            ...
                            var values = _57a.combobox('getValues');
                            setElementValue(_57a[0], dataset, _57a.attr("dataField"), values.join(","));
                            setElementValue(_57a[0], dataset, _57a.attr("dataField") + "Name", tArray1.join(','));
                        }
                    },
                    onInputText: function(value) {
                        var opts = _57a.combobox('options');
                        setElementValue(_57a[0], dataset, dataField, value);
                    }
                };
                _57a.combo({
                    oneClick: function() {
                        _57a.combobox($.extend(_579, o));
                        _57a.combobox('resize', _width);
                        _57a.combobox('showPanel');
                    }
                });
            ...
            getValue: function(_57c) {
                if ($(_57c).combo('options').multiple) {
                    ...
                    return typeof($(_57c).combo("getValue")) == 'undefined' ? '': $(_57c).combo("getValue");
                }
            },
        ...
        combotree: {
            init: function(_581, _582, otherops, width) {
                ...
                _583.attr('dataField', dataField).attr('componentDataset', componentDataset).attr('editType', 'dropDownSelect').attr('dropDown', dropdown).attr('id', 'editor_' + dataField).attr('datasetName', datasetName).attr('multi', multi);
                if (mask) {
                    _583.attr('validType', mask).attr('msg', maskErrorMessage);
                }
                $(_583).combo({
                    onInputText: function(value) {
                        _setElementValue(_583[0], dataset, dataField, value);
                        _setElementValue(_583[0], dataset, dataField + "Name", value);
                    },
                    oneClick: function() {
                        initDropdownTree(_583[0], null, null, width);
                    }
                });
                $(_583).combo("textbox").bind("mousedown.combo",
                function(e) {
                    e.stopPropagation();
                });
                return _583;
            ...
            getValue: function(_585) {
                if ($(_585).combo('options').multiple) {
                    return [$(_585).combo("getValues").join(","), $(_585).combo('getText')];
                } else {
                    return [$(_585).combo("getValue"), $(_585).combo('getText')];
                }
            },
    ...
    var _5af = {
        render: function(_5b0, _5b1, _5b2) {
            ...
            var _5b5 = ["<table gridname=\"" + opts.id + "_tbody\" class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
            for (var i = 0; i < rows.length; i++) {
            ...
            for (var i = 0; i < _5bf.length; i++) {
                ...
                if (col) {
                    ...
                    if (col.checkbox) {
                        ...
                        if (col.formatter) {
                            var divStr = $(cc[cc.length - 3] + cc[cc.length - 2] + cc[cc.length - 1] + "</div>");
                            cc.push(col.formatter(_5c5, _5c2, _5c1, _5c4, opts.id, divStr));
                        } else {
                            cc.push(_5c5);
                        }
                    }
    ...
    $.fn.propertygrid = function(_618, _619) {
        ...
        return this.each(function() {
            ...
            if (_61b) {
                ...
                var opts = $.extend({},
                $.fn.propertygrid.defaults, $.fn.propertygrid.parseOptions(this), _618);
                opts.frozenColumns = $.extend(true, [], opts.frozenColumns);
                opts.columns = $.extend(true, [], opts.columns);
    ...
    $.fn.propertygrid.parseOptions = function(_61c) {
        var t = $(_61c);
        return $.extend({},
        $.fn.datagrid.parseOptions(_61c), $.parser.parseOptions(_61c, [{
            showGroup: "boolean"
        }]));
    };
    var _614 = $.extend({},
    ...
    function _656(_674, _675, _676, _677, _678) {
        ...
        var _67b = opts.loader.call(_674, _679,
        function(data) {
    ...
    function _65b(_683, _684) {
        ...
        function _686(_688) {
            ...
            if (_689 && _689.children) {
                for (var i = 0,
                len = _689.children.length; i < len; i++) {
    ...
    $.fn.treegrid = function(_6bb, _6bc) {
        ...
        return this.each(function() {
            ...
            if (_6be) {
                ...
                $.data(this, "treegrid", {
                    options: $.extend({},
                    $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _6bb),
                    data: []
                });
            }
            _63f(this);
            if ($.data(this, "treegrid").options.onInit.call(this) != false) {
                _656(this);
            }
            _661(this);
        });
    ...
    $.fn.treegrid.parseOptions = function(_6c5) {
        return $.extend({},
        $.fn.datagrid.parseOptions(_6c5), $.parser.parseOptions(_6c5, ["treeField", {
            animate: "boolean"
        }]));
    };
    var _6c6 = $.extend({},
    $.fn.datagrid.defaults.view, {
        render: function(_6c7, _6c8, _6c9) {
            ...
            function _6cd(_6ce, _6cf, _6d0) {
                var _6d1 = ["<table gridname=\"" + opts.id + "_tbody\" class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
            ...
            for (var i = 0; i < _6db.length; i++) {
                ...
                if (col) {
                    ...
                    if (col.checkbox) {
                        ...
                        if (col.formatter) {
                            var divStr = $(cc[cc.length - 3] + cc[cc.length - 2] + cc[cc.length - 1] + "</div>");
                            val = col.formatter(row[_6de], row, row[opts.idField], _6de, opts.id, divStr);
                        } else {
                            val = row[_6de];
                        }
    ...
    function _702(_703, _704) {
        ...
        var text = _705.find("input.combo-text");
        if (_704) {
            opts.width = _704;
        }
        if (isNaN(opts.width)) {
    ...
    function init(_70b, opts) {
        $(_70b).addClass("combo-f").hide();
        var span = $("<span class=\"combo\"></span>").insertAfter(_70b);
        var placeholder = opts.placeholder || $.fn.combo.defaults.placeholder;
        var _70c = $("<input type=\"text\" class=\"combo-text\" placeholder=\"" + placeholder + "\" >").appendTo(span);
    ...
    function _711(_712) {
        ...
        if (!_713.panel) {
            _717.unbind(".combo").bind("click.combo",
            function() {
                if (opts.disabled) {
                    return;
                }
                if (opts.oneClick) {
                    _717.addClass("combo-loading");
                    setTimeout(function() {
                        opts.oneClick.call(_712);
                        opts.oneClick = null;
                        _717.removeClass("combo-loading");
                    },
                    0);
                }
                if (_715 && _715.is(":visible")) {
                    _71f(_712);
                } else {
            ...
            _716.bind("change.combo",
            function() {
                opts.onInputText.call(_712, _716.val());
            });
            return;
        }
        ...
        _715.bind("mousedown.combo",
        function(e) {
            e.stopPropagation();;
        });
        if (!opts.disabled) {
            _716.bind("mousedown.combo",
            function(e) {
                e.stopPropagation();
            }).bind("keydown.combo",
            function(e) {
    ...
    function _719(_71a) {
        ...
        _71c.panel("open");
        opts.onShowPanel.call(_71a); (function() {
            if (_71c.is(":visible")) {
                _71c.panel("move", {
                    left: _71e(),
                    top: _71d()
    ...
    function _725(_726, _727) {
        ...
        if (_727) {
            ...
            _728.find(".combo-value").attr("readonly", true);
            _728.find(".combo-text").attr("readonly", true);
        } else {
            opts.disabled = false;
            $(_726).removeAttr("disabled");
            if (opts.editable) {
                _728.find(".combo-value").removeAttr("readonly");
                _728.find(".combo-text").removeAttr("readonly");
            } else {
                _728.find(".combo-value").attr("readonly", true);
                _728.find(".combo-text").attr("readonly", true);
            }
    ...
    $.fn.combo = function(_744, _745) {
        ...
        return this.each(function() {
            ...
            if (_746) {
                ...
                var r = init(this, _744);
                _746 = $.data(this, "combo", {
                    options: $.extend({},
                    $.fn.combo.defaults, $.fn.combo.parseOptions(this), _744),
                    combo: r.combo,
                    panel: r.panel,
                    previousValue: null
                });
    ...
    $.fn.combo.parseOptions = function(_74b) {
        var t = $(_74b);
        return $.extend({},
        $.fn.validatebox.parseOptions(_74b), $.parser.parseOptions(_74b, ["width", "separator", {
            panelWidth: "number",
            editable: "boolean",
    ...
    function _757(_75d, _75e) {
        ...
        for (var i = 0; i < data.length; i++) {
            if (data[i][opts.valueField] == _75e) {
                if (opts.onBeforeSelect.call(_75d, data[i]) == false) {
                    return;
                }
            }
        }
        ...
        return this.each(function() {
            ...
            if (_77c) {
                ...
                _77c = $.data(this, "combobox", {
                    options: $.extend({},
                    $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _779)
                });
                _777(this);
                _76b(this, _769(this));
            }
    ...
    $.fn.combobox.parseOptions = function(_782) {
        var t = $(_782);
        return $.extend({},
        $.fn.combo.parseOptions(_782), $.parser.parseOptions(_782, ["valueField", "textField", "mode", "method", "url"]));
    };
    ...
    $.fn.combo.defaults, {
        ...
        keyHandler: {
            ...
            enter: function() {
                ...
                $.data(this, "combobox").options.onInputText.call(this, _783);
    ...
    function _78a(_78b) {
        ...
        opts, {
            ...
            onClick: function(node, node2) {
                _790(_78b);
                if (!opts.multiple) $(_78b).combo("hidePanel");
                opts.onClick.call(this, node, node2);
            }
        }));
    };
    function _790(_791) {
    ...
    $.fn.combotree = function(_796, _797) {
        ...
        return this.each(function() {
            ...
            if (_799) {
                ...
                $.data(this, "combotree", {
                    options: $.extend({},
                    $.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _796)
                });
            }
            _78a(this);
        });
    ...
    $.fn.combotree.parseOptions = function(_79c) {
        return $.extend({},
        $.fn.combo.parseOptions(_79c), $.fn.tree.parseOptions(_79c));
    };
    ...
    function _79d(_79e) {
        ...
        opts, {
            ...
            onLoadSuccess: function(data) {
                ...
                var text = $(_79e).combo("getText");
                _7ad(_79e, _7a1, _7a0);
                $(_79e).combo("setText", text);
        ...
        return this.each(function() {
            ...
            if (_7b7) {
                ...
                _7b7 = $.data(this, "combogrid", {
                    options: $.extend({},
                    $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _7b4)
                });
            }
            _79d(this);
        });
    ...
    $.fn.combogrid.parseOptions = function(_7ba) {
        var t = $(_7ba);
        return $.extend({},
        $.fn.combo.parseOptions(_7ba), $.fn.datagrid.parseOptions(_7ba), $.parser.parseOptions(_7ba, ["idField", "textField", "mode"]));
    };
    ...
    $.fn.combo.defaults, $.fn.datagrid.defaults, {
        ...
        keyHandler: {
            ...
            enter: function() {
                _7a8(this, 0);
                var _783 = $(this).combogrid("getValues");
                $.data(this, "combogrid").options.onInputText.call(this, _783);
    ...
    function _7bb(_7bc) {
        ...
        opts, {
            onShowPanel: function() {
                ...
                var value = $(_7bc).datebox("getValue");
                _7bd.calendar.calendar("moveTo", opts.parser.call(_7bd, value));
                opts.onShowPanel.call(_7bc);
            }
        }));
        $(_7bc).combo('panel').panel({
            onBeforeOpen: function() {
                if (!_7bd.calendar) {
                    _7be();
                }
        ...
        function _7be() {
            ...
            var _t = opts.today;
            var _tdate = opts.parser(opts.today);
            _7bd.calendar.calendar({
                today: _t,
                year: _tdate.getFullYear(),
                month: _tdate.getMonth() + 1,
                current: _tdate,
                ...
                onSelect: function(date) {
                    ...
                    opts.onSelect.call(_7bc, _7c0);
                }
            });
            _7bd.calendar.calendar('moveTo', parseDate($(_7bc).datebox("getValue")) || _today_date);
    ...
    function _7c5(_7c6) {
        ...
        _7c4(_7c6, _7c7);
        opts.onInputText.call(_7c6, _7c7);
    ...
    $.fn.datebox = function(_7cb, _7cc) {
        ...
        return this.each(function() {
            ...
            if (_7ce) {
                ...
                $.data(this, "datebox", {
                    options: $.extend({},
                    $.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _7cb)
                });
            }
            _7bb(this);
        });
    ...
    $.fn.datebox.methods = {
        ...
        setValue: function(jq, _7cf) {
            return jq.each(function() {
                ...
                try {
                    date = value.format(_VIEW_DATE_PATTERN);
                } catch(e) {
                    date = "";
                }
                _7c4(this, _7cf);
    ...
    function _7dc(_7dd) {
        ...
        opts.onOk.call(_7dd, date);
        $(_7dd).combo("hidePanel");
    };
    function _7dc(_7dd) {
        var opts = $.data(_7dd, "datetimebox").options;
        var date = _7d8(_7dd);
        var datestr = opts.formatter.call(_7dd, date);
        _7d7(_7dd, datestr);
        opts.onOk.call(_7dd, datestr);
        $(_7dd).combo("hidePanel");
    };
    function _7d7(_7de, _7df, _7e0) {
        var opts = $.data(_7de, "datetimebox").options;
        $(_7de).combo("setValue", _7df).combo("setText", _7df);
        if ($(_7de).datetimebox("spinner")) {
        ...
        return this.each(function() {
            ...
            if (_7e7) {
                ...
                $.data(this, "datetimebox", {
                    options: $.extend({},
                    $.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this), _7e4)
                });
            }
            _7d1(this);
        });
    ...
    $.fn.datetimebox.parseOptions = function(_7e9) {
        var t = $(_7e9);
        return $.extend({},
        $.fn.datebox.parseOptions(_7e9), $.parser.parseOptions(_7e9, ["timeSeparator", {
            showSeconds: "boolean"
        }]));
    };
...
$.extend($.fn.tabs.defaults, {
    ...
    onSelectNavigate: function(popts, opts) {}
});
$.extend($.fn.tabs.methods, {
    selectHis: function(jq) {
        return $.data(jq[0], "tabs").selectHis;
    }
});
$.extend($.fn.datagrid.defaults.editors, {
    datetimebox: {
        init: function(container, options, otherops, width) {
            var grid = otherops.grid;
            var dataField = otherops.dataField;
            var componentDataset = $(grid).attr('componentDataset');
            var editor = $("<input type=\"text\">").appendTo(container);
            editor.attr('dataField', dataField).attr('componentDataset', componentDataset).attr('id', 'editor_' + dataField).attr('editType', 'datetimebox');
            _dataInitEvent(editor, null, 'datetimebox', width);
            editor.combo("textbox").bind("mousedown.combo",
            function(e) {
                e.stopPropagation();
            }).parent().addClass("datebox");
            return editor;
        ...
        destroy: function(_525) {
            $(_525).datetimebox("destroy");
        },
        getValue: function(_526) {
            return $(_526).combo("getValue");
        },
        setValue: function(_527, _528) {
            $(_527).combo("setValue", _528).combo("setText", _528);
        },
        resize: function(_529, _52a) {
            $(_529).datetimebox("resize", _52a);
        }
    },
    combogrid: {
        init: function(container, options, otheropts, width) {
            var componentDataset = options.componentDataset;
            var datasetName = options.datasetName;
            var dropDown = options.dropDown;
            var dataField = options.dataField;
            var multiple = options.multiple;
            var tmpcid = "_" + componentDataset + "_" + datasetName + "_" + dropDown + "_" + dataField;
            var field = getDatasetByID(componentDataset).getField(dataField);
            var mask = field.mask;
            var maskErrorMessage = field.maskErrorMessage;
            var c = $('#' + tmpcid);
            if (c[0]) {
                $(container).append(c.children());
                return $(container).find("input.datagrid-editable-input");
            } else {
                c = $("<span/>").attr("id", tmpcid).appendTo("body").hide();
                c.html('test' + new Date().getTime());
                var input = $('<input type="text" class="datagrid-editable-input">').appendTo(container);
                input.attr("cid", tmpcid).attr('id', 'editor_' + dataField);
                input.attr("dataField", dataField).attr("dropDown", dropDown).attr("componentDataset", componentDataset);
                input.attr("datasetName", datasetName).attr("multi", multiple).attr('editType', 'dropDownSelect');
                if (mask) {
                    input.attr('validType', mask).attr('msg', maskErrorMessage);
                }
                initSelectCQClick(input[0], width);
                input.combo("textbox").bind("mousedown.combo",
                function(e) {
                    e.stopPropagation();
                });
                return input;
        ...
        destroy: function(target) {
            $('#' + $(target).attr('cid')).append($(target).parent().children());
        },
        getValue: function(target) {
            if ($(target).combo('options').multiple) {
                return [$(target).combo("getValues").join(","), $(target).combogrid('getText')];
            } else {
                return [$(target).combobox("getValue"), $(target).combogrid('getText')];
            }
        },
        setValue: function(target, value, text) {
            if ($(target).combo('options').multiple) {
                var combo = $(target);
                $(target).combo('setValues', value.split(","));
            } else {
                $(target).combo('setValue', value);
            }
            $(target).combo('setText', text || value);
        },
    ...
    custom: {
        init: function(container, options, otheropts) {
            var componentDataset = options.componentDataset;
            var datasetName = options.datasetName;
            var dropDown = options.dropDown;
            var dataField = options.dataField;
            var input = $('<input type="text" class="datagrid-editable-input">').appendTo(container);
            input.attr("dataField", dataField).attr("dropDown", dropDown).attr("componentDataset", componentDataset).attr("datasetName", datasetName);
            initSelectCustomClick(input[0],
            function(element, fieldMap, dataset, record) {},
            function(element, dataset, dataField, value) {});
            return input;
        },
        destroy: function(target) {},
        setValue: function(target, value, text) {},
...
$.fn.datebox.defaults.formatter = function(date) {
    if (date) {
        return date.format(_VIEW_DATE_PATTERN);
    } else {
        return "";
    }
};
$.extend($.fn.datebox.methods, {
    setValue: function(jq, value) {
        return jq.each(function() {
            ...
            $(jq).combo("setValue", date).combo("setText", date);
        });
    }
});
$.fn.datetimebox.defaults.parser = function(s) {
    var dtime = _today_date || new Date();;
    if ($.trim(s) == "") {
        return dtime;
    }
    if (typeof s == "string") {
...
$.fn.datetimebox.defaults.formatter = function(date) {
    if (date) {
        return date.format(_VIEW_DATETIME_PATTERN);
    } else {
        return "";
    }
};
...
$.extend($.fn.datagrid.defaults, {
    ...
    onBeforeClickRow: function(rowIndex, rowData, selected) {}
});
