...
<#-- date with extra js
 ...
 <#--
   month 类型 为年月类型
   其中新增2个参数 yearlength   为指定的年的范围长度
                startyear    为指定的起始年 
...
<#macro month id componentId label startyear yearlength targetDataset defaultValue  width  colSpan="2" rowSpan=1  vAlign="center" required="" readonly="" placeholder="" comparemode="" editable="false" >
	...
	<td class="datatd" valign="${colSpan?number - 1}" valign=${vAlign}  align="left" style="width: 20%" nowrap>
		<input extra="editor" startyear="${startyear}" yearlength="${yearlength}" id="editor_${id}" componentDataset="${targetDataset}"  dataField="${id}"  componentId="${componentId}"  editable="${editable}" editType="month" dateType="month" comparemode="${comparemode}"   type="text"   ${required}  ${readonly} name="${id}"   style="width:${width}px;" placeholder="${placeholder}">
	</td>
</#macro>

<#macro month2 id componentId label startyear yearlength targetDataset defaultValue  width  colSpan="2" rowSpan=1  vAlign="center" required="" readonly="" placeholder="" comparemode="" editable="false">
		<input extra="editor" startyear="${startyear}" yearlength="${yearlength}" id="editor_${id}" componentDataset="${targetDataset}"  dataField="${id}"  componentId="${componentId}"  editable="${editable}" editType="month" dateType="month" comparemode="${comparemode}"   type="text"   ${required}  ${readonly} name="${id}"   style="width:${width}px;" placeholder="${placeholder}">
</#macro>
  -->
<#macro date id componentId label  targetDataset defaultValue  width  colSpan="2" rowSpan=1  vAlign="center" required="" readonly="" placeholder="" comparemode="" editable="false" >
    <td class="labeltd" valign=${vAlign} align="right" style="width: 20%" nowrap>
		<label extra="fieldlabel" id="fldlabel_${id}" componentDataset="${targetDataset}" dataField="${id}"  label="${label}"></label>
	</td>
	<td class="datatd" valign="${colSpan?number - 1}" valign=${vAlign}  align="left" style="width: 20%" nowrap>
		<input extra="editor" id="editor_${id}" componentDataset="${targetDataset}"  dataField="${id}"  componentId="${componentId}" editType="datebox" dateType="date" comparemode="${comparemode}" editable="${editable}" type="text"   ${required}  ${readonly} name="${id}"   style="width:${width}px;" placeholder="${placeholder}">
	</td>
</#macro>

<#macro date2 id componentId label  targetDataset defaultValue  width  colSpan="2" rowSpan=1  vAlign="center" required="" readonly="" placeholder="" comparemode="" editable="false" >
...
<#--added by wangpeng 20091126 添加predate和postdate的数据类型支持  begin-->
<#macro predate  id componentId label targetDataset defaultValue  width  colSpan="2" rowSpan=1  vAlign="center" required="" readonly="" placeholder="" comparemode="" editable="false" >
		...
		<td class="datatd" colspan="${colSpan?number - 1}" valign=${vAlign}  align="left" style="width: 20%" nowrap>
			<input extra="editor" id="editor_${id}" componentDataset="${targetDataset}"  dataField="${id}"  componentId="${componentId}" editType="datebox" dateType="predate" comparemode="${comparemode}"  type="text"  editable="${editable}" ${required}  ${readonly} name="${id}"   style="width:${width}px;" placeholder="${placeholder}">
		</td>
</#macro>

<#macro predate2  id componentId label targetDataset defaultValue  width  colSpan="2" rowSpan=1  vAlign="center" required="" readonly="" placeholder="" comparemode="" editable="false" >
			<input extra="editor" id="editor_${id}" componentDataset="${targetDataset}"  dataField="${id}"  componentId="${componentId}" editType="datebox" dateType="predate" comparemode="${comparemode}"  type="text" editable="${editable}"  ${required}  ${readonly} name="${id}"   style="width:${width}px;" placeholder="${placeholder}">
</#macro>

<#macro postdate  id  componentId label  targetDataset defaultValue  width  colSpan="2" rowSpan=1  vAlign="center" required="" readonly="" placeholder="" comparemode="" editable="false" >
		<td class="labeltd"  valign=${vAlign} align="right" style="width: 20%" nowrap>
			<label extra="fieldlabel" id="fldlabel_${id}" componentDataset="${targetDataset}" dataField="${id}"  label="${label}"></label>
		</td>
		<td class="datatd" colspan="${colSpan?number - 1}" valign=${vAlign}  align="left" style="width: 20%" nowrap>
			<input extra="editor" id="editor_${id}" componentDataset="${targetDataset}" dataField="${id}" componentId="${componentId}"  editType="datebox" dateType="postdate" comparemode="${comparemode}"  type="text" editable="${editable}"  ${required}  ${readonly} name="${id}"   style="width:${width}px;" placeholder="${placeholder}">
        </td>
</#macro>

<#macro postdate2  id  componentId label  targetDataset defaultValue  width  colSpan="2" rowSpan=1  vAlign="center" required="" readonly="" placeholder="" comparemode="" editable="false" >
		<input extra="editor" id="editor_${id}" componentDataset="${targetDataset}" dataField="${id}" componentId="${componentId}"  editType="datebox" dateType="postdate" comparemode="${comparemode}"  type="text" editable="${editable}"  ${required}  ${readonly} name="${id}"   style="width:${width}px;" placeholder="${placeholder}">
</#macro>

<#macro timestamp  id  componentId label  targetDataset defaultValue  width  colSpan="2" rowSpan=1  vAlign="center" required="" readonly="" placeholder="" editable="false" >
    <td class="labeltd" valign=${vAlign} align="right" style="width: 20%" nowrap>
	   <label extra="fieldlabel"  id="fldlabel_${id}" componentDataset="${targetDataset}" dataField="${id}"  label="${label}"></label>
    </td>
    <td class="datatd" colspan="${colSpan?number - 1}"  valign=${vAlign} align="left" style="width: 20%" nowrap>
	   <input extra="editor" id="editor_${id}" componentDataset="${targetDataset}" dataField="${id}"  componentId="${componentId}" editType="datetimebox" dateType="timestamp"  type="text"  editable="${editable}" ${required}  ${readonly} name="${id}" style="width:${width}px;" placeholder="${placeholder}">
    </td> 
</#macro>
<#macro timestamp2  id  componentId label  targetDataset defaultValue  width  colSpan="2" rowSpan=1  vAlign="center" required="" readonly="" placeholder="" editable="false" >
	<input extra="editor" id="editor_${id}" componentDataset="${targetDataset}" dataField="${id}"  componentId="${componentId}" editType="datetimebox" dateType="timestamp"  type="text"  editable="${editable}" ${required}  ${readonly} name="${id}" style="width:${width}px;" placeholder="${placeholder}">
</#macro>

<#macro time  id  componentId label  targetDataset defaultValue  width  colSpan="2" rowSpan=1  vAlign="center" required="" readonly="">
  <td class="labeltd" valign=${vAlign} align="right" style="width: 20%" nowrap>
	 <label extra="fieldlabel"  id="fldlabel_${id}" componentDataset="${targetDataset}" dataField="${id}"  label="${label}"></label>
  </td>
  <td class="datatd" colspan="${colSpan?number - 1}"  valign=${vAlign} align="left" style="width: 20%" nowrap >
...
<#--added by wangpeng 20091126 添加predate和postdate的数据类型支持  end-->

<#--added by wangpeng 20091202 添加radio begin-->
<#--
-->
<#macro radioDataDic id fId label colSpan targetDataset width require readOnly defaultValue translated viewField valueField rowLen componentId isSingle=false>
	...
	<#if type=="LIST">
    	...
    	<@radio id=id fId=fId label=label colSpan=colSpan selsetValues=values fileMap=fMap targetDataset=targetDataset ddsfiles="data,dataName" defaultValue=defaultValue field="dataName" require=require readOnly=readOnly width=width rowLen = rowLen componentId=componentId isSingle=isSingle/>
    <#else>
...
<#macro radio id fId colSpan label selsetValues  targetDataset defaultValue fileMap ddsfiles field width require readOnly rowLen componentId isSingle=false>
    ...
    <td class="datatd" valign=center colspan="${colSpan?number - 1}" align="left" style="width: 20%" nowrap>
    </#if>
        <div extra="editor" id="editor_${id}" name="${fId}" componentDataset="${targetDataset}" editType="radio" dataField="${fId}" radio="${id}_Radio" >
        </div>  
    <#if !isSingle>
	</td>	
    </#if>
...
<#macro radioHidden id label  selsetValues  targetDataset defaultValue fileMap ddsfiles field width require readOnly rowLen>
    ...
    <input type="hidden" extra="editor" id="editor_${id}"
					name="${id}" componentDataset="${targetDataset}" dataField="${id}Name" radio="${id}_Radio_hidden" style="width:${width}">
	-->
	  <script language="javascript">
	  <#--
...
<#macro checkbox  label id  targetDataset defaultValue width colSpan=colSpan rowSpan=1 vAlign=vAlign componentId=componentId>
	...
	<td class="datatd" colspan="${colSpan?number - 1}" valign=${vAlign}  align="left" style="width: 20%" nowrap>
		<input type="checkbox" extra="editor" editType="checkbox"  id="editor_${id}" componentDataset="${targetDataset}" dataField="${id}"  style="width:${width}">
	</td>
    <script language="javascript">
	</script>
</#macro>

<#macro checkbox2  label id  targetDataset defaultValue width colSpan=colSpan rowSpan=1 vAlign=vAlign componentId=componentId>
		<input type="checkbox" extra="editor" editType="checkbox"  id="editor_${id}" componentDataset="${targetDataset}" dataField="${id}"  style="width:${width}">
    <script language="javascript">
	</script>
</#macro>
...
<#macro textarea  id label componentId targetDataset defaultValue  width height colSpan="2" rowSpan=1  vAlign="center" required="" readonly="" placeholder="">
	 ...
	 <td class="datatd" colspan="${colSpan?number - 1}" valign=${vAlign} align="left" style="width: 20%" nowrap>
	 <textarea extra="editor"  id="editor_${id}" componentId="${componentId}" componentDataset="${targetDataset}" dataField="${id}"  dataType="string" editType="textarea"    ${required}  ${readonly} name="${id}" style="width:${width}px;height:${_height}px" placeholder="${placeholder}"></textarea>
	 </td>
</#macro>
...
<#switch datatype>
  <#case "int">
	...
	<#assign opts = "max=\"2147483647\" min=\"-2147483648\" ">
	<#break> 
  <#case "float">
   <#case "double">
	<#assign _et = "numberbox">
   ...
   <@date id=id componentId=componentId label=label  targetDataset=targetDataset defaultValue=defaultValue width=width colSpan=colSpan required=required
  			readonly=readonly rowSpan=rowSpan vAlign=vAlign placeholder=placeholder comparemode=comparemode/>   
  	<#assign isHave="false">  
    <#break> 
   <#case "timestamp"> 
   <@timestamp id=id componentId=componentId label=label targetDataset=targetDataset defaultValue=defaultValue width=width colSpan=colSpan required=required
  			readonly=readonly  rowSpan=rowSpan vAlign=vAlign placeholder=placeholder/>
  	<#assign isHave="false">    
    <#break> 
   <#case "postdate">
...
<#if isHave=="true">
	<#if isSingle!="true">
	 ...
	 <td class="datatd" colspan="${colSpan?number - 1}"  valign=${vAlign} align="left" style="width: 20%" nowrap>
		...
		<input extra="editor" id="editor_${id}" componentDataset="${targetDataset}" dataField="${id}" componentId="${componentId}" ${required}  ${readonly} name="${id}" style="width:${width}px;" editType="${_et}" dataType="${_dt}" placeholder="${placeholder}"  ${opts} />
	<#if isSingle!="true"> 
	 </td>
	</#if>
</#if>
...
<#switch datatype>
  ...
  <#case "float">
   ...
   <#case "currency">
	...
	<#break>
   <#case "date">
   <@date2 id=id componentId=componentId label=label  targetDataset=targetDataset defaultValue=defaultValue width=width colSpan=colSpan required=required
  			readonly=readonly rowSpan=rowSpan vAlign=vAlign placeholder=placeholder comparemode=comparemode/>   
  	<#assign isHave="false">  
    <#break> 
   <#case "timestamp"> 
   <@timestamp2 id=id componentId=componentId label=label targetDataset=targetDataset defaultValue=defaultValue width=width colSpan=colSpan required=required
  			readonly=readonly  rowSpan=rowSpan vAlign=vAlign placeholder=placeholder/>
  	<#assign isHave="false">    
    <#break> 
   <#case "postdate">
   <@postdate2 id=id componentId=componentId label=label targetDataset=targetDataset defaultValue=defaultValue width=width colSpan=colSpan required=required
  			readonly=readonly  rowSpan=rowSpan vAlign=vAlign placeholder=placeholder comparemode=comparemode/>
  	<#assign isHave="false">     
    <#break>
   <#case "predate"> 
   <@predate2 id=id componentId=componentId label=label targetDataset=targetDataset defaultValue=defaultValue width=width colSpan=colSpan required=required
  			readonly=readonly  rowSpan=rowSpan vAlign=vAlign placeholder=placeholder comparemode=comparemode/>
  	<#assign isHave="false">    
    <#break> 
   <#default>
...
<#macro password id componentId label targetDataset defaultValue  width  colSpan=colSpan rowSpan=1  vAlign="center"  required="" readonly="">
	 ...
	 <td class="datatd" colspan="${colSpan?number - 1}"  valign=${vAlign} align="left" style="width: 20%" nowrap>
	 		<input type="password" extra="editor" editType="password" id="editor_${id}" ${required}  ${readonly}  componentDataset="${targetDataset}" dataField="${id}" style="width:${width};">
	 </td>
</#macro>

<#macro password2 id componentId label targetDataset defaultValue  width  colSpan=colSpan rowSpan=1  vAlign="center"  required="" readonly="">
	 <input type="password" extra="editor" editType="password" id="editor_${id}" ${required}  ${readonly}  componentDataset="${targetDataset}" dataField="${id}" style="width:${width};">
</#macro>
...
<#macro datalabel id label componentId targetDataset defaultValue  width  colSpan=colSpan rowSpan=1  vAlign="center">
	 ...
	 <td class="datatd" colspan="${colSpan?number - 1}"  valign=${vAlign} align="left" style="width: ${width}px" nowrap>
...
<#macro select lable id type selsetValues  componentId CQid targetDataset defaultValue fileMap ddsfiles field width height require readOnly colSpan="2" placeholder="" multiple="false" editable="false" >
	...
	<td class="labeltd" valign=center align="right" style="width: 20%" nowrap>
    	<label extra="fieldlabel" id="fldlabel_${id}" componentDataset="${targetDataset}" dataField="${id}Name" label="${lable}"></label>
    </td>
    <td class="datatd" colspan="${colSpan?number - 1}" valign=center align="left" style="width: 20%" nowrap>
      <div id="div_${id}">
    	<input  extra="dropDownSelect" editType="dropDownSelect" id="editor_${id}"  ${multi}   panelHeight="auto"  datasetName="${id}_DropDownDataset" valueField="id"  textField="text"
...
<#macro select_2  multiple lable id type selsetValues  componentId CQid targetDataset defaultValue fileMap ddsfiles field width height require readOnly colSpan="2" placeholder="" editable="false" >
	...
	<#else>
	  <#assign multi="">
    	...
    	<input  extra="dropDownSelect" editType="dropDownSelect" id="editor_${id}"  panelHeight="auto"  datasetName="${id}_DropDownDataset" valueField="id"  textField="text"  
		 editable="${editable}"	${require}  ${readOnly} ${multi}  componentDataset="${targetDataset}" multi="${multiple}"  dataField="${id}" dropDown="${id}_DropDown" style="width:${width}px" placeholder="${placeholder}">
	  <script language="javascript">
		_initDropDown("${id}_DropDownDataset","${id}_DropDown","${selsetValues}","${ddsfiles}","${lable}","${fileMapString}","${field}","${height}","${readOnly}","${require}","${type}");
		var ${id}_DropDownDataset=getDatasetByID("${id}_DropDownDataset");
		var ${id}_DropDown=getDropDownByID("${id}_DropDown");
...
-->
  ...
  <#else>
    ...
    <td class="datatd" colspan="${colSpan?number - 1}" valign=center align="left" style="width: 20%" nowrap>
    	<input  extra="dropDownSelect"  editType="dropDownSelect" id="editor_${id}"   componentId="${componentId}"  datasetName="${CQid}_DropDownDataset" panelHeight="auto" valueField="text"  textField="text"
...
<#macro selectCustom lable id type  componentId targetDataset defaultValue fileMap  field width height require readOnly colSpan="2" placeholder="" url="" editable="false">
    ...
    <td class="datatd" valign=center align="left" style="width: 20%" nowrap>
    	<input extra="dropDownSelect"  editType="dropDownSelect" id="editor_${id}"   componentId="${componentId}"  datasetName="${id}_DropDownDataset" editable="${editable}" panelHeight="auto" valueField="text"  textField="text"
	...
	<#if ddtype=="dataset">
		<#if type=="CQ">
    		...
    		<@CommonQueryForSelect id="${CQid}" init="false" require="${require}">
     			<@selectCQ lable=lable id=id targetDataset="${targetDataset}" componentId= componentId  multiple=multiple editable=editable
       				width=width height=height require=require readOnly=readOnly defaultValue=defaultValue  CQid=CQid fieldMap=fieldMap field=viewField type="cq" colSpan=colSpan placeholder=placeholder>
       			</@selectCQ>
        	</@CommonQueryForSelect>
    	<#elseif type=="LIST">
    		<#assign values = value>
			<#assign fMap=id + "=" + "data">
	    	<@select type="list"  multiple=multiple lable=lable id=id componentId= componentId CQid=value selsetValues=values targetDataset=targetDataset fileMap=fMap ddsfiles="data,dataName" defaultValue=defaultValue field="dataName"   width=width height=height require=require readOnly=readOnly colSpan=colSpan placeholder=placeholder editable=editable/>
	    <#else>
	    	<#assign values = sysDicStr(translated)>
			<#assign fMap=id + "=" + "data">
	 ...
	 <#elseif ddtype=="dynamic">
	 	<#if type=="CQ">
			<#assign CQid = value>
    		<@CommonQueryForSelect id="${CQid}" init="${init}" require="${require}">
     			<@selectCQ lable=lable id=id targetDataset="${targetDataset}"   componentId= componentId  multiple=multiple
       				width=width height=height require=require readOnly=readOnly defaultValue=defaultValue  CQid=CQid fieldMap=fieldMap field=viewField type="cq" colSpan=colSpan placeholder=placeholder editable=editable>
       			</@selectCQ>
        	</@CommonQueryForSelect>
        <#else>
        </#if>
     <#elseif ddtype=="dynamictree">
	 	<#if type=="CQ">
			<#assign CQid = value>
    		<@CommonQueryForSelect id="${CQid}" init="${init}" require="${require}">
     			<@selectGetter lable=lable id=id targetDataset="${targetDataset}"  componentId= componentId multiple=multiple editable=editable
       				width=width height=height require=require readOnly=readOnly defaultValue=defaultValue  CQid=CQid fieldmap=fieldMap field=viewField type="dynamictree" colSpan=colSpan placeholder=placeholder>
       			</@selectGetter>
        	</@CommonQueryForSelect>
        <#else>
        </#if>
     <#elseif ddtype=="custom">
		<@selectCustom type="custom" lable=lable id=id  targetDataset=targetDataset  componentId= componentId  defaultValue=defaultValue fileMap=fieldMap  field=viewField width=width height=height require=require readOnly=readOnly  url=url placeholder=placeholder editable=editable/>
     <#elseif ddtype=="dialog">
     	<@selectCustom type="dialog" lable=lable id=id  targetDataset=targetDataset  componentId= componentId  defaultValue=defaultValue fileMap=fieldMap  field=viewField width=width height=height require=require readOnly=readOnly  url=url placeholder=placeholder editable=editable/>
     <#else>
...
<#-- modify by shen_antonio 20080121 -->
	...
	<#if ddtype=="dataset">
		<#if type=="CQ">
			<#assign CQid = value>
    		<@CommonQueryForSelect id="${CQid}" init=init require="${require}">
     			<@selectCQ2 lable=lable id=id targetDataset="${targetDataset}"   componentId= componentId editable=editable multiple=multiple
       				width=width height=height require=require readOnly=readOnly defaultValue=defaultValue  CQid=CQid fieldMap=fieldMap field=viewField type="cq" colSpan=colSpan placeholder=placeholder>
       			</@selectCQ2>
       	 	</@CommonQueryForSelect>
    	<#elseif type=="LIST">
    		<#assign values = value>
			<#assign fMap=id + "=" + "data">
	    	<@select_2 type="list" multiple=multiple lable=lable id=id componentId= componentId CQid=value selsetValues=values targetDataset=targetDataset fileMap=fMap ddsfiles="data,dataName" defaultValue=defaultValue field="dataName"   width=width height=height require=require readOnly=readOnly colSpan=colSpan placeholder=placeholder editable=editable />
    	<#else>
			<#assign values = sysDicStr(translated)>
			<#assign fMap=id + "=" + "data">
	   		<@select_2 type="dic" multiple=multiple lable=lable id=id componentId= componentId CQid=value selsetValues=values targetDataset=targetDataset fileMap=fMap ddsfiles="data,dataName" defaultValue=defaultValue field="dataName"   width=width height=height require=require readOnly=readOnly colSpan=colSpan placeholder=placeholder editable=editable />
	    </#if>
	 <#elseif ddtype=="dynamic">
	 	<#if type=="CQ">
			<#assign CQid = value>
     ...
     <#elseif ddtype=="dynamictree">
	 	<#if type=="CQ">
			<#assign CQid = value>
    		<@CommonQueryForSelect id="${CQid}" init=init require="${require}">
     			<@selectGetter2 lable=lable id=id targetDataset="${targetDataset}"  componentId= componentId editable=editable multiple=multiple
       				width=width height=height require=require readOnly=readOnly defaultValue=defaultValue  CQid=CQid fieldmap=fieldMap field=viewField type="dynamictree" colSpan=colSpan placeholder=placeholder>
       			</@selectGetter2>
        	</@CommonQueryForSelect>
        <#else>
      ...
      <#elseif ddtype=="custom">
           <@selectCustom2 type="custom" lable=lable id=id  targetDataset=targetDataset  componentId= componentId  defaultValue=defaultValue fileMap=fieldMap  field=viewField width=width height=height require=require readOnly=readOnly  url=url placeholder=placeholder editable=editable/>
     <#elseif ddtype=="dialog">
           <@selectCustom2 type="dialog" lable=lable id=id  targetDataset=targetDataset  componentId= componentId  defaultValue=defaultValue fileMap=fieldMap  field=viewField width=width height=height require=require readOnly=readOnly  url=url placeholder=placeholder editable=editable/>
     <#else>
...
<#macro selectCQ lable id multiple componentId targetDataset width height require readOnly defaultValue CQid fieldMap field type colSpan="2" placeholder="" editable="false">
  <#if multiple=="false">
    <#assign multi="">
  <#else>
    <#assign multi="multiple">
    ...
    <td class="datatd" colspan="${colSpan?number - 1}" valign=center align="left" style="width: 20%" nowrap>
    	<input type="${type}" extra="dropDownSelect" editType="dropDownSelect" id="editor_${id}"   componentId="${componentId}"  datasetName="${CQid}_DropDownDataset"  editable="${editable}"
...
<#--
	...
	-->
	_initButton("${id}","${targetDataset}","${url}","${updateClass}","${resultDataset}","${submitDataset}","${targetFrame}","${defaultOperation}");
</script>
</#macro>
