...
<script type='text/javascript' src='<%=path%>/dwr/interface/PrivAction.js'> </script>
<link rel="stylesheet" type="text/css" href="<%=path%>/templets/easyui/themes/blue/easyui.css">
<script type="text/javascript">
	...
	function buttonMouseOut(obj){
		obj.style.backgroundImage = "url(<%=path%>/login/leftnavg/images/button.gif)";
	}
</script>
<style type="text/css">
	.divbutton{
...
<body bgcolor="white" style="margin: 0px;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-28" data-genuitec-path="/TopReport1.1/WebContent/fpages/management/jsp/favorites_set.jsp">
<div style="padding: 3px;padding-left: 10px;text-align: left;padding-top: 8px;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-28" data-genuitec-path="/TopReport1.1/WebContent/fpages/management/jsp/favorites_set.jsp">
<table>
	<tr>
		<td colspan="2">
