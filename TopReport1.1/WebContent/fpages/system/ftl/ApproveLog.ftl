...
<@CommonQueryMacro.CommonQuery id="approve_log" init="true" submitMode="current">
	<table width="100%">
		...
		<tr>
  		...
  		<tr>
      		<td colspan="2">
          		<@CommonQueryMacro.DataTable id ="datatable1" fieldStr="id[100],intInsId[100],updTransCd,intOperId,insCd,crtDt,approveResult[60],approveRemark" width="100%"  readonly="true"/></br>
        	</td>
        </tr>
