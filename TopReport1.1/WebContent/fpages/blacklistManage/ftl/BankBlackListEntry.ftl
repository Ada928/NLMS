					...
					<tr>
						<td colspan="2">
							<@CommonQueryMacro.DataTable id="datatable1" paginationbar="" 
									fieldStr="id[100],blacklistType,accountType[60],accountCode[120],certificateType,certificateNumber[100],clientName[200],"+
										"clientEnglishName[200],cardBkBookNo[120],approve,share"  
