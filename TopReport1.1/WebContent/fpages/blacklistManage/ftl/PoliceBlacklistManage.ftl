	...
	<tr>
		<td align="left">
	       <@CommonQueryMacro.Group id="PoliceBlacklistManageGroup" label="公安部黑名单维护"
        		fieldStr="id,blacklistType,accountType,accountCode,certificateType,certificateNumber,clientName,clientEnglishName,cardBkBookNo,blackListedOrganization,valid,validDate" colNm=4/>
        	<br/>
		</td>
	</tr>
	<tr >
...
<script language="javascript">
	...
	function btSave_onClickCheck(button) {
        ...
        var clientName = PoliceBlacklistManage_dataset.getValue("clientName");
        if (id == null || "" == id) {
            alert("黑名单不能为空");
            return false;
        }
...
var vcity={ 11:"北京",12:"天津",13:"河北",14:"山西",15:"内蒙古",
 ...
 function checkCard()
{
	var card = PoliceBlacklistManage_dataset.getValue("certificateNumber");
