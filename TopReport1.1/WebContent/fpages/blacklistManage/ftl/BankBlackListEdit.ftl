					...
					<tr>
						<td colspan="2">
							<@CommonQueryMacro.DataTable id="datatable1" paginationbar="btAdd,-,btDel" 
									fieldStr="select,id,blacklistid,brcode,accountType,accountCode,certificateType,certificateNumber,"+
										"clientName,clientEnglishName,cardBkBookNo,blacklistType,editDate,"+
...
<script language="JavaScript">
	...
	function datatable1_statedes_onRefresh(cell, value, record) {
		var accountCode = record.getValue("accountCode");
		if (record) {
