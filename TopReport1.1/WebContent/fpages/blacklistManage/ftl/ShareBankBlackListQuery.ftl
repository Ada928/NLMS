    ...
    <@CommonQueryMacro.page title="商行共享黑名单查询">
        <@CommonQueryMacro.CommonQuery id="ShareBankBlackListQuery" init="true" submitMode="current" navigate="false">
            <table align="center" width="100%">
                ...
                <tr>
                    <td colspan="2">
                        <@CommonQueryMacro.DataTable id="datatable1" paginationbar="" fieldStr="id,accountType,accountCode,certificateType,certificateNumber,clientName," + "clientEnglishName,cardBkBookNo,bankName,share" width="100%" hasFrame="true" /></td>
                </tr>
