...
%>
		...
		<%} else {%>
		<tr>
			<td class="labeltd" valign=center align="center" style="width: 20%" nowrap>错误类型</td>
		</tr>
		<tr>
			<%if(reprotBackErrBean.getErrType().equals("01")){ %>
			<td class="datatd" colspan="1" valign=center align="center" style="width: 20%" nowrap>格式错误</td>
			<% } else { %>
			<td class="datatd" colspan="1" valign=center align="center" style="width: 20%" nowrap>记录错误</td>
			<%} %>
		</tr>
		</table>
	</FIELDSET>
