...
/**
 * This is an object that contains data related to the query_acct_his table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="query_acct_his"
 */

public abstract class BaseQueryAcctHis implements Serializable {

	public static String REF = "QueryAcctHis";
	 ...
	 */
	public BaseQueryAcctHis(resource.bean.report.QueryAcctHisPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private resource.bean.report.QueryAcctHisPK id;
	 ...
	 * @hibernate.id
	 */
	public resource.bean.report.QueryAcctHisPK getId() {
		return id;
	}
	 ...
	 *            the new ID
	 */
	public void setId(resource.bean.report.QueryAcctHisPK id) {
		this.id = id;
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.QueryAcctHis))
			return false;
		else {
			resource.bean.report.QueryAcctHis queryAcctHis = (resource.bean.report.QueryAcctHis) obj;
			if (null == this.getId() || null == queryAcctHis.getId())
				return false;
			else
				return (this.getId().equals(queryAcctHis.getId()));
		}
	}
