 ...
 *
 * @hibernate.class table="ALREADY_SUB_INFO"
 */
...
public abstract class BaseAlreadySubInfo implements Serializable {
	 ...
	 */
	public BaseAlreadySubInfo(java.lang.String id, java.lang.String apptype, java.lang.String currentfile) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.AlreadySubInfo))
			return false;
		else {
			resource.bean.report.AlreadySubInfo alreadySubInfo = (resource.bean.report.AlreadySubInfo) obj;
			if (null == this.getId() || null == alreadySubInfo.getId())
				return false;
			else
				return (this.getId().equals(alreadySubInfo.getId()));
		}
	}
