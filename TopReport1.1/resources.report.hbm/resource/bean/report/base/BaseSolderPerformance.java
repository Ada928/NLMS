 ...
 *
 * @hibernate.class table="solder_performance"
 */
...
public abstract class BaseSolderPerformance implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.SolderPerformance))
			return false;
		else {
			resource.bean.report.SolderPerformance solderPerformance = (resource.bean.report.SolderPerformance) obj;
			if (null == this.getId() || null == solderPerformance.getId())
				return false;
			else
				return (this.getId().equals(solderPerformance.getId()));
		}
	}
