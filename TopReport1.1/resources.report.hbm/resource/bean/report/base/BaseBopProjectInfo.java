 ...
 *
 * @hibernate.class table="BOP_PROJECT_INFO"
 */
...
public abstract class BaseBopProjectInfo implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.BopProjectInfo))
			return false;
		else {
			resource.bean.report.BopProjectInfo bopProjectInfo = (resource.bean.report.BopProjectInfo) obj;
			if (null == this.getId() || null == bopProjectInfo.getId())
				return false;
			else
				return (this.getId().equals(bopProjectInfo.getId()));
		}
	}
