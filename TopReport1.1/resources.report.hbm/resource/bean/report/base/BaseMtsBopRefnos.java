...
/**
 * This is an object that contains data related to the MTS_BOP_REFNOS table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="MTS_BOP_REFNOS"
 */
...
public abstract class BaseMtsBopRefnos implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.MtsBopRefnos))
			return false;
		else {
			resource.bean.report.MtsBopRefnos mtsBopRefnos = (resource.bean.report.MtsBopRefnos) obj;
			if (null == this.getId() || null == mtsBopRefnos.getId())
				return false;
			else
				return (this.getId().equals(mtsBopRefnos.getId()));
		}
	}
