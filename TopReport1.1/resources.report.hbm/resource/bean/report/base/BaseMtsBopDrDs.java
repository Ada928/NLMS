...
/**
 * This is an object that contains data related to the MTS_BOP_Dr_DS table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="MTS_BOP_Dr_DS"
 */

public abstract class BaseMtsBopDrDs implements Serializable {

	public static String REF = "MtsBopDrDs";
	...
	public static String PROP_CHKAMT = "chkamt";
	 ...
	 */
	public BaseMtsBopDrDs(java.lang.String id) {
		this.setId(id);
		initialize();
	}
	 ...
	 */
	public BaseMtsBopDrDs(java.lang.String id, java.lang.String apptype, java.lang.String currentfile) {
	...
	private java.math.BigDecimal chkamt;
	 ...
	 */
	public java.math.BigDecimal getChkamt() {
		return chkamt;
	}
	 ...
	 *            the CHKAMT value
	 */
	public void setChkamt(java.math.BigDecimal chkamt) {
		this.chkamt = chkamt;
	}
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.MtsBopDrDs))
			return false;
		else {
			resource.bean.report.MtsBopDrDs mtsBopDrDs = (resource.bean.report.MtsBopDrDs) obj;
			if (null == this.getId() || null == mtsBopDrDs.getId())
				return false;
			else
				return (this.getId().equals(mtsBopDrDs.getId()));
		}
	}
