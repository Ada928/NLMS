...
/**
 * This is an object that contains data related to the BOP_CFA_BUSI_MAPPING
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="BOP_CFA_BUSI_MAPPING"
 */
...
public abstract class BaseBopCfaBusiMapping implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.BopCfaBusiMapping))
			return false;
		else {
			resource.bean.report.BopCfaBusiMapping bopCfaBusiMapping = (resource.bean.report.BopCfaBusiMapping) obj;
			if (null == this.getId() || null == bopCfaBusiMapping.getId())
				return false;
			else
				return (this.getId().equals(bopCfaBusiMapping.getId()));
		}
	}
