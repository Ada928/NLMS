...
/**
 * This is an object that contains data related to the MTS_BOP_CUSTOM table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="MTS_BOP_CUSTOM"
 */
...
public abstract class BaseMtsBopCustom implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.MtsBopCustom))
			return false;
		else {
			resource.bean.report.MtsBopCustom mtsBopCustom = (resource.bean.report.MtsBopCustom) obj;
			if (null == this.getId() || null == mtsBopCustom.getId())
				return false;
			else
				return (this.getId().equals(mtsBopCustom.getId()));
		}
	}
