 ...
 *
 * @hibernate.class table="REP_FILE_ERR_DET"
 */
...
public abstract class BaseRepFileErrDet implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.RepFileErrDet))
			return false;
		else {
			resource.bean.report.RepFileErrDet repFileErrDet = (resource.bean.report.RepFileErrDet) obj;
			if (null == this.getId() || null == repFileErrDet.getId())
				return false;
			else
				return (this.getId().equals(repFileErrDet.getId()));
		}
	}
