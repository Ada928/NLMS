...
/**
 * This is an object that contains data related to the customer_info table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="customer_info"
 */
...
public abstract class BaseCustomerInfo implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.CustomerInfo))
			return false;
		else {
			resource.bean.report.CustomerInfo customerInfo = (resource.bean.report.CustomerInfo) obj;
			if (null == this.getId() || null == customerInfo.getId())
				return false;
			else
				return (this.getId().equals(customerInfo.getId()));
		}
	}
