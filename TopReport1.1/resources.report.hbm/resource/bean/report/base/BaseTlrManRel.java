...
/**
 * This is an object that contains data related to the TLR_MAN_REL table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="TLR_MAN_REL"
 */
...
public abstract class BaseTlrManRel implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.TlrManRel))
			return false;
		else {
			resource.bean.report.TlrManRel tlrManRel = (resource.bean.report.TlrManRel) obj;
			if (null == this.getId() || null == tlrManRel.getId())
				return false;
			else
				return (this.getId().equals(tlrManRel.getId()));
		}
	}
