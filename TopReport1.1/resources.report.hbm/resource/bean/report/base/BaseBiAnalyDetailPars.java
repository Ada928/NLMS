...
/**
 * This is an object that contains data related to the BI_ANALY_DETAIL_PARS
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="BI_ANALY_DETAIL_PARS"
 */
...
public abstract class BaseBiAnalyDetailPars implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.BiAnalyDetailPars))
			return false;
		else {
			resource.bean.report.BiAnalyDetailPars biAnalyDetailPars = (resource.bean.report.BiAnalyDetailPars) obj;
			if (null == this.getId() || null == biAnalyDetailPars.getId())
				return false;
			else
				return (this.getId().equals(biAnalyDetailPars.getId()));
		}
	}
