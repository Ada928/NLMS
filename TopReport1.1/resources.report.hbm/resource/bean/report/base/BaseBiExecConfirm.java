...
/**
 * This is an object that contains data related to the BI_EXEC_CONFIRM table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="BI_EXEC_CONFIRM"
 */
...
public abstract class BaseBiExecConfirm implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.BiExecConfirm))
			return false;
		else {
			resource.bean.report.BiExecConfirm biExecConfirm = (resource.bean.report.BiExecConfirm) obj;
			if (null == this.getId() || null == biExecConfirm.getId())
				return false;
			else
				return (this.getId().equals(biExecConfirm.getId()));
		}
	}
