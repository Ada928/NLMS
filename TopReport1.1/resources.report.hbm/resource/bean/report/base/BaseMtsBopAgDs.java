...
/**
 * This is an object that contains data related to the MTS_BOP_AG_DS table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="MTS_BOP_AG_DS"
 */

public abstract class BaseMtsBopAgDs implements Serializable {

	public static String REF = "MtsBopAgDs";
	...
	public static String PROP_INCHARGECCY = "inchargeccy";
	 ...
	 */
	public BaseMtsBopAgDs(java.lang.String id) {
		this.setId(id);
		initialize();
	}
	 ...
	 */
	public BaseMtsBopAgDs(java.lang.String id, java.lang.String apptype, java.lang.String currentfile) {
	...
	/**
	 * Return the value associated with the column: INCHARGECCY
	 */
	...
	/**
	 * Set the value related to the column: INCHARGECCY
	 * 
	 * @param inchargeccy
	 *            the INCHARGECCY value
	 */
	...
	/**
	 * Return the value associated with the column: INCHARGEAMT
	 */
	...
	/**
	 * Set the value related to the column: INCHARGEAMT
	 * 
	 * @param inchargeamt
	 *            the INCHARGEAMT value
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.MtsBopAgDs))
			return false;
		else {
			resource.bean.report.MtsBopAgDs mtsBopAgDs = (resource.bean.report.MtsBopAgDs) obj;
			if (null == this.getId() || null == mtsBopAgDs.getId())
				return false;
			else
				return (this.getId().equals(mtsBopAgDs.getId()));
		}
	}
