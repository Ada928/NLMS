...
/**
 * This is an object that contains data related to the tla_ln_acct table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="tla_ln_acct"
 */
...
public abstract class BaseTlaLnAcct implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.TlaLnAcct))
			return false;
		else {
			resource.bean.report.TlaLnAcct tlaLnAcct = (resource.bean.report.TlaLnAcct) obj;
			if (null == this.getId() || null == tlaLnAcct.getId())
				return false;
			else
				return (this.getId().equals(tlaLnAcct.getId()));
		}
	}
