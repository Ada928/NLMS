 ...
 *
 * @hibernate.class table="vip_customer_his"
 */
...
public abstract class BaseVipCustomerHis implements Serializable {
	 ...
	 * 
	 * @param lastMonthClass
	 *            the last_month_class value
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.VipCustomerHis))
			return false;
		else {
			resource.bean.report.VipCustomerHis vipCustomerHis = (resource.bean.report.VipCustomerHis) obj;
			if (null == this.getId() || null == vipCustomerHis.getId())
				return false;
			else
				return (this.getId().equals(vipCustomerHis.getId()));
		}
	}
