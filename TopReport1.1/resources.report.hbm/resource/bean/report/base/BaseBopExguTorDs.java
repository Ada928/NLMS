...
/**
 * This is an object that contains data related to the BOP_EXGU_TOR_DS table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="BOP_EXGU_TOR_DS"
 */
...
public abstract class BaseBopExguTorDs implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.BopExguTorDs))
			return false;
		else {
			resource.bean.report.BopExguTorDs bopExguTorDs = (resource.bean.report.BopExguTorDs) obj;
			if (null == this.getId() || null == bopExguTorDs.getId())
				return false;
			else
				return (this.getId().equals(bopExguTorDs.getId()));
		}
	}
