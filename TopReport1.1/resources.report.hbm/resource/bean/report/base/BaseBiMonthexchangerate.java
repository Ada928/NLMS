...
/**
 * This is an object that contains data related to the BI_MONTHEXCHANGERATE
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="BI_MONTHEXCHANGERATE"
 */
...
public abstract class BaseBiMonthexchangerate implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.BiMonthexchangerate))
			return false;
		else {
			resource.bean.report.BiMonthexchangerate biMonthexchangerate = (resource.bean.report.BiMonthexchangerate) obj;
			if (null == this.getId() || null == biMonthexchangerate.getId())
				return false;
			else
				return (this.getId().equals(biMonthexchangerate.getId()));
		}
	}
