...
/**
 * This is an object that contains data related to the products_info table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="products_info"
 */
...
public abstract class BaseProductsInfo implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.ProductsInfo))
			return false;
		else {
			resource.bean.report.ProductsInfo productsInfo = (resource.bean.report.ProductsInfo) obj;
			if (null == this.getId() || null == productsInfo.getId())
				return false;
			else
				return (this.getId().equals(productsInfo.getId()));
		}
	}
