 ...
 *
 * @hibernate.class table="BI_WORKDATE_CONF"
 */
...
public abstract class BaseBiWorkdateConf implements Serializable {
	 ...
	 * 
	 * @hibernate.id column="WORKDATE_YEAR"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.BiWorkdateConf))
			return false;
		else {
			resource.bean.report.BiWorkdateConf biWorkdateConf = (resource.bean.report.BiWorkdateConf) obj;
			if (null == this.getId() || null == biWorkdateConf.getId())
				return false;
			else
				return (this.getId().equals(biWorkdateConf.getId()));
		}
	}
