...
/**
 * This is an object that contains data related to the SUB_FILE_INFO table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="SUB_FILE_INFO"
 */
...
public abstract class BaseSubFileInfo implements Serializable {
	 ...
	 */
	public BaseSubFileInfo(java.lang.String id, java.lang.String apptype, java.lang.String currentfile) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.SubFileInfo))
			return false;
		else {
			resource.bean.report.SubFileInfo subFileInfo = (resource.bean.report.SubFileInfo) obj;
			if (null == this.getId() || null == subFileInfo.getId())
				return false;
			else
				return (this.getId().equals(subFileInfo.getId()));
		}
	}
