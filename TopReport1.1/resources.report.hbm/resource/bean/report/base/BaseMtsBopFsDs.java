...
public abstract class BaseMtsBopFsDs implements Serializable {

	public static String REF = "MtsBopFsDs";
	...
	public static String PROP_PAYATTR = "payattr";
	 ...
	 */
	public BaseMtsBopFsDs(java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	/**
	 * Return the value associated with the column: PAYATTR
	 */
	...
	/**
	 * Set the value related to the column: PAYATTR
	 * 
	 * @param payattr
	 *            the PAYATTR value
	 */
