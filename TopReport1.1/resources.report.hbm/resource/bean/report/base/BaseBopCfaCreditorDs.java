...
/**
 * This is an object that contains data related to the BOP_CFA_CREDITOR_DS
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="BOP_CFA_CREDITOR_DS"
 */
...
public abstract class BaseBopCfaCreditorDs implements Serializable {
	 ...
	 * 
	 * @hibernate.id column="CREDITOR_ID"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.BopCfaCreditorDs))
			return false;
		else {
			resource.bean.report.BopCfaCreditorDs bopCfaCreditorDs = (resource.bean.report.BopCfaCreditorDs) obj;
			if (null == this.getId() || null == bopCfaCreditorDs.getId())
				return false;
			else
				return (this.getId().equals(bopCfaCreditorDs.getId()));
		}
	}
