...
/**
 * This is an object that contains data related to the BI_ACCOUNT table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="BI_ACCOUNT"
 */
...
public abstract class BaseBiAccount implements Serializable {
	 ...
	 * 
	 * @hibernate.id generator-class="sequence" column="ACCOUNT_ID"
	 */
	 ...
	 * 
	 * @param accAccountType
	 *            the ACC_ACCOUNT_TYPE value
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.BiAccount))
			return false;
		else {
			resource.bean.report.BiAccount biAccount = (resource.bean.report.BiAccount) obj;
			if (null == this.getId() || null == biAccount.getId())
				return false;
			else
				return (this.getId().equals(biAccount.getId()));
		}
	}
