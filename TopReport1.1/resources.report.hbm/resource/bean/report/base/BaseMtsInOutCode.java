...
/**
 * This is an object that contains data related to the MTS_IN_OUT_CODE table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="MTS_IN_OUT_CODE"
 */
...
public abstract class BaseMtsInOutCode implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.MtsInOutCode))
			return false;
		else {
			resource.bean.report.MtsInOutCode mtsInOutCode = (resource.bean.report.MtsInOutCode) obj;
			if (null == this.getId() || null == mtsInOutCode.getId())
				return false;
			else
				return (this.getId().equals(mtsInOutCode.getId()));
		}
	}
