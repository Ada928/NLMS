...
/**
 * This is an object that contains data related to the solder_count table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="solder_count"
 */
...
public abstract class BaseSolderCount implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.SolderCount))
			return false;
		else {
			resource.bean.report.SolderCount solderCount = (resource.bean.report.SolderCount) obj;
			if (null == this.getId() || null == solderCount.getId())
				return false;
			else
				return (this.getId().equals(solderCount.getId()));
		}
	}
