...
/**
 * This is an object that contains data related to the MTS_BOP_BHN_DS table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="MTS_BOP_BHN_DS"
 */

public abstract class BaseMtsBopBhnDs implements Serializable {

	public static String REF = "MtsBopBhnDs";
	 ...
	 */
	public BaseMtsBopBhnDs(java.lang.String id) {
		this.setId(id);
		initialize();
	}
	 ...
	 */
	public BaseMtsBopBhnDs(java.lang.String id, java.lang.String apptype, java.lang.String currentfile) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.report.MtsBopBhnDs))
			return false;
		else {
			resource.bean.report.MtsBopBhnDs mtsBopBhnDs = (resource.bean.report.MtsBopBhnDs) obj;
			if (null == this.getId() || null == mtsBopBhnDs.getId())
				return false;
			else
				return (this.getId().equals(mtsBopBhnDs.getId()));
		}
	}
