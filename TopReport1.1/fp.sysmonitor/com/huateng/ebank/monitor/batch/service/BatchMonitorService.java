...
public class BatchMonitorService {
	...
	public static synchronized BatchMonitorService getInstance() {
		return (BatchMonitorService) ApplicationContextUtils.getBean(BatchMonitorService.class.getName());
	}

	/** 获得批量步骤列表 */
	public List getBatchStepList(String bhDate, String statusCode) throws Exception {
