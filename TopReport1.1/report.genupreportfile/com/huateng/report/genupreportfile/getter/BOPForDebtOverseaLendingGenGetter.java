...
public class BOPForDebtOverseaLendingGenGetter extends BaseGetter {
	...
	public Result call() throws AppException {
		...
		try {
			...
			result.init();
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "外债境外同业拆借签约信息上报生成文件页面查询");
	...
	private PageQueryResult getData() throws CommonException {
		...
		return bopDebtService.queryGenRecordAD(pageIndex, pageSize, qActiontype, qBrNo, qfiller2,
				TopReportConstants.REPORT_APP_TYPE_CFA, TopReportConstants.REPORT_FILE_TYPE_CFA_AC, "");
