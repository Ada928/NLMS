 ...
 *         2012-8-15上午10:54:59
 */
public class BopForDebtFeiOrgSaveSignedGenGetter extends BaseGetter {
	...
	public PageQueryResult getData() throws CommonException, IllegalAccessException, InvocationTargetException {
		...
		return debtYinTuanService.queryFeiOrgSaveGen("signed", pageIndex, pageSize, qbrNo, qactiontype, qFiller2);
	}
}
