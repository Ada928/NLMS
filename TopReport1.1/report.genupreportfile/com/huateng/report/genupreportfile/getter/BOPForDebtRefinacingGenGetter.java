...
public class BOPForDebtRefinacingGenGetter extends BaseGetter {
	...
	public Result call() throws AppException {
		...
		try {
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "海外代付签约信息查询");
	...
	private PageQueryResult getData() throws CommonException {
		...
		return bopDebtService.queryGenRecordAD(pageIndex, pageSize, qActiontype, qBrNo, qfiller2,
				TopReportConstants.REPORT_APP_TYPE_CFA, TopReportConstants.REPORT_FILE_TYPE_CFA_AD, "");
