...
public class BOPForDebtNobleMetalGenGetter extends BaseGetter {
	...
	private PageQueryResult getData() throws CommonException, IllegalAccessException, InvocationTargetException {
		...
		return debtYinTuanService.queryFeiOrgSaveGen("signedsQuery", pageIndex, pageSize, qbrNo, qactiontype, qFiller2);
	}
