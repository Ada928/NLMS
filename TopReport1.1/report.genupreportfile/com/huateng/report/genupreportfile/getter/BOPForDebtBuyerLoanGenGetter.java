...
public class BOPForDebtBuyerLoanGenGetter extends BaseGetter {
	...
	private PageQueryResult getData() throws CommonException {
		...
		return bopDebtService.queryGenRecordAD(pageIndex, pageSize, qActiontype, qBrNo, filler2,
				TopReportConstants.REPORT_APP_TYPE_CFA, TopReportConstants.REPORT_FILE_TYPE_CFA_AB, "");
