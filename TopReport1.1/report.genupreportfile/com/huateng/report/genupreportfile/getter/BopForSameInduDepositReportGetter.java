...
public class BopForSameInduDepositReportGetter extends BaseGetter {
	...
	private PageQueryResult getData() throws AppException {
		this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "境外同业存放上报信息签约信息查询");
		...
		if (StringUtils.isNotBlank(qbrNo)) {
			hql.append(" and bds.br_No ='").append(qbrNo).append("'");
		}
		...
		hql.append(" and bds.work_Date ='").append(gi.getFileDate()).append("'");
		hql.append(" and  bds.rec_Status ='" + TopReportConstants.REPORT_RECSTATUS_05 + "'");
