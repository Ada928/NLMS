...
public class BOPForDebtBilLoanGenGetter extends BaseGetter {
	...
	public Result call() throws AppException {
		...
		try {
			...
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "外债双边贷款签约信息上报文件查询");
			// HtLog logger =
	...
	private PageQueryResult getData() throws CommonException {
		...
		return bopDebtService.queryGenRecordAD(pageIndex, pageSize, qActiontype, qBrNo, qFiller2,
				TopReportConstants.REPORT_APP_TYPE_CFA, TopReportConstants.REPORT_FILE_TYPE_CFA_AA, "");
