...
public class BopCfaStrdeDsGenService {
	 ...
	 */
	public PageQueryResult pageQueryByHql(String getType, String qactiontype, String qbrNo, String qfiller2,
			int pageSize, int pageIndex) throws CommonException {
		GlobalInfo globalInfo = GlobalInfo.getCurrentInstance();
		StringBuffer buff = new StringBuffer();
		List<Object> paramList = new ArrayList<Object>();
		buff.append(
				" from BopCfaStrdeDs model where model.workDate = ? and model.apptype = ? and model.recStatus = ? and model.repStatus = ?");
