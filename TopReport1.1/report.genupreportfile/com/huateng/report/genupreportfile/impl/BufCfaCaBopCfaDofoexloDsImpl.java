...
public class BufCfaCaBopCfaDofoexloDsImpl implements IGetSubFileList {
	...
	public List getSubFileResultList(Map<String, Object> paramMap) throws CommonException {
		...
		hqlBuff.append(" from BopCfaDofoexloDs model ").append(" where model.apptype = '" + appType).append("'")
