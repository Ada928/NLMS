...
import com.huateng.report.common.generator.GetSysTaskNoGentator;
...
public class ReportTaskUtil {
	...
	public static String[] getStrToArray(String str) throws CommonException {
		...
		if (!DataFormat.isEmpty(str)) {
			...
			if (strLen > Len) {
				...
				array[1] = str.substring(Len + 1, strLen);
			} else {
				array[0] = str;
			}
		}
	...
	private static String getTaskNo() throws CommonException {
		GetSysTaskNoGentator getSysTaskNoGentator = (GetSysTaskNoGentator) GeneratorFactory
				.getGenerator("GetSysTaskNoGentator");

		return getSysTaskNoGentator.gen(null);
	}
