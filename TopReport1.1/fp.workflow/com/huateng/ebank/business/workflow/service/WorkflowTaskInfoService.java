...
public class WorkflowTaskInfoService {
	...
	public static WorkflowTaskInfoService getInstance() {
		return (WorkflowTaskInfoService) ApplicationContextUtils.getBean(WorkflowTaskInfoService.class.getName());
	}
	...
	// * @version v1.0,2008-8-18
	// */
	// public void markTaskAssigned(String appno, String appType, String
	// taskName,
	...
	public WorkflowTaskInfo findTaskInfo(String appno, String appType, String taskName, String flowName, String piid)
		...
		// po.taskEndFlag <> '"+SystemConstant.FLAG_ON+"' order by id desc";
		List list = dao.queryByCondition(
	...
	// }
	//
	// public void markReject(String appno, String appType) throws
	// CommonException {
	// WorkflowAppInfoDAO wDao = DAOUtils.getWorkflowAppInfoDAO();
	// WorkflowAppInfo appInfo = wDao.queryById(appno);
	// if (appInfo == null) {
