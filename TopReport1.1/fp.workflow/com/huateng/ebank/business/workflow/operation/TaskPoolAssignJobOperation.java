...
public class TaskPoolAssignJobOperation extends BaseOperation {
	...
	public void execute(OperationContext context) throws CommonException {
		...
		for (int i = 0; i < taskList.size(); i++) {
			...
			// 工作流任务分配
			WorkFlowForwardTaskBean workFlowForwardTaskBean = new WorkFlowForwardTaskBean(disTlrno, disTlrno, disTlrno);
			...
			taskAssignService.insertOrUpdateTlrWorkload(disTlrno, null, null, SystemConstant.TASK_ASSIGN_MODE_1, false,
					false);
		}
	}
}
