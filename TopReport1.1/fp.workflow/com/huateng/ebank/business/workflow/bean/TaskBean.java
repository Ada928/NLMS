...
public class TaskBean {
	...
	public String getLimitLeftTime() {
		return limitLeftTime;
	}

	public void setLimitLeftTime(String limitLeftTime) {
		this.limitLeftTime = limitLeftTime;
	}
