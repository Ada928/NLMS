...
/**
 * ClassName:GetApproveTaskAssign Function: TODO ADD FUNCTION Reason: TODO ADD
 * REASON
 *
 * @author shen_antonio
 * @version
...
public class GetApproveTaskAssign implements AssignmentHandler {
	...
	public void assign(Assignable arg0, ExecutionContext arg1) throws Exception {
		...
		try {
			...
			// Map resultmap =
			// WorkFlowParamService.getInstance().getManualApproveTaskAssign(map);
			...
			// map.put("OPRNO_ARR",
			// WorkFlowParamService.getInstance().transArrayToString(arr));
