...
public class BankBlackListEntryGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		if (StringUtils.isNotBlank(qCertificateNumber)) {
			hql.append(" and bblt.certificateNumber = ?");
		...
		if(StringUtils.isNotBlank(qAccountCode)){
			hql.append(" and bblt.accountCode = ?");
			list.add(qAccountCode.trim());
			message.append("qAccountCode=").append(qAccountCode);

		}
		if(StringUtils.isNotBlank(qCardBkBookNo)){
			hql.append(" and bblt.cardBkBookNo = ?");
			list.add(qCardBkBookNo.trim());
			message.append("qCardBkBookNo=").append(qCardBkBookNo);
