 ...
 * author by getter
 */
public class PoliceBlackListManageGetter extends BaseGetter {

	public Result call() throws AppException {
		try {
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "公安部黑名单信息查询");
	...
	protected PageQueryResult getData() throws Exception {
		...
		if (!opType.equals("add")) {
			...
			NsPoliceBlackList bean = PoliceBlackListService.getInstance().selectById(id);
			list.add(bean);
