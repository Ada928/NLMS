...
public class PoliceBlackListGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		if(StringUtils.isNotBlank(qAccountCode)){
			hql.append(" and pblt.accountCode = '").append(qAccountCode.trim()).append("'");
		}
		if(StringUtils.isNotBlank(qCardBkBookNo)){
			hql.append(" and pblt.cardBkBookNo = '").append(qCardBkBookNo.trim()).append("'");
		}
		hql.append(" and rownum<10000 order by pblt.createDate desc ");
		/*else {
