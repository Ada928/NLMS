 ...
 */
public class RoleOperateLogQueryGetter extends BaseGetter {

	@Override
	public Result call() throws AppException {
		try {

			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "岗位操作日志查询");
	...
	private PageQueryResult getData() throws CommonException {
		...
		return service.pageQueryByHql(pageIndex, pageSize, qtlrNo, qtlrIP, qbrNo, startDate, endDate);
	}
}
