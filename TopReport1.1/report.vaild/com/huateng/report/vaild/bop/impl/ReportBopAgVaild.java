...
public class ReportBopAgVaild extends AbsReportDataVaild {
	...
	public String executeDataVaild(Object obj) {
		...
		if (ds.getCurrentfile().equals(TopReportConstants.REPORT_FILE_TYPE_BOP_A)) {
			...
			// CUSTYPE 收款人类型 字符型，1 "C－对公用户 D－对私中国居民 F－对私中国非居民
			...
			// OTHAMT 其它金额 数值型，22.0 "选输项，但不能小于0。
			// 若账号不为空则对应金额必须>0；若金额>0，则对应账号不能为空。
			// OTHACC 其它帐号/银行卡号 字符型，32
			// 如果有其他金额，则该字段不能为空，其他金额为0，则该字段不应该填写，其它金额、其它帐号或同时空，或同时有值。
			...
			// BILLNO 外汇局批件号/备案表号/业务编号 字符型，50
