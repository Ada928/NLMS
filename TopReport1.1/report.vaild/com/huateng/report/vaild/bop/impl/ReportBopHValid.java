...
public class ReportBopHValid extends AbsReportDataVaild {
	...
	public String executeDataVaild(Object obj) {
		...
		// 交易编码2 选输
		/*
		 * 必须在国际收支交易编码表中存在 不能与交易编码1相同， 没有输入交易编码时，相应金额及交易附言不应该填写。
		 * 有交易金额2或交易附言2时必填。
		 *
		 */
		...
		boolean tx2Flag1 = StringUtils.isEmpty(ds.getTxcode2()) && ds.getTc2amt() == null
				&& StringUtils.isEmpty(ds.getTx2rem());
		boolean tx2Flag2 = StringUtils.isNotEmpty(ds.getTxcode2()) && ds.getTc2amt() != null
				&& StringUtils.isNotEmpty(ds.getTx2rem());
