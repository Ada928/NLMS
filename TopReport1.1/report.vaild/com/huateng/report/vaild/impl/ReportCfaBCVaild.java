...
public class ReportCfaBCVaild extends AbsReportDataVaild {
	...
	public String executeDataVaild(Object obj) {
		...
		ds.getGuarantores();
		ds.getBeneficiarys();
		// result.append(this.exguTlrCodeVaild(ds.getBencountrycode(),
		// ds.getBentype(), "受益人代码"));
		/*
		 * Iterator it = ds.getBeneficiarys().iterator(); if(it.hasNext()){
		 * Beneficiary ben = (Beneficiary)it.next();
		 * result.append(this.exguTlrCodeVaild(ben.getBencountrycode(),
		 * ben.getBentype(), "受益人代码"));
		 * 
		 * }
		 */
