...
public class ReportCfaAA_ASVaild extends AbsReportDataVaild {
	...
	public String executeDataVaild(Object obj) {
		...
		if (TopReportConstants.REPORT_FILE_TYPE_CFA_AA.equals(eds.getCurrentfile())) {
			...
			result.append(validateCreditorCodeNull(eds.getCreditortype(), eds.getCreditorcode(),
					TopReportConstants.REPORT_FILE_TYPE_CFA_AA, eds.getCrehqcode()));
			...
			result.append(lessLenNull(eds.getCreditorcode(), 11, "债权人代码"));
			result.append(validateCreditorCodeNull(eds.getCreditortype(), eds.getCreditorcode(),
					TopReportConstants.REPORT_FILE_TYPE_CFA_AB, eds.getCrehqcode()));
			result.append(optionOne(eds.getCreditorname(), eds.getCreditornamen(), "债权人中文名称或英文名称"));
			result.append(lessLenNull(eds.getCreditorname(), 128, "债权人中文名称"));
			result.append(lessLenNull(eds.getCreditornamen(), 128, "债权人英文名称"));
			result.append(valLenByNotNull(eds.getCreditortype(), 8, "债权人类型代码"));
			...
			result.append(lessLenNull(eds.getCreditorcode(), 11, "债权人代码"));
			result.append(validateCreditorCodeNull(eds.getCreditortype(), eds.getCreditorcode(),
					TopReportConstants.REPORT_FILE_TYPE_CFA_AC, eds.getCrehqcode()));
			result.append(optionOne(eds.getCreditorname(), eds.getCreditornamen(), "债权人中文名称或英文名称"));
			result.append(lessLenNull(eds.getCreditorname(), 128, "债权人中文名称"));
			result.append(lessLenNull(eds.getCreditornamen(), 128, "债权人英文名称"));
			...
			result.append(lessLenNull(eds.getCreditorcode(), 11, "债权人代码"));
			result.append(validateCreditorCodeNull(eds.getCreditortype(), eds.getCreditorcode(),
					TopReportConstants.REPORT_FILE_TYPE_CFA_AD, eds.getCrehqcode()));
			result.append(optionOne(eds.getCreditorname(), eds.getCreditornamen(), "债权人中文名称或英文名称"));
			result.append(valLenByNotNull(eds.getCreditortype(), 8, "债权人类型代码"));
			result.append(valLenByNotNull(eds.getCrehqcode(), 3, "债权人总部所在国家（地区）代码"));
			result.append(valLenByNotNull(eds.getOpercode(), 3, "债权人经营地所在国家（地区）代码"));
			...
			if (eds.getActiontype().equals(TopReportConstants.REPORT_ACTIONTYPE_D)) {
				...
				result.append(
						exbuiSeNumVaild(eds.getActiontype(), eds.getCurrentfile(), eds.getFiller2(), eds.getBrNo()));
				result.append(valLenByNotNull(eds.getExdebtcode(), 28, "外债编号"));
				result.append(lessLen(eds.getDebtorcode(), 12, "债务人代码"));
				result.append(valLenByNotNull(eds.getDebtype(), 4, "债务类型"));
				result.append(valLenByNotNull(eds.getValuedate(), 8, "起息日"));
				...
				result.append(lessLenNull(eds.getCreditorcode(), 11, "债权人代码"));
				result.append(validateCreditorCodeNull(eds.getCreditortype(), eds.getCreditorcode(),
						TopReportConstants.REPORT_FILE_TYPE_CFA_AE, eds.getCrehqcode()));
			...
			if (eds.getActiontype().equals(TopReportConstants.REPORT_ACTIONTYPE_D)) {
				...
				result.append(lessLenNull(eds.getCreditorcode(), 11, "债权人代码"));
				result.append(validateCreditorCodeNull(eds.getCreditortype(), eds.getCreditorcode(),
						TopReportConstants.REPORT_FILE_TYPE_CFA_AF, eds.getCrehqcode()));
			...
			return result.toString();
		} else if (TopReportConstants.REPORT_FILE_TYPE_CFA_AG.equals(eds.getCurrentfile())) {
			result.append(checkActiontype(eds.getActiontype()));
			if (eds.getActiontype().equals(TopReportConstants.REPORT_ACTIONTYPE_D)) {
				result.append(isDelRemarkVaild(eds.getActiontype(), eds.getActiondesc()));
				result.append(lessLen(eds.getActiondesc(), 128, "删除原因"));
				...
				for (BopCfaCreditorDs ds : queryBopCfaCreditorDsList) {
					...
					result.append(validateCreditorCodeNull(ds.getCreditortype(), ds.getCreditorcode(),
							TopReportConstants.REPORT_FILE_TYPE_CFA_AG, ds.getCrehqcode()));
			...
			if (eds.getActiontype().equals(TopReportConstants.REPORT_ACTIONTYPE_D)) {
				...
				result.append(lessLenNull(eds.getCreditorcode(), 11, "债权人代码"));
				result.append(validateCreditorCodeNull(eds.getCreditortype(), eds.getCreditorcode(),
						TopReportConstants.REPORT_FILE_TYPE_CFA_AH, eds.getCrehqcode()));
			...
			if (eds.getCreditors() == null || eds.getCreditors().size() == 0) {
				...
				result.append(validateCreditorCodeNull(creditords.getCreditortype(), creditords.getCreditorcode(),
						TopReportConstants.REPORT_FILE_TYPE_CFA_AI, eds.getCrehqcode()));

				// 债权人中文名称 字符型，128 非必填项， 债权人中文名称和债权人英文名称至少填写一个。
				// 债权人英文名称 字符型，128 非必填项， 债权人中文名称和债权人英文名称至少填写一个。
				result.append(
						optionOne(creditords.getCreditorname(), creditords.getCreditornamen(), "债权人中文名称和债权人英文名称"));
			...
			// 是否经外汇局特批不需占用指标 字符型，1 必填项，是-Y，否-N，默认为否，填写N。
			result.append(isYorNAndNotNull(eds.getSpapfeboindex(), "是否经外汇局特批不需占用指标"));
			// ISIN CODE 字符型，12 必填项，国际证券识别编码， ISIN
			// CODE的编码规则为：共12位。第1-2位为字母，用于标识国别；第3-11位为数字和字母，为国内证券识别编码；第12位为数字，为校对码。
			...
			if (eds.getCreditors() == null || eds.getCreditors().size() == 0) {
				...
				result.append(valLenByNotNull(creditords.getCreditortype(), 8, "债权人类型代码"));
				result.append(validateCreditorCodeNull(creditords.getCreditortype(), creditords.getCreditorcode(),
						TopReportConstants.REPORT_FILE_TYPE_CFA_AJ, creditords.getCrehqcode()));
			...
			if (eds.getCreditors() == null || eds.getCreditors().size() == 0) {
				...
				result.append(validateCreditorCodeNull(creditords.getCreditortype(), creditords.getCreditorcode(),
						TopReportConstants.REPORT_FILE_TYPE_CFA_AK, creditords.getCrehqcode()));
				// 债权人中文名称 字符型，128 非必填项， 债权人中文名称和债权人英文名称至少填写一个。
				// 债权人英文名称 字符型，128 非必填项， 债权人中文名称和债权人英文名称至少填写一个。
				result.append(
						optionOne(creditords.getCreditorname(), creditords.getCreditornamen(), "债权人中文名称和债权人英文名称"));
			...
			if (eds.getCreditors() == null || eds.getCreditors().size() == 0) {
				...
				result.append(validateCreditorCodeNull(creditords.getCreditortype(), creditords.getCreditorcode(),
						TopReportConstants.REPORT_FILE_TYPE_CFA_AL, creditords.getCrehqcode()));
			...
			if (eds.getCreditors() == null || eds.getCreditors().size() == 0) {
				...
				result.append(validateCreditorCodeNull(creditords.getCreditortype(), creditords.getCreditorcode(),
						TopReportConstants.REPORT_FILE_TYPE_CFA_AM, creditords.getCrehqcode()));
			...
			result.append(validateCreditorCodeNull(eds.getCreditortype(), eds.getCreditorcode(),
					TopReportConstants.REPORT_FILE_TYPE_CFA_AN, eds.getCrehqcode()));
			...
			result.append(validateCreditorCodeNull(eds.getCreditortype(), eds.getCreditorcode(),
					TopReportConstants.REPORT_FILE_TYPE_CFA_AP, eds.getCrehqcode()));
			...
			result.append(validateCreditorCodeNull(eds.getCreditortype(), eds.getCreditorcode(),
					TopReportConstants.REPORT_FILE_TYPE_CFA_AQ, eds.getCrehqcode()));
