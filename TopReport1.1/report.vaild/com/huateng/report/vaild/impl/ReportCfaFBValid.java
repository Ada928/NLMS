...
/**
 * @author Administrator 商业银行人民币结构性存款终止信息验证
 */
public class ReportCfaFBValid extends AbsReportDataVaild {
	...
	public String executeDataVaild(Object obj) {
		...
		// 9.必填项，大于等于0。 终止支付金额合计折人民币
		// 人民币结构性存款合同终止后，支付金额合计折人民币值，等于终止人民币支付金额+终止外币支付金额折人民币。
	...
	private String sameOrNotSynchronic(BopCfaStrdeDs bopCfaStrdeDs) {
		...
		BigDecimal terpaycurram = bopCfaStrdeDs.getTerpaycurram();
		if (!(((terpaycurr == null || terpaycurr.length() == 0) && terpaycurram == null)
				|| ((terpaycurr != null && terpaycurr.length() != 0) && terpaycurram != null))) {
	 ...
	 *
	 */
	private String equalOrNotResultString(BigDecimal terpaycurram, String terpaycurr, String workDate,
			BigDecimal terrmbpayam, BigDecimal terpayamtormb) {
		StringBuffer buff = new StringBuffer();
		// 如果没有终止外币支付金额
