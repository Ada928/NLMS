...
public class ReportCfaCBVaild extends AbsReportDataVaild {
	...
	public String executeDataVaild(Object obj) {
		 ...
		 * result.append(this.isDelRemarkVaild(ds.getActiontype(),
		 * ds.getActiondesc()));
		 ...
		 * result.append(this.optionOne(ds.getBename(), ds.getBenamen(),
		 * "中文名称和英文名称")); result.append(this.optionOne(ds.getGuappname(),
		 * ds.getGuappnamen(), "中文名称和英文名称"));
		 */
		/*
		 ...
		 * result.append(this.valLenByNotNull(ds.getGuarantorcode(), 12,
		 * "担保人代码")); result.append(this.lessLen(ds.getBuscode(),32,"银行业务参号"));
		 * result.append(this.optionOne(ds.getBename(), ds.getBenamen(),
		 * "中文名称和英文名称"));
		 * result.append(this.dateLessCheckDateOrEqual(ds.getGuperdate(),ds.
		 * getContractdate(),"履约日期","签约日期"));
		...
		result.append(this.notZeroNotNull2(ds.getWithamount(), ds.getSettamount(), ds.getWithcurrence(), "提款币种", "提款金额",
				"结汇金额"));
