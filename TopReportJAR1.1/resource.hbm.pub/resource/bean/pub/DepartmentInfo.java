...
import resource.bean.pub.base.AbstractDepartmentInfo;
...
public class DepartmentInfo extends AbstractDepartmentInfo implements java.io.Serializable {
	...
	/** minimal constructor */
	public DepartmentInfo(long departmentCode, String departmentName, String brcode, String status) {
		super(departmentCode, departmentName, brcode, status);
	}
