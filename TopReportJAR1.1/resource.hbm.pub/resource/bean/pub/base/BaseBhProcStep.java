...
/**
 * This is an object that contains data related to the BH_PROC_STEP table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="BH_PROC_STEP"
 */
...
public abstract class BaseBhProcStep implements Serializable {
	 ...
	 */
	public BaseBhProcStep(java.lang.Integer id, java.lang.Integer jobno, java.lang.Integer step,
			java.lang.Integer subStep, java.lang.String processFunction) {
	 ...
	 * 
	 * @param reportDataFlag
	 *            the REPORT_DATA_FLAG value
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.pub.BhProcStep))
			return false;
		else {
			resource.bean.pub.BhProcStep bhProcStep = (resource.bean.pub.BhProcStep) obj;
			if (null == this.getId() || null == bhProcStep.getId())
				return false;
			else
				return (this.getId().equals(bhProcStep.getId()));
		}
	}
