...
public abstract class BaseRoleOperateLog implements Serializable {
	 ...
	 */
	public BaseRoleOperateLog(java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof resource.bean.pub.BctlOperateLog))
			...
			resource.bean.pub.RoleOperateLog roleOperateLog = (resource.bean.pub.RoleOperateLog) obj;
			if (null == this.getId() || null == roleOperateLog.getId())
				return false;
			else
				return (this.getId().equals(roleOperateLog.getId()));
		}
	}
