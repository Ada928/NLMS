...
public abstract class BaseBctlOperateLog implements Serializable {

	public static String REF = "BaseBctlOperateLog";
	public static String PROP_MESSAFE = "message";
	public static String PROP_TLRNO = "tlrco";
	 ...
	 */
	public BaseBctlOperateLog(java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof resource.bean.pub.BctlOperateLog))
			...
			resource.bean.pub.BctlOperateLog bctlOperateLog = (resource.bean.pub.BctlOperateLog) obj;
			if (null == this.getId() || null == bctlOperateLog.getId())
				return false;
			else
				return (this.getId().equals(bctlOperateLog.getId()));
		}
	}
