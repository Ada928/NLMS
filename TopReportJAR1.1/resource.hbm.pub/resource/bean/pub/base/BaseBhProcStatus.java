...
/**
 * This is an object that contains data related to the BH_PROC_STATUS table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="BH_PROC_STATUS"
 */
...
public abstract class BaseBhProcStatus implements Serializable {
	 ...
	 */
	public BaseBhProcStatus(java.lang.Integer id, java.util.Date bhdate, java.lang.Integer jobno,
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof resource.bean.pub.BhProcStatus))
			return false;
		else {
			resource.bean.pub.BhProcStatus bhProcStatus = (resource.bean.pub.BhProcStatus) obj;
			if (null == this.getId() || null == bhProcStatus.getId())
				return false;
			else
				return (this.getId().equals(bhProcStatus.getId()));
		}
	}
