...
/**
 * This is an object that contains data related to the WORKFLOW_TASK_POOL table.
 * Do not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="WORKFLOW_TASK_POOL"
 */

public abstract class BaseWorkflowTaskPool implements Serializable {

	public static String REF = "WorkflowTaskPool";
	 ...
	 */
	public BaseWorkflowTaskPool(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.String assignFlag;
	...
	/**
	 * Return the value associated with the column: ASSIGN_FLAG
	 */
	public java.lang.String getAssignFlag() {
		return assignFlag;
	}

	/**
	 * Set the value related to the column: ASSIGN_FLAG
	 * 
	 * @param assignFlag
	 *            the ASSIGN_FLAG value
	 */
	public void setAssignFlag(java.lang.String assignFlag) {
	...
	/**
	 * Return the value associated with the column: ASSIGN_TIME
	 */
	...
	/**
	 * Set the value related to the column: ASSIGN_TIME
	 * 
	 * @param assignTime
	 *            the ASSIGN_TIME value
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.huateng.ebank.entity.data.workflow.WorkflowTaskPool))
			return false;
		else {
			com.huateng.ebank.entity.data.workflow.WorkflowTaskPool workflowTaskPool = (com.huateng.ebank.entity.data.workflow.WorkflowTaskPool) obj;
			if (null == this.getId() || null == workflowTaskPool.getId())
				return false;
			else
				return (this.getId().equals(workflowTaskPool.getId()));
		}
	}
