 ...
 *
 * @hibernate.class table="WORKFLOW_ROUTE_DEF"
 */
...
public abstract class BaseWorkflowRouteDef implements Serializable {
	 ...
	 */
	public BaseWorkflowRouteDef(java.lang.Integer id, java.lang.String routeName, java.lang.String brhClass) {
	 ...
	 * 
	 * @hibernate.id generator-class="sequence" column="ROUTE_ID"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof WorkflowRouteDef))
			return false;
		else {
			WorkflowRouteDef workflowRouteDef = (WorkflowRouteDef) obj;
			if (null == this.getId() || null == workflowRouteDef.getId())
				return false;
			else
				return (this.getId().equals(workflowRouteDef.getId()));
		}
	}
