...
/**
 * This is an object that contains data related to the WORKFLOW_PARAM_BINDING
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="WORKFLOW_PARAM_BINDING"
 */
...
public abstract class BaseWorkflowParamBinding implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.huateng.ebank.entity.data.workflow.WorkflowParamBinding))
			return false;
		else {
