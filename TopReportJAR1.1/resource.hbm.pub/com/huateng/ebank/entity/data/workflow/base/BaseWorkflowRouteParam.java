...
public abstract class BaseWorkflowRouteParam implements Serializable {

	public static String REF = "WorkflowRouteParam";
	 ...
	 */
	public BaseWorkflowRouteParam(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	 ...
	 */
	public BaseWorkflowRouteParam(java.lang.Integer id, java.lang.Integer stopId, java.lang.Integer routeId) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof WorkflowRouteParam))
			return false;
		else {
			WorkflowRouteParam workflowRouteParam = (WorkflowRouteParam) obj;
			if (null == this.getId() || null == workflowRouteParam.getId())
				return false;
			else
				return (this.getId().equals(workflowRouteParam.getId()));
		}
	}
