...
/**
 * This is an object that contains data related to the WORKFLOW_ROUTE_BINDING
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="WORKFLOW_ROUTE_BINDING"
 */
...
public abstract class BaseWorkflowRouteBinding implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.huateng.ebank.entity.data.workflow.WorkflowRouteBinding))
			return false;
		else {
			...
			if (null == this.getId() || null == workflowRouteBinding.getId())
				return false;
			else
				return (this.getId().equals(workflowRouteBinding.getId()));
		}
	}
