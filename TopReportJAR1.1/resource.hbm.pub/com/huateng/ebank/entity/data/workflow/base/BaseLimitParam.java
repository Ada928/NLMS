...
/**
 * This is an object that contains data related to the LIMIT_PARAM table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="LIMIT_PARAM"
 */
...
public abstract class BaseLimitParam implements Comparable, Serializable {
	 ...
	 */
	public BaseLimitParam(long id, java.lang.String tlrno, java.lang.String bizClass, java.lang.String bizSubclass) {
	 ...
	 * 
	 * @param limitMinamount
	 *            the LIMIT_MINAMOUNT value
	 */
	 ...
	 * 
	 * @param limitMaxamount
	 *            the LIMIT_MAXAMOUNT value
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.huateng.ebank.entity.data.workflow.LimitParam))
			return false;
		else {
