...
/**
 * This is an object that contains data related to the TLR_WORKLOAD table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="TLR_WORKLOAD"
 */
...
public abstract class BaseTlrWorkload implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.huateng.ebank.entity.data.TlrWorkload))
			return false;
		else {
			com.huateng.ebank.entity.data.TlrWorkload tlrWorkload = (com.huateng.ebank.entity.data.TlrWorkload) obj;
			if (null == this.getTlrno() || null == tlrWorkload.getTlrno())
				return false;
			else
				return (this.getTlrno().equals(tlrWorkload.getTlrno()));
		}
	}
