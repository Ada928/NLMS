 ...
 *
 * @hibernate.class table="ROLE_REPORT_PARAM"
 */
...
public abstract class BaseRoleReportParam implements Serializable {
	 ...
	 */
	public BaseRoleReportParam(java.lang.String reportType, java.lang.Integer roleId) {
	...
	/**
	 * @hibernate.property column=ROLE_ID not-null=true
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.huateng.ebank.entity.data.mng.RoleReportParam))
			return false;
		else {
