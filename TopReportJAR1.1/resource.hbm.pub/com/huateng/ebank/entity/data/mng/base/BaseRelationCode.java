...
/**
 * This is an object that contains data related to the RELATION_CODE table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="RELATION_CODE"
 */
...
public abstract class BaseRelationCode implements Comparable, Serializable {
	 ...
	 */
	public BaseRelationCode(java.lang.String id, java.lang.String relationName, java.lang.String cusType,
	 ...
	 * 
	 * @hibernate.id generator-class="assigned" column="RELATION_CODE"
	 */
	 ...
	 * 
	 * @param needMemorabilia
	 *            the NEED_MEMORABILIA value
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.huateng.ebank.entity.data.mng.RelationCode))
			return false;
		else {
			com.huateng.ebank.entity.data.mng.RelationCode relationCode = (com.huateng.ebank.entity.data.mng.RelationCode) obj;
			if (null == this.getId() || null == relationCode.getId())
				return false;
			else
				return (this.getId().equals(relationCode.getId()));
		}
	}
