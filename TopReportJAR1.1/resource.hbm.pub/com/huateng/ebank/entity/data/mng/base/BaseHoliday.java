...
/**
 * This is an object that contains data related to the HOLIDAY table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="HOLIDAY"
 */
...
public abstract class BaseHoliday implements Comparable, Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.huateng.ebank.entity.data.mng.Holiday))
			return false;
		else {
			com.huateng.ebank.entity.data.mng.Holiday holiday = (com.huateng.ebank.entity.data.mng.Holiday) obj;
			if (null == this.getId() || null == holiday.getId())
				return false;
			else
				return (this.getId().equals(holiday.getId()));
		}
	}
