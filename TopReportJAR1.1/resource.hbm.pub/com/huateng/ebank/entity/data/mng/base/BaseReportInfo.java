...
/**
 * This is an object that contains data related to the REPORT_INFO table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="REPORT_INFO"
 */
...
public abstract class BaseReportInfo implements Serializable {
	 ...
	 * 
	 * @hibernate.id generator-class="assigned" column="REPORT_TYPE"
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.huateng.ebank.entity.data.mng.ReportInfo))
			return false;
		else {
			com.huateng.ebank.entity.data.mng.ReportInfo reportInfo = (com.huateng.ebank.entity.data.mng.ReportInfo) obj;
			if (null == this.getReportType() || null == reportInfo.getReportType())
				return false;
			else
				return (this.getReportType().equals(reportInfo.getReportType()));
		}
	}
