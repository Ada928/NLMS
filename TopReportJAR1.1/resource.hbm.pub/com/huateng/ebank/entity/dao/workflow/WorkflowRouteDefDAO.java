...
public class WorkflowRouteDefDAO extends HibernateDaoSupport {
	...
	public WorkflowRouteDef query(Integer id) throws CommonException {
		try {
			return (WorkflowRouteDef) this.getHibernateTemplate().load(WorkflowRouteDef.class, id);
		} catch (Exception e) {
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_DEF_SELECT, e);
		}
		return null;
	}
	...
	public List queryByCondition(String whereString, Object[] objArray, Type[] typeArray) throws CommonException {
		try {
			List list = this.getHibernateTemplate().find("from WorkflowRouteDef po where " + whereString, objArray);
			return list;
		} catch (Exception e) {
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_DEF_SELECT, e);
		}
	...
	public List queryByCondition(String whereString) throws CommonException {
		try {
			List list = this.getHibernateTemplate().find("from WorkflowRouteDef po where " + whereString);
			return list;
		} catch (Exception e) {
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_DEF_SELECT, e);
		}
	...
	public void update(WorkflowRouteDef po) throws CommonException {
		try {
			...
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_DEF_UPDATE, e);
		}
	}
	...
	public void insert(WorkflowRouteDef po) throws CommonException {
		try {
			...
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_DEF_INSERT, e);
		}
	}
	...
	public void delete(WorkflowRouteDef po) throws CommonException {
		try {
			...
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_DEF_DELETE, e);
		}
	}
