...
public class WorkflowRouteParamDAO extends HibernateDaoSupport {
	...
	public WorkflowRouteParam query(long id) throws CommonException {
		try {
			return (WorkflowRouteParam) this.getHibernateTemplate().load(WorkflowRouteParam.class, new Long(id));
		} catch (Exception e) {
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_PARAM_SELECT, e);
		}
		return null;
	}
	...
	public List queryByCondition(String whereString, Object[] objArray, Type[] typeArray) throws CommonException {
		try {
			List list = this.getHibernateTemplate().find("from WorkflowRouteParam po where " + whereString, objArray);
			return list;
		} catch (Exception e) {
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_PARAM_SELECT, e);
		}
	...
	public List queryByCondition(String whereString) throws CommonException {
		try {
			List list = this.getHibernateTemplate().find("from WorkflowRouteParam po where " + whereString);
			return list;
		} catch (Exception e) {
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_PARAM_SELECT, e);
		}
	...
	public void update(WorkflowRouteParam po) throws CommonException {
		try {
			...
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_PARAM_UPDATE, e);
		}
	}
	...
	public void insert(WorkflowRouteParam po) throws CommonException {
		try {
			...
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_PARAM_INSERT, e);
		}
	}
	...
	public void delete(WorkflowRouteParam po) throws CommonException {
		try {
			...
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_PARAM_DELETE, e);
		}
		// try {
		// delete(po.getId());
		// } catch (Exception e) {
