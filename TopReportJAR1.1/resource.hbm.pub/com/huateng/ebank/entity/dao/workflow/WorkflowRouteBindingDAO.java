...
public class WorkflowRouteBindingDAO extends HibernateDaoSupport {
	...
	public WorkflowRouteBinding query(Integer id) throws CommonException {
		try {
			return (WorkflowRouteBinding) this.getHibernateTemplate().load(WorkflowRouteBinding.class, id);
		} catch (Exception e) {
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_BINDING_SELECT, e);
		}
		return null;
	}
	...
	public List queryByCondition(String whereString, Object[] objArray, Type[] typeArray) throws CommonException {
		try {
			List list = this.getHibernateTemplate().find("from WorkflowRouteBinding po where " + whereString, objArray);
			return list;
		} catch (Exception e) {
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_BINDING_SELECT, e);
		}
	...
	public List queryByCondition(String whereString) throws CommonException {
		try {
			List list = this.getHibernateTemplate().find("from WorkflowRouteBinding po where " + whereString);
			return list;
		} catch (Exception e) {
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_BINDING_SELECT, e);
		}
	...
	public void update(WorkflowRouteBinding po) throws CommonException {
		try {
			...
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_BINDING_UPDATE, e);
		}
	}
	...
	public void insert(WorkflowRouteBinding po) throws CommonException {
		try {
			...
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_BINDING_INSERT, e);
		}
	}
	...
	public void delete(WorkflowRouteBinding po) throws CommonException {
		try {
			...
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_ROUTE_BINDING_DELETE, e);
		}
	}
