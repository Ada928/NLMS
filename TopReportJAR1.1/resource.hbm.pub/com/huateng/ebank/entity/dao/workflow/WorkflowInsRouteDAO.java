...
public class WorkflowInsRouteDAO extends HibernateDaoSupport {
	...
	public WorkflowInsRoute query(long id) throws CommonException {
		try {
			return (WorkflowInsRoute) this.getHibernateTemplate().load(WorkflowInsRoute.class, new Long(id));
		} catch (Exception e) {
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_INS_ROUTE_SELECT, e);
		}
		return null;
	}
	...
	public List queryByCondition(String whereString, Object[] objArray, Type[] typeArray) throws CommonException {
		try {
			List list = this.getHibernateTemplate().find("from WorkflowInsRoute po where " + whereString, objArray);
			return list;
		} catch (Exception e) {
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_INS_ROUTE_SELECT, e);
		}
	...
	public List queryByCondition(String whereString) throws CommonException {
		try {
			List list = this.getHibernateTemplate().find("from WorkflowInsRoute po where " + whereString);
			return list;
		} catch (Exception e) {
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_INS_ROUTE_SELECT, e);
		}
	...
	public void update(WorkflowInsRoute po) throws CommonException {
		try {
			...
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_INS_ROUTE_UPDATE, e);
		}
	}
	...
	public void insert(WorkflowInsRoute po) throws CommonException {
		try {
			...
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_INS_ROUTE_INSERT, e);
		}
	}
	...
	public void delete(WorkflowInsRoute po) throws CommonException {
		try {
			...
			ExceptionUtil.throwCommonException(e.getMessage(), ErrorCode.ERROR_CODE_WORKFLOW_INS_ROUTE_DELETE, e);
		}
	}
