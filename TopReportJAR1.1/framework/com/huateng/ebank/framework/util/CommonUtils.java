...
public class CommonUtils {
	...
	/**
	 * 比较浮点数相等性时的默认容忍值。容忍值一般为最小精度的一半， 这里的容忍值是建立在最小精度为0.01的情况下的(金额计算通常精度为分)
	 */
	 ...
	 * 保存审批历史
	 */
	public static void saveAppltyDtl(String appno, String attitude, String reason, String appType)
	 ...
	 */
	public static Object copyProperties(Object dest, Object orig) throws CommonException {
		try {
	...
	// del by zhaozhiguo
	// public static void processAccount(Integer txnLogId) throws
	// CommonException{
