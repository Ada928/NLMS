...
import com.huateng.commquery.servlet.CommQueryInterfaceServlet;
...
/**
 * Title: BankCommQueryInterfaceServlet Description: Copyright: Copyright (c)
 * 2008 Company: Shanghai Huateng Software Systems Co., Ltd.
 * 
 * @author shen_antonio
 * @version 1.1, 2008-1-1
 */
public class BankCommQueryInterfaceServlet extends CommQueryInterfaceServlet {
	private static final Log log = LogFactory.getLog(BankCommQueryInterfaceServlet.class);

	/** memeber variable: long serialVersionUID. */
	private static final long serialVersionUID = -565921392763903597L;
