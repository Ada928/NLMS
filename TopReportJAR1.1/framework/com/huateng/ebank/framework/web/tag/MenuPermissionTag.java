...
public class MenuPermissionTag extends BodyTagSupport {
	...
	public int doStartTag() throws JspException {
		...
		// try{
		// globalInfo =
		// GlobalInfo.getFromRequest((HttpServletRequest)this.pageContext.getRequest());
		...
		// operationContext.setAttribute(MenuPermissionOperation.IN_PARAM_MENU,
		// menu);
		// operationContext.setAttribute(MenuPermissionOperation.IN_PARAM_TLRNO,
		// tlrno);
		// try{
