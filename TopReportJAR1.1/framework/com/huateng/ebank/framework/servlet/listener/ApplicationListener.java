...
public class ApplicationListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent event) {
		log.info("sessionBetweenSessionTime="
				+ event.getServletContext().getInitParameter(SESSION_BETWEEN_SESSION_TIME));
		System.setProperty(SESSION_BETWEEN_SESSION_TIME,
				event.getServletContext().getInitParameter(SESSION_BETWEEN_SESSION_TIME));
		...
		try {
			...
			/** modify by shen_antonio 2009-7-28.BMS-2373 end */
			/**
			 * add jiang@2009-11-03 BMS-2142 系统启动时，将操作员状态重置为未登录状态
			 */
	...
	/**
	 * add by jornezhang 20100104 BMS-2389 设置系统类型 系统启动时，初始化系统类型
	 * 
	 * @author JorneZhang
	 * @throws HuatengException
	 * @version 创建时间：2010-1-4 上午10:20:42
	 */
	protected void setBmsSystemType() throws HuatengException {
		try {
			...
			// Globalinfo gi =
			// dao.findById(SystemConstant.TABLE_GLOBAL_INFO_ID);
