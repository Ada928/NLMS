...
/**
 * Title: WorkFlowParamConfigReader Description: 读取配置文件workflowparam.properties。
...
public class WorkFlowParamConfigReader {
	...
	// SystemConstant.WORK_FLOW_PARAM_CONFFILENAME;
	private static String bundle_name;

	static {
		try {
			bundle_name = ConfigReader.getProperty("gd.workflow.param");
			;// 用于流程参数文件配置,可参考gd.properties
