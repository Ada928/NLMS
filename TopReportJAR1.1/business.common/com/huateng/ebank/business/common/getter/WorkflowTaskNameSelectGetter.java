...
public class WorkflowTaskNameSelectGetter extends BaseGetter {
	...
	public Result call() throws AppException {
		...
		// Session session =
		// dao.getHibernateTemplate().getSessionFactory().getCurrentSession();
		...
		try {
			...
			//
			// hql.append("select po from BranchInfo po where (po.brhNo like
			// '"+value+"' or po.brhName like '"+value+"' and po.brhAttr =
			// '0')");
			//
