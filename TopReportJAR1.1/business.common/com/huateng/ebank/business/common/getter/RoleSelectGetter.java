...
public class RoleSelectGetter extends BaseGetter {
	...
	public Result call() throws AppException {
		...
		// String custId =
		// (String)getCommQueryServletRequest().getParameter("custId");
		...
		// int custid =0;//
		// globalInfo.getCustId();//GlobalInfo中去掉了custId，编译不通过，所以注释掉！！！做该模块的人请修改该代码！！----涂缘
		//
		// list =
		// BaseDAOUtils.getRoleInfoDAO().findByStatus(SystemConstant.VALID_FLAG_VALID);
