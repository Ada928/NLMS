		...
		try {
			...
			if (funcLogFlag != null && !funcLogFlag.equals("")) {
				if (txnLogFlag != null && txnLogFlag.equals("true") && funcLogFlag.equals("true")) {
					...
					bizLog.setTxnRunTime(
							com.huateng.common.DateUtil.comparaTime(globalInfo.getTxnStartTime(), endTime));
					// 机构号
					...
					if (globalInfo.getTxnStatus() != null
							&& !globalInfo.getTxnStatus().equals(BaseGlobalData.TXN_STATUS_02_S)) {
