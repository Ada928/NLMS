...
public class CommonService {
	 ...
	 * @throws CommonException
	 */
	public String getAppno(String apptype, String brcode) throws CommonException {
		GetAppnoGenerator getAppnoGenertor = (GetAppnoGenerator) GeneratorFactory.getGenerator("GetAppnoGenerator");
	 ...
	 * @throws CommonException
	 */
	public String getAppno2(String apptype, String brcode) throws CommonException {
	...
	public synchronized int getSeqno(int valueNo, String valueIndex) throws CommonException {
	 ...
	 * @author yang jenny
	 */
	public String getCreditNo(String preIndex, String busiType) throws CommonException {
	...
	public int getCreditRealId() throws CommonException {
		int creditRealId = CommonService.getInstance().getSeqno(SystemConstant.VALUE_NO_CREDITREALID,
	 ...
	 */
	public String getCustcd(String custType, String corpCodeType) throws CommonException {
	...
	public boolean isSubBranchRole() throws CommonException {
		...
		if (SystemConstant.BRCODE_CLASS_SUBBRANCH.equals(brclass)) {// 支行行长
			return true;
		}
		return false;
	}
	...
	public boolean isBranchRole() throws CommonException {
		GlobalInfo gi = GlobalInfo.getCurrentInstance();
		String brclass = gi.getBrClass();
		if (SystemConstant.BRCODE_CLASS_BRANCH.equals(brclass)) {// 分行行长
			return true;
		}
		return false;
		/*
	...
	public boolean isChiefBranchRole() throws CommonException {
		GlobalInfo gi = GlobalInfo.getCurrentInstance();
		String brclass = gi.getBrClass();
		if (SystemConstant.BRCODE_CLASS_HEAD.equals(brclass)) {// 总行行长
			return true;
		}
		return false;
		/*
	 ...
	 * @throws CommonException
	 */
	public String getProductCreditno(String custCreditNo, String curcd, String productType) throws CommonException {
	 ...
	 * @throws CommonException
	 */
	public String getBreedCreditno(String productCreditNo, String breedType, String useType) throws CommonException {
	...
	public String getContractno(String contType) throws CommonException {
		...
		Map paramMap = new HashMap();
		paramMap.put("brno", BctlService.getInstance().getBrnoByBrcode(GlobalInfo.getCurrentInstance().getBrcode()));
	 ...
	 * @throws CommonException
	 */
	public String getContractno(String brcode, String lnid) throws CommonException {
		GetContractnoGenerator getContractnoGenerator = (GetContractnoGenerator) GeneratorFactory
				.getGenerator("GetContractnoGenerator");
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.put("brcode", brcode);
	...
	public String getProjectno(String brcode) throws CommonException {
		GetProjectnoGenerator getProjectnoGenerator = (GetProjectnoGenerator) GeneratorFactory
				.getGenerator("GetProjectnoGenerator");
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.put("brcode", brcode);
	...
	public String getWarningID(String brcode) throws CommonException {
		GetWarningIDGenerator getWarningIDGenerator = (GetWarningIDGenerator) GeneratorFactory
				.getGenerator("GetWarningIDGenerator");
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.put("brcode", brcode);
	...
	public String getHouseno(String brcode) throws CommonException {
		GetHousenoGenerator getHousenoGenerator = (GetHousenoGenerator) GeneratorFactory
				.getGenerator("GetHousenoGenerator");
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.put("brcode", brcode);
	...
	public String getAccumFundActno(String brcode, String term, String lnid) throws CommonException {
		GetAccumFundActno2Generator GetAccumFundActno2Generator = (GetAccumFundActno2Generator) GeneratorFactory
				.getGenerator("GetAccumFundActno2Generator");
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.put("brcode", brcode);
	...
	public int getCoreReqSeq() throws CommonException {
		GetCoreReqSeqGenerator getCoreReqSeqGenerator = (GetCoreReqSeqGenerator) GeneratorFactory
				.getGenerator("GetCoreReqSeqGenerator");
	...
	public int getDaysNmByTerm(String term) {
		...
		totalDays = temYears * theDaysOfYear + temMonths * theDaysOfMonth + temDays;
		return totalDays;
	}
	...
	// GetBlackCustnoGenerator getBlackCustnoGenerator =
	// (GetBlackCustnoGenerator) GeneratorFactory
	...
	public String genLnid(String lntypeid) throws CommonException {
		GetLnidGenerator getLnidGenerator = (GetLnidGenerator) GeneratorFactory.getGenerator("GetLnidGenerator");
	 ...
	 * @throws CommonException
	 */
	public String getCreditCino(String contractno, short seqno) throws CommonException {
