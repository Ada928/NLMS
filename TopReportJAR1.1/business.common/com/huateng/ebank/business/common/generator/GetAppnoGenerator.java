...
/**
 * Title: GetAppnoGenertor Description: 生成申请编号 Copyright: Copyright (c) 2008
...
public class GetAppnoGenerator extends BaseGenerator {
	...
	public String gen(Object paramMap) throws CommonException {
		...
		/*
		 * int iCustNo = Integer.parseInt(custNo); String custNo20 =
		 * DataFormat.intToString(iCustNo, 20); .
		 */
	...
	public String genBuyApptypeBrcode(Map<String, Object> paramMap) throws CommonException {
		...
		return valueIndex + DataFormat
				.intToString(CommonService.getInstance().getSeqno(SystemConstant.VALUE_NO_APPNO, valueIndex), 8);
	}
}
