...
/**
 * Title: GetAccumFundActnoGenerator Description: 公积金帐号生成器 Copyright: Copyright
...
public class GetAccumFundActnoGenerator extends BaseGenerator {
	...
	public String gen(Object paramMap) throws CommonException {
		...
		// + term.substring(0, 2)
		// +
		// DataFormat.intToString(CommonService.getInstance().getSeqno(SystemConstant.VALUE_NO_ACCUM_FUND_ACTNO,
		// brcode), 9);
		return "";
	}
