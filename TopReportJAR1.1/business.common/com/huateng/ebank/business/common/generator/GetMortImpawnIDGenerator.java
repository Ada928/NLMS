...
/**
 * Title: GetMortImpawnIDGenerator Description: 抵押、质押序号生成器 Copyright: Copyright
 * (c) 2008 Company: Shanghai Huateng Software Systems Co., Ltd.
 * 
 * @author shen_antonio
 * @version 1.1, 2008-4-13
 */
public class GetMortImpawnIDGenerator extends BaseGenerator {
	...
	public String gen(Object obj) throws CommonException {
		...
		return String.valueOf(CommonService.getInstance().getSeqno(SystemConstant.VALUE_NO_MORIIMPAWN_ID,
