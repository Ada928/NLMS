...
/**
 * Title: GetCreditNoGenerator Description: 生成申请编号 Copyright: Copyright (c) 2008
...
public class GetCreditNoGenerator extends BaseGenerator {
	...
	public String gen(Object paramMap) throws CommonException {
		...
		return valueIndex + DataFormat
				.intToString(CommonService.getInstance().getSeqno(SystemConstant.VALUE_NO_CREDITNO, valueIndex), 6);
	}
}
