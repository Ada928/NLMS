...
public class GetContnoGenerator extends BaseGenerator {
	...
	public String gen(Object obj) throws CommonException {
		...
		String valueIndex = "S" + brno + contType + DataFormat.getYear(GlobalInfo.getCurrentInstance().getTxdate());
		return valueIndex + DataFormat
				.intToString(CommonService.getInstance().getSeqno(SystemConstant.VALUE_NO_LOANCENTER, "CN082008"), 7);
	}
	...
	public String genNew(Object obj) throws CommonException {
		...
		String date = DataFormat.getYear(GlobalInfo.getCurrentInstance().getTxdate())
				+ DataFormat.getMonth(GlobalInfo.getCurrentInstance().getTxdate());
		...
		String valueIndex = "P" + SystemConstant.CONTRACT_NO_BRNO + contTypeSmall + date;
		return valueIndex + DataFormat
				.intToString(CommonService.getInstance().getSeqno(SystemConstant.VALUE_NO_LOANCENTER, "LM" + year), 4);
	}
