...
public class ErrorCode {
	...
	public static final String ERROR_CODE_LICENSE_NO_IS_EXIST = "SE4101"; // 营业执照/批准证书
																			// 已存在
	...
	/*
	 * //房贷卡授信信息表 public static final String ERROR_CODE_LOANCARD_DELETE =
	 * "GD1645"; //房贷卡授信信息表删除错误 public static final String
	 * ERROR_CODE_LOANCARD_INSERT = "GD1656"; //房贷卡授信信息表插入错误 public static final
	 * String ERROR_CODE_LOANCARD_SELECT = "GD1647"; //房贷卡授信信息表读取错误 public
	 * static final String ERROR_CODE_LOANCARD_UPDATE = "GD1648"; //房贷卡授信信息表修改错误
	 * 
	 * //房贷卡授信附属信息表 public static final String ERROR_CODE_LNCARDCREDIT_DELETE =
	 * "GD1649"; //房贷卡授信附属信息表删除错误 public static final String
	 * ERROR_CODE_LNCARDCREDIT_INSERT = "GD1650"; //房贷卡授信附属信息表插入错误 public static
	 * final String ERROR_CODE_LNCARDCREDIT_SELECT = "GD1651"; //房贷卡授信附属信息表读取错误
	 * public static final String ERROR_CODE_LNCARDCREDIT_UPDATE = "GD1652";
	 * //房贷卡授信附属信息表修改错误
	 * 
	 * //房贷卡授信额度申请表 public static final String ERROR_CODE_LOANCARDAPPLY_DELETE =
	 * "GD1653"; //房贷卡授信额度申请表删除错误 public static final String
	 * ERROR_CODE_LOANCARDAPPLY_INSERT = "GD1654"; //房贷卡授信额度申请表插入错误 public
	 * static final String ERROR_CODE_LOANCARDAPPLY_SELECT = "GD1655";
	 * //房贷卡授信额度申请表读取错误 public static final String
	 * ERROR_CODE_LOANCARDAPPLY_UPDATE = "GD1656"; //房贷卡授信额度申请表修改错误
	 */
	...
	/**
	 * add by Joseph.Bao 2008-04-24 客户经理绩效考核分析表错误码
	 */
	...
	/**
	 * add by weikun wang 2008-04-28 贷款分析表分配错误码
	 */
	...
	/**
	 * add by znh 2008-04-29 贷款品种流程配置表错误码
	 */
	...
	/**
	 * add by maik chen 2008-06-03 个贷系统跟核心系统比较账户：个贷系统传入的账号/卡号
	 */
	...
	/**
	 * add by fan.jiang 20100110 start 核算
	 */
	...
	/**
	 * add by qianlong 20110121 start 罚金减免申请
	 */
