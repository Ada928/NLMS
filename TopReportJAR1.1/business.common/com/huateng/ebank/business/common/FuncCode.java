...
public class FuncCode {
	 ...
	 */
	// 营销活动开办维护
	public static final int FUNC_CODE_CASH_RTN_ACT_INIT_MTN = 11005001;
	// 现金回赠参数维护
	public static final int FUNC_CODE_CASH_RTN_PARAM_MTN = 11005003;
	// 单笔贷款营销活动终止
	public static final int FUNC_CODE_CASH_RTN_ACT_TMNT = 11005004;

	// 总行终止现金回赠
	public static final int FUNC_CODE_CASH_RTN_STOP_BY_HEAD = 11005006;
	// 现金回赠信息查询
	public static final int FUNC_CODE_QUERY_CASH_RTN_INFO = 11005007;
	...
	// 法人客户大事信息查询
	public static final int FUNC_CODE_CORP_CUST_GREAT_EVENT_INFO_QUERY = 1020108;
	// 法人客户违规记录信息查询
	...
	// 合作项目中止上传工作项查询
	public static final int FUNC_CODE_COOP_PROJ_TERM_WF_APPLY_LST_QUERY = 1020336;
	// 合作项目中止审查工作项查询
	public static final int FUNC_CODE_COOP_PROJ_TERM_WF_AUDIT_LST_QUERY = 1020337;
	// 合作项目中止审批工作项查询
	public static final int FUNC_CODE_COOP_PROJ_TERM_WF_APPROVE_LST_QUERY = 1020338;
	// 合作项目退回修改工作项查询
	...
	// 合作项目中止审批取消声明
	public static final int FUNC_CODE_COOP_PROJ_TERM_WF_APPROVE_CANCEL = 1020348;
	// 合作项目退回修改取消声明
	...
	// 合作协议中止上传工作项查询
	public static final int FUNC_CODE_COOP_PROT_TERM_WF_APPLY_LST_QUERY = 1020411;
	// 合作协议中止审查工作项查询
	public static final int FUNC_CODE_COOP_PROT_TERM_WF_AUDIT_LST_QUERY = 1020412;
	// 合作协议中止审批工作项查询
	public static final int FUNC_CODE_COOP_PROT_TERM_WF_APPROVE_LST_QUERY = 1020413;
	// 合作协议退回修改工作项查询
	...
	// 合作协议中止审批取消声明
	public static final int FUNC_CODE_COOP_PROT_TERM_WF_APPROVE_CANCEL = 1020423;
	// 合作协议退回修改取消声明
	...
	// 物理删除自然人信息和附属信息
	public static final int FUNC_CODE_CUSTINDV_PHY_DELETE = 1030131;
	...
	// 自然人和配偶贷款担保授信统计交易
	public static final int FUNC_CODE_LOAN_ASSURE_QUERY = 1030165;
	/**
	 * 贷款公共交易
	 */
	// 贷款模糊查询定位
	...
	// 贷款核查列表
	public static final int FUNC_CODE_LOANVERIFY_LIST = 1040218;
	// 贷款核查详细信息
	public static final int FUNC_CODE_LOANVERIFY_DTL = 1040219;
	// 贷款核查提交
	public static final int FUNC_CODE_LOAN_VERIFY_INFO_SUBMIT = 1040220;
	...
	// 银信通socket交易
	public static final int FUNC_CODE_BANK_SMS_MNG_LIST = 1040504;
	...
	// 柜面小额质押贷款发放
	public static final int FUNC_CODE_CORE_COUNTER_LITTLE_LOAN_IMPAWN_GRANT = 1040812;
	// 柜面小额质押贷款抹帐
	public static final int FUNC_CODE_CORE_COUNTER_LITTLE_LOAN_IMPAWN_CANCEL = 1040813;
	// 柜面小额质押贷款冲帐
	public static final int FUNC_CODE_CORE_COUNTER_LITTLE_LOAN_IMPAWN_REVERSE = 1040814;
	// 自助小额质押贷款发放
	public static final int FUNC_CODE_CORE_SELF_LITTLE_LOAN_IMPAWN_GRANT = 1040815;
	// 外汇宝质押贷款发放
	...
	// 贷款利率优惠参数表维护 总行系统管理岗和分行系统管理岗
	public static final int FUNC_CODE_FAV_LNINTR_PARAM_QUERY = 11005010;
	...
	// 变更借款人单笔合同查询
	public static final int FUNC_CODE_BORROWER_CHG_SINGLE_QUERY = 1050801;
	// 变更借款人申请
	public static final int FUNC_CODE_BORROWER_CHG_APPLY = 1050802;
	// 变更借款人主机确认
	public static final int FUNC_CODE_BORROWER_CORE_AFFIRM = 1050803;
	// 变更借款人合同号查询
	public static final int FUNC_CODE_BORROWER_CONTRACTNO_QUERY = 1050804;
	...
	// 建立手工关联关系
	public static final int FUNC_CODE_CREAT_RELATION = 1070141;
	// 修改手工关联关系
	public static final int FUNC_CODE_DELETE_RELATION = 1070142;
	// 查询手工关联关系
	public static final int FUNC_CODE_QUERY_RELATION = 1070143;
	// 修改手工关联关系
	public static final int FUNC_CODE_UPDATE_RELATION = 1070144;
	/**
	 * 统计分析
	 */
	// 客户分析
	...
	// 放开权限给所有操作员查询
	public static final int FUNC_CODE_PROJ_PARAM_ALL_QUERY = 11004086;
	...
	// 合同打印分析
	public static final int FUNC_CODE_PRINT_LOANAPPLY_PRINTDOC_ANALYZE = 1100711;
	// 批量扣款查询
	...
	// 还款计划变更打印
	public static final int FUNC_CODE_REPAY_PLAN_CALC_PRINT = 1100722;
	// 黑名单列表查询
	public static final int FUNC_CODE_QUERY_BLACKLIST_LIST = 1100723;
	// MQ交易补录
	...
	// 某个授信序号下小额质押贷款查询
	public static final int FUNC_CODE_TELE_IMPAWN_LOAN = 1110106;
	/**
	 * 天津分行公积金
	 */
	// 天津分行公积金主贷信息建立
	...
	// 联机批量打印还款计划表
	public static final int FUNC_CODE_OBP_REPAYPLAN = 2010108;
	// 下载联机批量报表
	public static final int FUNC_CODE_OB_DOWNLOADREPORT = 2010109;
}