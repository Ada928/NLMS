...
/**
 * Title: BankBaseWorkflowRule Description: Copyright: Copyright (c) 2008
...
public abstract class BankBaseWorkflowRule extends BaseWorkflowRule {
	 ...
	 * 
	 * @see
	 * com.huateng.business.workflow.rule.BaseWorkflowRule#start(com.huateng.
	 * business.workflow.rule.base.IWorkflowContext)
	 */
	...
	public void start(IWorkflowContext workflowContext) throws AppException {
		...
		WorkFlowStartBean workFlowStartBean = new WorkFlowStartBean(workflowContext.getTlrList(), brcode, flowName,
				flowVersion, workflowContext.getParamMap(), workflowContext.getKey(), workflowContext.getStatus(),
				getWorkType(), getAssignMode(), isAsnWorkType(), isLv());
	...
	/**
	 * 检查启动流程前的WorkflowContext信息 允许动态路由的情况下,FlowName字段不能为空
	 * 
	 * @param context
	 * @throws CommonException
	 */
