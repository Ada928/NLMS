...
/**
 * Title: LoanApplyWorkflowRule Description:额度申请流程规则 Copyright: Copyright (c)
 * 2008 Company: Shanghai Huateng Software Systems Co., Ltd.
 * 
 * @author shen_antonio
 * @version 1.1, 2008-4-2
 */
public class CreditApplyWorkflowRule extends BankBaseWorkflowRule {
	/**
	...
	public void preStart(BankWorkflowContext workflowContext) throws CommonException {
		...
		list.add(String.valueOf(WorkFlowConstants.ROLE_ID_LOAN_AUDIT));
		/** 设置流程key . */
