...
public class LoanApplyWorkflowRule extends BankBaseWorkflowRule {
	...
	public void preStart(BankWorkflowContext workflowContext) throws CommonException {
		...
		/** 构造BankTaskInfo对象. */
		BankTaskInfo bankTaskInfo = new BankTaskInfo((String) param.get("contractno"), (String) param.get("appno"),
				Double.valueOf((String) param.get("amount")).doubleValue(), (String) param.get("customer"),
