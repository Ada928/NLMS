...
public class WorkFlowHelper implements Serializable {
	...
	public final static String APP_TYPE_Monitor_Periodic = "31";// 定期监控流程
																// 贷后监控（定期监控）
	public final static String APP_TYPE_Monitor_Memo = "32";// 不定期监控 贷后监控（信贷备忘录）
	public final static String APP_TYPE_Monitor_Report = "33";// 不定期监控
																// 贷后监控（授信客户查访报告）
	public final static String APP_TYPE_Monitor_Use = "34";// 不定期监控
															// 贷后监控（授信业务用途监控表）
	...
	/*
	 * author:yangyong start data:20101026 黑名单审批流程
	 */
	...
	/*
	 * author:yangyong end data:20101026
	 */
	...
	public static final String APPLY_TYPE_CHG_PLAN = "36"; // 还款计划变更包括：
															// 贷款利率变更申请，贷款期限变更申请，还款方式变更，约定扣款日变更申请
	...
	// public final static String WFP_LOAN_ChG_PROCESS =
	// "PLoanChgProcess";//贷后变更流程，包括：贷款减免罚息申请，贷款核销申请，贷款销户申请，挪用罚息申请，贷款利率变更申请，贷款期限变更申请，还款方式变更，约定扣款日变更申请
